...
"use asm";
    ...
    function malloc(nbytes) {
        ...
        var top = 0;
        var ptr = 0;
        nbytes = (nbytes + (((alignment|0) - (1|0))|0) & ~(((alignment|0) - (1|0))|0)|0);
        ...
        offset = ((HEAP32[(12) >> 2]|0) + (((alignment|0) - (1|0))|0) & ~(((alignment|0) - (1|0))|0));
    ...
    function setHeadSize(ptr, s) {
        ptr = ptr|0;
        s = s|0;
        HEAPU32[(ptr ) >> 2] = (HEAPU32[(ptr ) >> 2]|0) & (7|0) | s;
    }
    ...
    function setInuse(ptr) {
        ...
        var chunkptr = 0;
        chunkptr = ((ptr|0) - (4|0)|0);
        HEAPU32[(chunkptr ) >> 2] = (HEAPU32[(chunkptr ) >> 2]|0) | (1|0);
    }
    ...
    function clearInuse(ptr) {
        ...
        var chunkptr = 0;
        chunkptr = ((ptr|0) - (4|0)|0);
        HEAPU32[(chunkptr ) >> 2] = (HEAPU32[(chunkptr ) >> 2]|0) & (-2|0);
    }
    ...
    function Vector3_add(ptr, b) {
        ...
        var a = fround(0);
        var c = 0;
        c = Vector3_new(fround(a), fround(a), fround(a))|0;
        HEAPF32[(c ) >> 2] = fround(fround(HEAPF32[(ptr ) >> 2]) + fround(HEAPF32[(b ) >> 2]));
        HEAPF32[(c + (4|0)) >> 2] = fround(fround(HEAPF32[(ptr + (4|0) ) >> 2]) + fround(HEAPF32[(b + (4|0) ) >> 2]));
        HEAPF32[(c + (8|0)) >> 2] = fround(fround(HEAPF32[(ptr + (8|0) ) >> 2]) + fround(HEAPF32[(b + (8|0) ) >> 2]));
        return (c|0);
    }
    ...
    function newVector(x, y, z) {
        ...
        y = fround(y);
        z = fround(z);
        return (Vector3_new(fround(x), fround(y), fround(z))|0|0);
    }
