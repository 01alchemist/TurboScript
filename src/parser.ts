...
import {
    ...
    NODE_FLAG_PUBLIC, NODE_FLAG_STATIC, NODE_FLAG_UNSAFE, createExpression, NODE_FLAG_POSITIVE
} from "./node";
...
export function isRightAssociative(precedence: Precedence): boolean {
...
export class ParserContext {
  ...
  parseInt(range: Range, node: Node): boolean {
    ...
    while (i < limit) {
      ...
      if (baseValue / base != value || baseValue > ~0 - digit) {
