        ...
        binary.sections.forEach(function (importedSection) {
            switch (importedSection.id) {
                ...
                case wasm_section_1.WasmSection.Custom: {
                    var section = _this.getSection(importedSection.id);
                    section.names = section.names.concat(importedSection.names);
                    break;
                }
            }
        });
...
var WasmAssembler = (function () {
    ...
    WasmAssembler.prototype.mergeBinary = function (binary) {
...
var CustomSection = (function (_super) {
    ...
    function CustomSection(name, payload) {
        if (payload === void 0) { payload = new bytearray_1.ByteArray(); }
        var _this = _super.call(this, wasm_section_1.WasmSection.Custom, payload.length, -1, name, payload) || this;
        _this.names = [];
        return _this;
    }
...
var WasmModule = (function () {
    function WasmModule(binary) {
        ...
        if (binary !== undefined) {
            ...
            this.binary = new wasm_binary_1.WasmBinary(library_1.Library.dlmallocBin);
    ...
    WasmModule.prototype.getReferences = function () {
        this.importSection = this.binary.getSection(wasm_section_1.WasmSection.Import);
        this.exportSection = this.binary.getSection(wasm_section_1.WasmSection.Export);
        this.globalSection = this.binary.getSection(wasm_section_1.WasmSection.Global);
        this.signatureSection = this.binary.getSection(wasm_section_1.WasmSection.Signature);
        this.functionSection = this.binary.getSection(wasm_section_1.WasmSection.Function);
    };
...
var WasmModuleEmitter = (function () {
    ...
    WasmModuleEmitter.prototype.mergeBinaryImports = function () {
        ...
        var binaryImports = binary_importer_1.BinaryImporter.binaries;
        binaryImports.forEach(function (binary) {
            _this.assembler.mergeBinary(binary);
        });
    };
...
var dlmallocBin = __webpack_require__(77);
...
Library.dlmallocBin = dlmallocBin;
