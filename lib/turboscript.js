...
Object.defineProperty(exports, "__esModule", { value: true });
var env_1 = __webpack_require__(29);
...
var stringbuilder_1 = __webpack_require__(31);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var bitness_1 = __webpack_require__(18);
...
var type_checker_1 = __webpack_require__(65);
var node_1 = __webpack_require__(9);
var log_1 = __webpack_require__(5);
var preprocessor_1 = __webpack_require__(70);
var scope_1 = __webpack_require__(26);
var scanner_1 = __webpack_require__(12);
var parser_1 = __webpack_require__(28);
var shaking_1 = __webpack_require__(68);
var webassembly_1 = __webpack_require__(64);
var library_1 = __webpack_require__(72);
var preparser_1 = __webpack_require__(69);
...
var wasm_parser_1 = __webpack_require__(63);
/**
 * Created by n.vinayakan on 17.06.17.
 */
var WasmBinary = (function () {
    ...
    WasmBinary.prototype.readNextSection = function () {
        if (this.data.bytesAvailable > 0) {
            ...
            terminal_1.Terminal.log(this.sections.length + " Sections parsed!");
        }
    };
    ...
    WasmBinary.prototype.getSection = function (id) {
        var index = this.sectionMap.get(id);
        if (index !== undefined) {
            return this.sections[index];
        }
        else {
            var section = wasm_parser_1.createSection(id);
            var warn = "Section " + wasm_section_1.WasmSection[id] + " created! Reason: Requested section not found in the imported wasm module";
            terminal_1.Terminal.warn(warn);
            return section;
        }
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var symbol_1 = __webpack_require__(7);
var type_1 = __webpack_require__(27);
var FindNested;
(function (FindNested) {
...
var compile_target_1 = __webpack_require__(8);
var terminal_1 = __webpack_require__(2);
var filesystem_1 = __webpack_require__(30);
var compiler_options_1 = __webpack_require__(66);
var color_1 = __webpack_require__(17);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_stack_tracer_1 = __webpack_require__(49);
var utils_1 = __webpack_require__(10);
var opcode_1 = __webpack_require__(11);
var logger_1 = __webpack_require__(15);
var wasm_section_1 = __webpack_require__(1);
var wasm_runtime_local_1 = __webpack_require__(24);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
var index_1 = __webpack_require__(14);
var wasm_module_1 = __webpack_require__(62);
var wasm_function_chunk_1 = __webpack_require__(74);
/**
 * Created by n.vinayakan on 02.06.17.
 */
var WasmAssembler = (function () {
    ...
    WasmAssembler.prototype.startSection = function (id) {
        var section = this.module.binary.getSection(id);
        logger_1.log(section.payload, 0, null, " - section: " + wasm_section_1.WasmSection[id] + " [0x" + utils_1.toHex(id, 2) + "]");
    ...
    WasmAssembler.prototype.setCurrentSection = function (id) {
        var section = this.module.binary.getSection(id);
        this.currentSection = section;
        this.activePayload = section.payload;
        this.activeCode = section.code;
    ...
    WasmAssembler.prototype.endCurrentSection = function () {
        this.currentSection = null;
        this.activePayload = null;
        this.activeCode = null;
    };
    ...
    WasmAssembler.prototype.startFunctionChunk = function (fn) {
    ...
    WasmAssembler.prototype.dropStack = function (max) {
        ...
        if (this.stackTracer.context.stack.length > 0) {
            ...
            while (item !== undefined && max > 0) {
                ...
                this.currentFunction.body.append(opcode_1.WasmOpcode.DROP);
    ...
    WasmAssembler.prototype.append = function (offset, value, msg) {
        ...
        this.currentSection.payload.log += (value != null ? utils_1.toHex(offset + this.currentSection.payload.position) + ": " + utils_1.toHex(value, 2) + "                    ; " : "") + (msg != null ? msg + "\n" : "\n");
        if (value) {
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_export_1 = __webpack_require__(19);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_function_1 = __webpack_require__(20);
/**
 * Created by 01 on 2017-06-17.
 */
var FunctionDeclarationSection = (function (_super) {
    __extends(FunctionDeclarationSection, _super);
    function FunctionDeclarationSection(payload) {
        if (payload === void 0) { payload = new bytearray_1.ByteArray(); }
        var _this = _super.call(this, wasm_section_1.WasmSection.Function, payload.length, null, null, payload) || this;
        _this.functions = [];
        return _this;
    }
    FunctionDeclarationSection.prototype.read = function () {
        var functionCount = this.payload.readU32LEB();
        console.log("WasmFunctionsDeclarations : " + functionCount);
        for (var i = 0; i < functionCount; i++) {
            var _function = new wasm_function_1.WasmFunction(null); // We don't know have the name of the function yet.
            _function.signatureIndex = this.payload.readU32LEB();
            this.functions.push(_function);
        }
    };
    FunctionDeclarationSection.prototype.publish = function (data) {
        _super.prototype.publish.call(this, data);
    };
    FunctionDeclarationSection.prototype.toString = function () {
    ...
    return FunctionDeclarationSection;
}(wasm_binary_section_1.WasmSectionBinary));
exports.FunctionDeclarationSection = FunctionDeclarationSection;
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_global_1 = __webpack_require__(21);
var wasm_type_1 = __webpack_require__(6);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_import_1 = __webpack_require__(22);
var wasm_external_kind_1 = __webpack_require__(13);
var assert_1 = __webpack_require__(3);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_signature_1 = __webpack_require__(23);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
/**
 * Created by 01 on 2017-06-17.
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_binary_1 = __webpack_require__(25);
var wasm_function_1 = __webpack_require__(20);
var wasm_import_1 = __webpack_require__(22);
var wasm_signature_1 = __webpack_require__(23);
var wasm_global_1 = __webpack_require__(21);
...
var WasmModule = (function () {
    ...
    WasmModule.prototype.getReferences = function () {
        this.imports = this.binary.getSection(wasm_section_1.WasmSection.Import).imports;
        this.exports = this.binary.getSection(wasm_section_1.WasmSection.Export).exports;
        this.globals = this.binary.getSection(wasm_section_1.WasmSection.Global).globals;
        this.signatures = this.binary.getSection(wasm_section_1.WasmSection.Signature).signatures;
        this.functions = this.binary.getSection(wasm_section_1.WasmSection.Function).functions;
    };
    ...
    WasmModule.prototype.allocateFunction = function (symbol, signatureIndex, isExported) {
        ...
        if (isExported) {
            this.exports.push(new wasm_export_1.WasmExport(_function.name, wasm_external_kind_1.WasmExternalKind.Function, this.functions.length - 1));
        }
...
var bytearray_1 = __webpack_require__(0);
var wasm_section_1 = __webpack_require__(1);
var signature_section_1 = __webpack_require__(59);
var import_section_1 = __webpack_require__(56);
var function_section_1 = __webpack_require__(54);
var table_section_1 = __webpack_require__(61);
var memory_section_1 = __webpack_require__(57);
var global_section_1 = __webpack_require__(55);
var export_section_1 = __webpack_require__(53);
var start_section_1 = __webpack_require__(60);
var element_section_1 = __webpack_require__(52);
var code_section_1 = __webpack_require__(50);
var data_section_1 = __webpack_require__(51);
var name_section_1 = __webpack_require__(58);
var terminal_1 = __webpack_require__(2);
/**
 * Created by 01 on 2017-06-19.
 */
...
function createSection(id, name) {
    ...
    switch (id) {
        ...
        case wasm_section_1.WasmSection.Function:
            sectionBinary = new function_section_1.FunctionDeclarationSection(new bytearray_1.ByteArray());
            break;
...
function parseSection(data) {
    ...
    switch (id) {
        ...
        case wasm_section_1.WasmSection.Import:
            ...
            break;
        case wasm_section_1.WasmSection.Function:
            sectionBinary = new function_section_1.FunctionDeclarationSection(payload);
            break;
        case wasm_section_1.WasmSection.Table:
...
var node_1 = __webpack_require__(9);
var opcode_1 = __webpack_require__(11);
var builtins_helper_1 = __webpack_require__(45);
var assert_1 = __webpack_require__(3);
var wasm_type_1 = __webpack_require__(6);
var logger_1 = __webpack_require__(15);
var bitness_1 = __webpack_require__(18);
var wasm_section_1 = __webpack_require__(1);
var wasm_external_kind_1 = __webpack_require__(13);
var wasm_local_1 = __webpack_require__(46);
var wasm_shared_offset_1 = __webpack_require__(47);
var wasm_assembler_1 = __webpack_require__(44);
var terminal_1 = __webpack_require__(2);
var utils_2 = __webpack_require__(14);
var wasm_optimizer_1 = __webpack_require__(48);
var wasm_binary_1 = __webpack_require__(25);
var WasmModuleEmitter = (function () {
    ...
    WasmModuleEmitter.prototype.emitSignatures = function () {
        ...
        signatures.forEach(function (signature, index) {
            ...
            signature.argumentTypes.forEach(function (type) {
                ...
                section.code.append(" " + wasm_type_1.WasmTypeToString[type]);
            });
            if (signature.argumentTypes.length > 0) {
                section.code.append(")");
            }
            if (signature.returnType !== wasm_type_1.WasmType.VOID) {
                ...
                section.code.append(" (result " + wasm_type_1.WasmTypeToString[signature.returnType] + ")");
            }
            else {
        ...
        globals.forEach(function (global, index) {
            ...
            if (value) {
                if (value.kind === node_1.NodeKind.NULL || value.kind === node_1.NodeKind.UNDEFINED) {
                    ...
                    _this.assembler.setCurrentSection(wasm_section_1.WasmSection.Global);
                }
            }
    ...
    WasmModuleEmitter.prototype.addGlobalToStartFunction = function (global) {
        ...
        this.assembler.setCurrentSection(wasm_section_1.WasmSection.Start);
        this.emitNode(0, value);
        console.log("addGlobalToStartFunction", global.name);
        startFn.body.append(opcode_1.WasmOpcode.SET_GLOBAL);
    ...
    WasmModuleEmitter.prototype.emitExportTable = function () {
        ...
        logger_1.log(section.payload, offset, memoryName.length, "export name length");
        logger_1.log(section.payload, null, null, utils_1.toHex(section.payload.position + offset + 4) + ": " + memoryName + " // export name");
        this.assembler.writeWasmString(memoryName);
        logger_1.log(section.payload, offset, wasm_external_kind_1.WasmExternalKind.Memory, "export kind");
        this.assembler.activePayload.writeUnsignedByte(wasm_external_kind_1.WasmExternalKind.Memory);
        logger_1.log(section.payload, offset, 0, "export memory index");
        this.assembler.writeUnsignedLEB128(0);
        section.code.append("(export \"memory\" (memory 0))\n");
        exports.forEach(function (_export, index) {
            ...
            logger_1.log(section.payload, offset, wasm_external_kind_1.WasmExternalKind.Function, "export kind");
            _this.assembler.writeUnsignedLEB128(wasm_external_kind_1.WasmExternalKind.Function);
            logger_1.log(section.payload, offset, index, "export func index");
            _this.assembler.writeUnsignedLEB128(index);
    ...
    WasmModuleEmitter.prototype.emitFunctionBodies = function () {
        ...
        functions.forEach(function (fn, index) {
            ...
            if (fn.chunks.length > 0) {
                fn.chunks.forEach(function (chunk) {
            ...
            logger_1.log(section.payload, offset, bodyData.length, "func body size");
    ...
    WasmModuleEmitter.prototype.emitDataSegments = function () {
        ...
        section.code.append("(data (i32.const " + wasm_binary_1.WasmBinary.MEMORY_INITIALIZER_BASE + ") \"  ");
        var i = 0;
        var value;
    ...
    WasmModuleEmitter.prototype.emitNames = function () {
        var _this = this;
        var section = this.assembler.startSection(wasm_section_1.WasmSection.Custom);
        var functions = this.assembler.module.binary.getSection(wasm_section_1.WasmSection.Function).functions;
    ...
    WasmModuleEmitter.prototype.prepareToEmit = function (node) {
        if (node.kind == node_1.NodeKind.STRING) {
            ...
            var fn = this.assembler.module.allocateFunction(symbol, signatureIndex, node.isExport());
        ...
        if (node.kind == node_1.NodeKind.BLOCK) {
            ...
            if (!skipBlock) {
                ...
                if (node.returnNode !== undefined) {
                    logger_1.log(this.assembler.currentSection.payload, byteOffset, this.currentFunction.returnType, wasm_type_1.WasmType[this.currentFunction.returnType]);
                    ...
                    logger_1.log(this.assembler.currentSection.payload, wasm_type_1.WasmType.block_type);
            ...
            logger_1.log(this.assembler.currentSection.payload, 0, wasm_type_1.WasmType.block_type, wasm_type_1.WasmType[wasm_type_1.WasmType.block_type]);
            this.assembler.append(byteOffset, wasm_type_1.WasmType.block_type);
...
var scope_1 = __webpack_require__(26);
var utils_1 = __webpack_require__(10);
var const_1 = __webpack_require__(67);
var assert_1 = __webpack_require__(3);
var compiler_1 = __webpack_require__(16);
var terminal_1 = __webpack_require__(2);
/**
...
var jstypes = __webpack_require__(40);
var runtime = __webpack_require__(39);
var wrapper = __webpack_require__(41);
var malloc = __webpack_require__(36);
var mallocBinary = __webpack_require__(33);
var builtins = __webpack_require__(42);
var initializer = __webpack_require__(43);
