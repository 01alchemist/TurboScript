...
var stringbuilder_1 = __webpack_require__(19);
...
var scanner_1 = __webpack_require__(13);
...
Object.defineProperty(exports, "__esModule", { value: true });
var bitness_1 = __webpack_require__(20);
var wasm_type_1 = __webpack_require__(6);
var symbol_1 = __webpack_require__(7);
/**
 * Created by n.vinayakan on 17.06.17.
...
///<reference path="declarations.d.ts" />
var log_1 = __webpack_require__(5);
var compiler_1 = __webpack_require__(12);
var compile_target_1 = __webpack_require__(9);
var terminal_1 = __webpack_require__(2);
...
var wasm_runtime_local_1 = __webpack_require__(26);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_function_1 = __webpack_require__(15);
/**
...
var CodeSection = (function (_super) {
    ...
    CodeSection.prototype.read = function () {
        ...
        for (var i = 0; i < length; i++) {
            var _function = new wasm_function_1.WasmFunction("<anonymous>");
            var pos = this.payload.position;
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_export_1 = __webpack_require__(21);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_global_1 = __webpack_require__(22);
var wasm_type_1 = __webpack_require__(6);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_import_1 = __webpack_require__(23);
var wasm_external_kind_1 = __webpack_require__(14);
var assert_1 = __webpack_require__(3);
/**
 * Created by 01 on 2017-06-17.
 */
...
var CustomSection = (function (_super) {
    ...
    CustomSection.prototype.read = function () {
    };
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_signature_1 = __webpack_require__(24);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
/**
 * Created by 01 on 2017-06-17.
...
var WasmModule = (function () {
    ...
    WasmModule.prototype.allocateBinaryImport = function (binaryImport) {
    };
    return WasmModule;
}());
...
var wasm_binary_1 = __webpack_require__(17);
var import_helper_1 = __webpack_require__(76);
var WasmModuleEmitter = (function () {
    ...
    WasmModuleEmitter.prototype.emitExportTable = function () {
        ...
        exports.forEach(function (_export) {
            var fnIndex = importCount + _export.index;
            ...
            _this.assembler.writeUnsignedLEB128(wasm_external_kind_1.WasmExternalKind.Function);
            logger_1.log(section.payload, offset, fnIndex, "export func index");
            _this.assembler.writeUnsignedLEB128(fnIndex);
    ...
    WasmModuleEmitter.prototype.prepareToEmit = function (node) {
        if (node.kind == node_1.NodeKind.STRING) {
            ...
            if (body == null) {
                if (import_helper_1.isBinaryImport(wasmFunctionName)) {
                    this.assembler.module.allocateBinaryImport(import_helper_1.getBinaryImport(wasmFunctionName));
                }
                else if (!builtins_helper_1.isBuiltin(wasmFunctionName)) {
...
var filesystem_1 = __webpack_require__(31);
var terminal_1 = __webpack_require__(2);
var binary_importer_1 = __webpack_require__(78);
            ...
            while (i < limit) {
                ...
                if (i + 1 < limit && next == '\\') {
                    ...
                    if (next == c) {
                        ...
                        var importContent = resolveImport(imports, basePath + pathSeparator + from, from);
                        if (importContent) {
...
function resolveImport(imports, from, importPath) {
    ...
    if (from === "javascript") {
        ...
        return binary_importer_1.BinaryImporter.resolve(imports, from, importPath);
    }
    else {
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_binary_import_1 = __webpack_require__(79);
/**
...
function getBinaryImport(name) {
    return new wasm_binary_import_1.WasmBinaryImport();
}
exports.getBinaryImport = getBinaryImport;
...
var BinaryImporter = (function () {
    ...
    BinaryImporter.resolve = function (imports, from, importPath) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var binary_import_1 = __webpack_require__(80);
/**
 * Created by n.vinayakan on 23.06.17.
 */
var WasmBinaryImport = (function (_super) {
    __extends(WasmBinaryImport, _super);
    function WasmBinaryImport() {
        return _super.call(this) || this;
    }
    return WasmBinaryImport;
}(binary_import_1.BinaryImport));
 ...
 * Created by n.vinayakan on 23.06.17.
 */
var BinaryImport = (function () {
    function BinaryImport() {
    }
    return BinaryImport;
}());
exports.BinaryImport = BinaryImport;
