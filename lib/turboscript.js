...
Object.defineProperty(exports, "__esModule", { value: true });
var filesystem_1 = __webpack_require__(16);
...
var WasmModule = (function () {
    ...
    WasmModule.prototype.allocateExport = function (name, kind, index, as) {
        ...
        if (duplicate === undefined) {
            ...
            terminal_1.Terminal.error("Error! Duplicate export " + name + " as " + as);
        }
    };
...
var wasm_binary_1 = __webpack_require__(18);
var binary_importer_1 = __webpack_require__(19);
var WasmModuleEmitter = (function () {
    ...
    WasmModuleEmitter.prototype.emitFunctionBodies = function () {
        ...
        functions.forEach(function (fn, index) {
            ...
            if (!fn.isExternal) {
                if (fn.name === "__WASM_INITIALIZER" && compiler_1.Compiler.mallocRequired) {
                    // write mspace_init
                    var mspace_init_index = binary_importer_1.getMergedCallIndex("mspace_init");
                    _this.assembler.startFunctionChunk(_this.startFunction, _this.startFunctionIndex);
                    _this.assembler.appendOpcode(0, opcode_1.WasmOpcode.I32_CONST);
                    _this.assembler.writeUnsignedLEB128(40);
                    _this.assembler.appendOpcode(0, opcode_1.WasmOpcode.CALL);
                    _this.assembler.writeUnsignedLEB128(mspace_init_index);
                    _this.assembler.appendOpcode(0, opcode_1.WasmOpcode.SET_GLOBAL);
                    _this.assembler.writeUnsignedLEB128(_this.HEAP_BASE_INDEX);
                }
