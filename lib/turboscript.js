...
var stringbuilder_1 = __webpack_require__(71);
/**
...
var wasm_parser_1 = __webpack_require__(61);
/**
 * Created by n.vinayakan on 17.06.17.
 */
var WasmBinary = (function () {
    ...
    WasmBinary.prototype.getSection = function (id) {
        ...
        if (index !== undefined) {
            ...
            var error = "Section " + wasm_section_1.WasmSection[id] + " not defined yet!";
...
var wasm_module_1 = __webpack_require__(60);
/**
 * Created by n.vinayakan on 02.06.17.
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_binary_1 = __webpack_require__(20);
...
function createSection(id, name) {
    ...
    if (sectionBinary === null) {
        var error = "Unknown section name:" + name + ", id:" + id;
        terminal_1.Terminal.error(error);
        throw error;
    }
...
var WasmModuleEmitter = (function () {
    ...
    WasmModuleEmitter.prototype.emitGlobalDeclarations = function () {
        ...
        globals.forEach(function (global, index) {
            ...
            _this.assembler.writeUnsignedLEB128(1); //mutability, 0 if immutable, 1 if mutable. MVP only support immutable global variables
            var rawValue = 0;
            if (value) {
...
var filesystem_1 = __webpack_require__(25);
var terminal_1 = __webpack_require__(2);
var javascript = __webpack_require__(28);
...
var malloc = __webpack_require__(30);
var mallocBinary = __webpack_require__(27);
