...
})(this, function(__WEBPACK_EXTERNAL_MODULE_81__, __WEBPACK_EXTERNAL_MODULE_82__) {
...
var stringbuilder_1 = __webpack_require__(23);
...
Object.defineProperty(exports, "__esModule", { value: true });
var bitness_1 = __webpack_require__(24);
...
var type_checker_1 = __webpack_require__(73);
var node_1 = __webpack_require__(10);
var log_1 = __webpack_require__(5);
var preprocessor_1 = __webpack_require__(78);
var scope_1 = __webpack_require__(33);
var scanner_1 = __webpack_require__(15);
var parser_1 = __webpack_require__(35);
var shaking_1 = __webpack_require__(76);
var webassembly_1 = __webpack_require__(72);
var library_1 = __webpack_require__(36);
var preparser_1 = __webpack_require__(77);
...
var Compiler = (function () {
    function Compiler(options, outputName, excludeMalloc) {
        if (excludeMalloc === void 0) { excludeMalloc = false; }
        ...
        this.librarySource = this.addInput("<library>", library_1.Library.get(options, excludeMalloc));
        this.librarySource.isLibrary = true;
        this.runtimeSource = library_1.Library.getRuntime(options.target);
        this.wrapperSource = library_1.Library.getWrapper(options.target);
        this.createGlobals();
        if (options.target == compile_target_1.CompileTarget.CPP) {
            this.preprocessor.define("CPP", true);
        }
        else if (options.target == compile_target_1.CompileTarget.JAVASCRIPT) {
            this.preprocessor.define("JS", true);
        }
        else if (options.target == compile_target_1.CompileTarget.WEBASSEMBLY) {
...
var BinaryImporter = (function () {
    ...
    BinaryImporter.resolveWasmBinaryImport = function (imports, from, importPath) {
        var binary;
        if (filesystem_1.FileSystem.existsSync(importPath)) {
            binary = filesystem_1.FileSystem.readBinaryFile(importPath);
        }
        if (binary === null || binary === undefined) {
            binary = filesystem_1.FileSystem.readBinaryFile(from);
        }
        if (binary === null || binary === undefined) {
            var error = "Cannot find wasm binary! [file: " + importPath + "]";
...
function getMergedCallIndex(name) {
    ...
    if (__import !== undefined) {
        ...
        var error = "Cannot find imported function index of " + name;
        terminal_1.Terminal.error(error);
        throw error;
    }
}
...
var FileSystem = (function () {
    ...
    FileSystem.existsSync = function (path, virtual) {
    ...
    FileSystem.readTextFile = function (path, virtual) {
        ...
        try {
            ...
            if (virtualFile === undefined) {
                terminal_1.Terminal.warn("Requested text file " + path + " not found");
                return null;
            }
            else {
    ...
    FileSystem.readBinaryFile = function (path, virtual) {
        ...
        try {
            ...
            var virtualFile = virtualFileSystem.readFileSync(path);
            if (virtualFile === undefined) {
                terminal_1.Terminal.warn("Requested binary file " + path + " not found");
                return null;
            }
            else {
                return virtualFile;
...
var terminal_1 = __webpack_require__(2);
var wasm_section_1 = __webpack_require__(0);
var wasm_parser_1 = __webpack_require__(32);
/**
 * Created by n.vinayakan on 17.06.17.
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * Created by n.vinayakan on 04.07.17.
 */
var DependencyLinking;
(function (DependencyLinking) {
    DependencyLinking[DependencyLinking["NONE"] = 0] = "NONE";
    DependencyLinking[DependencyLinking["STATIC"] = 1] = "STATIC";
    DependencyLinking[DependencyLinking["DYNAMIC"] = 2] = "DYNAMIC";
    DependencyLinking[DependencyLinking["MIXED"] = 3] = "MIXED";
})(DependencyLinking = exports.DependencyLinking || (exports.DependencyLinking = {}));
...
var bytearray_1 = __webpack_require__(1);
var wasm_section_1 = __webpack_require__(0);
var signature_section_1 = __webpack_require__(67);
var import_section_1 = __webpack_require__(64);
var function_section_1 = __webpack_require__(62);
var table_section_1 = __webpack_require__(69);
var memory_section_1 = __webpack_require__(65);
var global_section_1 = __webpack_require__(63);
var export_section_1 = __webpack_require__(61);
var start_section_1 = __webpack_require__(68);
var element_section_1 = __webpack_require__(60);
var code_section_1 = __webpack_require__(58);
var data_section_1 = __webpack_require__(59);
var name_section_1 = __webpack_require__(66);
var terminal_1 = __webpack_require__(2);
/**
 * Created by 01 on 2017-06-19.
 */
...
var compile_target_1 = __webpack_require__(9);
var filesystem_1 = __webpack_require__(17);
var dependency_linking_1 = __webpack_require__(20);
// library files
var math = __webpack_require__(43);
var types = __webpack_require__(44);
var array = __webpack_require__(40);
var wasmStringType = __webpack_require__(50);
var jstypes = __webpack_require__(46);
var runtime = __webpack_require__(45);
var wrapper = __webpack_require__(47);
var wasmWrapper = __webpack_require__(51);
var malloc = __webpack_require__(42);
var malloc_dynamic = __webpack_require__(41);
var dlmallocBin = __webpack_require__(38);
var builtins = __webpack_require__(48);
var initializer = __webpack_require__(49);
...
var Library = (function () {
    ...
    Library.get = function (options, excludeMalloc) {
        if (excludeMalloc === void 0) { excludeMalloc = false; }
        var lib;
        switch (options.target) {
            ...
            case compile_target_1.CompileTarget.WEBASSEMBLY:
                lib = [
                    types,
                    builtins,
                    options.link === dependency_linking_1.DependencyLinking.DYNAMIC ? malloc_dynamic : malloc,
...
var terminal_1 = __webpack_require__(2);
var filesystem_1 = __webpack_require__(17);
var compiler_options_1 = __webpack_require__(74);
var color_1 = __webpack_require__(21);
var library_1 = __webpack_require__(36);
var dependency_linking_1 = __webpack_require__(20);
/**
...
function main_entry() {
    var options = new compiler_options_1.CompilerOptions();
    var argument = firstArgument;
    var inputCount = 0;
    var output;
    var outputName;
    var outputPath;
    var excludeMalloc = false;
    ...
    while (argument != null) {
        ...
        if (text.startsWith("-")) {
            if (text == "-h" || text == "-help" || text == "--help" || text == "/?") {
                ...
                options.target = compile_target_1.CompileTarget.CPP;
            }
            else if (text == "--js") {
                options.target = compile_target_1.CompileTarget.JAVASCRIPT;
            }
            else if (text == "--wasm") {
                options.target = compile_target_1.CompileTarget.WEBASSEMBLY;
            }
                ...
                options.link = dependency_linking_1.DependencyLinking.STATIC;
            }
            else if (text == "--link-dynamic") {
                options.link = dependency_linking_1.DependencyLinking.DYNAMIC;
            }
            else {
    ...
    if (options.target == compile_target_1.CompileTarget.NONE) {
    ...
    var compiler = new compiler_1.Compiler(options, output, excludeMalloc);
...
function compileString(source, options) {
    if (options === void 0) { options = new compiler_options_1.CompilerOptions(); }
    ...
    var compiler = new compiler_1.Compiler(options, output);
...
module.exports = "/**\n * Created by n.vinayakan on 04.07.17.\n */\ndeclare function memcmp(vl:int32, vr:int32, n:int32):boolean;\ndeclare function memcpy(dist:int32, src:int32, n:int32):void;\ndeclare function memset(dist:int32, c:int32, n:int32):void;\ndeclare function mspace_init(base:int32):int32;\ndeclare function mspace_malloc(base:int32, size:int32):int32;\ndeclare function mspace_free(base:int32, size:int32):void;\ndeclare function malloc(value:int32):int32;\ndeclare function free(value:int32):void;"

/***/ }),
/* 42 */
/***/ (function(module, exports) {

module.exports = "import {mspace_init, mspace_malloc, mspace_free, memcpy, memcmp} from \"/library/dlmalloc.wasm\";\n\nexport function malloc(value:int32):int32 {\n    return mspace_malloc(HEAP_BASE, value);\n}\nexport function free(value:int32):void {\n    mspace_free(HEAP_BASE, value);\n}\n"
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_stack_tracer_1 = __webpack_require__(57);
var utils_1 = __webpack_require__(8);
var opcode_1 = __webpack_require__(13);
var wasm_runtime_local_1 = __webpack_require__(31);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
var index_1 = __webpack_require__(11);
var wasm_module_1 = __webpack_require__(71);
var wasm_function_chunk_1 = __webpack_require__(54);
var wasm_merger_1 = __webpack_require__(70);
/**
 * Created by n.vinayakan on 02.06.17.
 */
...
var wasm_local_1 = __webpack_require__(28);
/**
...
var CodeSection = (function (_super) {
    ...
    CodeSection.prototype.read = function () {
        ...
        for (var i = 0; i < length; i++) {
            ...
            var localVariables = [];
            var localVariableCount = this.payload.readU32LEB();
            for (var j = 0; j < localVariableCount; j++) {
                var typeCount = this.payload.readU8LEB();
                for (var k = 0; k < typeCount; k++) {
                    var local = new wasm_local_1.WasmLocal(this.payload.readU8LEB(), "");
...
var wasm_section_1 = __webpack_require__(0);
var bytearray_1 = __webpack_require__(1);
var wasm_export_1 = __webpack_require__(25);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(0);
var bytearray_1 = __webpack_require__(1);
var wasm_global_1 = __webpack_require__(26);
var wasm_type_1 = __webpack_require__(6);
/**
 * Created by 01 on 2017-06-17.
 */
...
var wasm_section_1 = __webpack_require__(0);
var bytearray_1 = __webpack_require__(1);
var wasm_import_1 = __webpack_require__(27);
var wasm_external_kind_1 = __webpack_require__(12);
var assert_1 = __webpack_require__(3);
/**
 * Created by 01 on 2017-06-17.
...
var wasm_section_1 = __webpack_require__(0);
var bytearray_1 = __webpack_require__(1);
var wasm_signature_1 = __webpack_require__(29);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
/**
 * Created by 01 on 2017-06-17.
...
var compiler_1 = __webpack_require__(14);
var opcode_1 = __webpack_require__(13);
var builtins_helper_1 = __webpack_require__(53);
var assert_1 = __webpack_require__(3);
var wasm_type_1 = __webpack_require__(6);
var logger_1 = __webpack_require__(30);
var bitness_1 = __webpack_require__(24);
...
var wasm_external_kind_1 = __webpack_require__(12);
var wasm_local_1 = __webpack_require__(28);
var wasm_shared_offset_1 = __webpack_require__(55);
var wasm_assembler_1 = __webpack_require__(52);
var terminal_1 = __webpack_require__(2);
var utils_2 = __webpack_require__(11);
var wasm_optimizer_1 = __webpack_require__(56);
var wasm_binary_1 = __webpack_require__(19);
var binary_importer_1 = __webpack_require__(16);
var dependency_linking_1 = __webpack_require__(20);
var WasmModuleEmitter = (function () {
    function WasmModuleEmitter(bitness, compilerOptions) {
    ...
    WasmModuleEmitter.prototype.prepareToEmit = function (node, link) {
        if (node.kind == node_1.NodeKind.STRING) {
            ...
            if (body == null) {
                if (!builtins_helper_1.isBuiltin(wasmFunctionName)) {
                    ...
                    if (binary_importer_1.isBinaryImport(wasmFunctionName) && link == dependency_linking_1.DependencyLinking.STATIC) {
    ...
    WasmModuleEmitter.prototype.emitNode = function (byteOffset, node) {
        ...
        if (node.kind == node_1.NodeKind.BLOCK) {
            ...
            if (builtins_helper_1.isBuiltin(wasmFunctionName)) {
                ...
                if (binary_importer_1.isBinaryImport(wasmFunctionName) && this.compilerOptions.link === dependency_linking_1.DependencyLinking.STATIC) {
...
function wasmEmit(compiler, bitness, optimize) {
    ...
    var wasmEmitter = new WasmModuleEmitter(bitness, compiler.options);
    wasmEmitter.context = compiler.context;
    wasmEmitter.memoryInitializer = new bytearray_1.ByteArray();
    if (compiler.options.link === dependency_linking_1.DependencyLinking.STATIC) {
...
var scope_1 = __webpack_require__(33);
var utils_1 = __webpack_require__(8);
var const_1 = __webpack_require__(75);
var assert_1 = __webpack_require__(3);
var compiler_1 = __webpack_require__(14);
var terminal_1 = __webpack_require__(2);
/**
...
var CompilerOptions = (function () {
    function CompilerOptions(target, optimize, link, bundle, jsWrapper, silent, logError) {
        if (target === void 0) { target = compile_target_1.CompileTarget.WEBASSEMBLY; }
        if (optimize === void 0) { optimize = false; }
        if (link === void 0) { link = dependency_linking_1.DependencyLinking.DYNAMIC; }
        if (bundle === void 0) { bundle = false; }
        if (jsWrapper === void 0) { jsWrapper = true; }
        if (silent === void 0) { silent = false; }
...
var binary_importer_1 = __webpack_require__(16);
var env_1 = __webpack_require__(22);
var javascript = __webpack_require__(39);
var path;
if (env_1.isNode) {
