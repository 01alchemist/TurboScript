...
var FileSystem = (function () {
    ...
    FileSystem.writeBinaryFile = function (path, contents, virtual, uint8) {
        if (virtual === void 0) { virtual = false; }
        if (uint8 === void 0) { uint8 = false; }
        try {
            if (virtual) {
        ...
        if (node.kind == node_1.NodeKind.STRING) {
            ...
            if (body == null) {
                if (binary_importer_1.isBinaryImport(wasmFunctionName)) {
                    symbol.flags |= node_1.NODE_FLAG_IMPORT;
                }
...
filesystem_1.FileSystem.writeBinaryFile("/library/dlmalloc.wasm", dlmallocBin, true, true);
