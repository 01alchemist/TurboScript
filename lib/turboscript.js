...
var stringbuilder_1 = __webpack_require__(53);
/**
 * Created by n.vinayakan on 02.06.17.
 */
...
var WasmModule = (function () {
    ...
    WasmModule.prototype.emitFunctionBodies = function (array) {
        ...
        while (fn != null) {
            ...
            var argType = fn.signature.argumentTypes;
            while (argType != null) {
                section.code.append(" (param " + wasm_type_1.WasmTypeToString[argType.id] + ")");
            ...
            if (fn.localCount > 0) {
                ...
                while (local) {
                    section.code.append("(local " + wasm_type_1.WasmTypeToString[local.type] + ") ");
            ...
            this.assembler.appendOpcode(bodyData, sectionOffset, opcode_1.WasmOpcode.END, null, true); //end, 0x0b, indicating the end of the body
