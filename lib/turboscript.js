...
})(this, function(__WEBPACK_EXTERNAL_MODULE_75__, __WEBPACK_EXTERNAL_MODULE_76__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var env_1 = __webpack_require__(19);
...
function wasmToTurboType(type) {
    switch (type) {
        case wasm_type_1.WasmType.VOID: return "void";
        case wasm_type_1.WasmType.I32: return "int32";
        case wasm_type_1.WasmType.I64: return "int64";
        case wasm_type_1.WasmType.F32: return "float32";
        case wasm_type_1.WasmType.F64: return "float64";
    }
}
...
var scope_1 = __webpack_require__(29);
var scanner_1 = __webpack_require__(14);
...
var FileSystem = (function () {
    ...
    FileSystem.readBinaryFile = function (path) {
        try {
            ...
            terminal_1.Terminal.warn("Requested file " + path + " not found, searching in virtual file system");
...
Object.defineProperty(exports, "__esModule", { value: true });
var symbol_1 = __webpack_require__(7);
var type_1 = __webpack_require__(30);
var FindNested;
(function (FindNested) {
...
var compile_target_1 = __webpack_require__(9);
var terminal_1 = __webpack_require__(2);
var filesystem_1 = __webpack_require__(20);
...
module.exports = "import {mspace_init, mspace_malloc, mspace_free} from \"./src/library/common/malloc/build/malloc.wasm\";\r\n\r\nlet originalHeapPointer: int32 = null;\r\nlet currentHeapPointer: int32 = null;"
...
var utils_1 = __webpack_require__(8);
var opcode_1 = __webpack_require__(12);
var wasm_runtime_local_1 = __webpack_require__(28);
var wasm_type_1 = __webpack_require__(6);
var terminal_1 = __webpack_require__(2);
var index_1 = __webpack_require__(13);
var wasm_module_1 = __webpack_require__(62);
var wasm_function_chunk_1 = __webpack_require__(45);
/**
 * Created by n.vinayakan on 02.06.17.
 */
...
var wasm_section_1 = __webpack_require__(1);
var bytearray_1 = __webpack_require__(0);
var wasm_export_1 = __webpack_require__(23);
/**
 * Created by 01 on 2017-06-17.
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_binary_1 = __webpack_require__(16);
var wasm_function_1 = __webpack_require__(15);
var wasm_import_1 = __webpack_require__(25);
var wasm_signature_1 = __webpack_require__(26);
var wasm_global_1 = __webpack_require__(24);
...
var node_1 = __webpack_require__(10);
var opcode_1 = __webpack_require__(12);
var builtins_helper_1 = __webpack_require__(44);
var assert_1 = __webpack_require__(3);
var wasm_type_1 = __webpack_require__(6);
var logger_1 = __webpack_require__(27);
var bitness_1 = __webpack_require__(22);
...
var wasm_assembler_1 = __webpack_require__(43);
var terminal_1 = __webpack_require__(2);
        ...
        if (node.kind == node_1.NodeKind.STRING) {
            ...
            if (body == null) {
                if (!builtins_helper_1.isBuiltin(wasmFunctionName)) {
                    ...
                    var _b = this.assembler.module.allocateImport(signature, signatureIndex, moduleName, symbol.name), _import = _b[0], importIndex = _b[1];
            ...
            if (symbol.kind == symbol_1.SymbolKind.FUNCTION_GLOBAL && symbol.name == "mspace_malloc") {
                assert_1.assert(this.mallocFunctionIndex == -1);
                this.mallocFunctionIndex = symbol.offset;
            }
            if (symbol.kind == symbol_1.SymbolKind.FUNCTION_GLOBAL && symbol.name == "mspace_free") {
...
var filesystem_1 = __webpack_require__(20);
var terminal_1 = __webpack_require__(2);
var binary_importer_1 = __webpack_require__(71);
var env_1 = __webpack_require__(19);
            ...
            while (i < limit) {
                ...
                if (i + 1 < limit && next == '\\') {
                    ...
                    if (next == c) {
                        ...
                        var importContent = resolveImport(imports, from, basePath + pathSeparator + from);
                        if (importContent) {
                            if (source.isLibrary) {
...
var wasm_external_kind_1 = __webpack_require__(11);
var terminal_1 = __webpack_require__(2);
var wasm_binary_import_1 = __webpack_require__(72);
/**
            ...
            if (exports_1.length > 0) {
                imports.forEach(function (_import) {
                    ...
                    if (matchedExport !== undefined && matchedExport.kind === wasm_external_kind_1.WasmExternalKind.Function) {
                        var _function = functionSection.functions[matchedExport.index];
...
var jstypes = __webpack_require__(39);
var runtime = __webpack_require__(38);
var wrapper = __webpack_require__(40);
var malloc = __webpack_require__(35);
var builtins = __webpack_require__(41);
var initializer = __webpack_require__(42);
