...
var type_checker_1 = __webpack_require__(45);
var node_1 = __webpack_require__(4);
var log_1 = __webpack_require__(2);
var preprocessor_1 = __webpack_require__(50);
var scope_1 = __webpack_require__(15);
var scanner_1 = __webpack_require__(8);
var parser_1 = __webpack_require__(17);
var shaking_1 = __webpack_require__(48);
var webassembly_1 = __webpack_require__(44);
var library_1 = __webpack_require__(52);
var preparser_1 = __webpack_require__(49);
var compile_target_1 = __webpack_require__(3);
var assert_1 = __webpack_require__(0);
var terminal_1 = __webpack_require__(1);
/**
 * Author: Nidin Vinayakan
 ...
 */
var WasmRuntimeLocal = (function () {
    function WasmRuntimeLocal(type) {
        this.type = type;
    }
    return WasmRuntimeLocal;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var symbol_1 = __webpack_require__(5);
var type_1 = __webpack_require__(16);
var FindNested;
(function (FindNested) {
...
var compiler_options_1 = __webpack_require__(46);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var wasm_stack_tracer_1 = __webpack_require__(43);
var utils_1 = __webpack_require__(6);
var opcode_1 = __webpack_require__(7);
var section_buffer_1 = __webpack_require__(34);
var logger_1 = __webpack_require__(10);
var wasm_section_1 = __webpack_require__(13);
var wasm_runtime_local_1 = __webpack_require__(14);
var wasm_type_1 = __webpack_require__(9);
var terminal_1 = __webpack_require__(1);
/**
 * Created by n.vinayakan on 02.06.17.
 */
var WasmAssembler = (function () {
    ...
    WasmAssembler.prototype.appendOpcode = function (array, offset, opcode, inline_value) {
        if (offset === void 0) { offset = 0; }
...
var WasmLocalEntry = (function () {
    function WasmLocalEntry(type, name) {
        this.type = type;
        this.name = name;
    }
...
var WasmStackTracer = (function () {
    ...
    WasmStackTracer.prototype.setGlobals = function (globalEntries) {
        var _this = this;
        this.globals = [];
        globalEntries.forEach(function (globalType) {
            _this.globals.push(new wasm_runtime_local_1.WasmRuntimeLocal(globalType));
        });
    };
    ...
    WasmStackTracer.prototype.updateStack = function (opcode, value) {
        ...
        switch (opcode) {
            ...
            case opcode_1.WasmOpcode.SET_LOCAL:
                if (value !== undefined) {
                    if (this.context.fn.locals.length <= value) {
                        ...
                        var a_1 = this.context.stack.pop();
                        this.context.fn.locals[value].value = a_1.value;
                    }
                }
                break;
            case opcode_1.WasmOpcode.GET_LOCAL:
                if (value !== undefined) {
                    var a_2 = this.context.fn.locals[value];
                    this.context.stack.push(new WasmStackItem(a_2.type, a_2.value));
                }
                break;
            case opcode_1.WasmOpcode.SET_GLOBAL:
                if (value !== undefined) {
                    if (this.globals.length <= value) {
                        ...
                        var a_3 = this.context.stack.pop();
                        this.globals[value].value = a_3.value;
                    }
                }
                break;
            case opcode_1.WasmOpcode.GET_GLOBAL:
                if (value !== undefined) {
                    var a_4 = this.globals[value];
                    this.context.stack.push(new WasmStackItem(a_4.type, a_4.value));
                }
                break;
            // ADD
            ...
            case opcode_1.WasmOpcode.F64_ADD: {
                var a_5 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_5.value + b.value));
                break;
            }
            //SUB
            ...
            case opcode_1.WasmOpcode.F64_SUB: {
                var a_6 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_6.value - b.value));
                break;
            }
            //MUL
            ...
            case opcode_1.WasmOpcode.F64_MUL: {
                var a_7 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_7.value * b.value));
                break;
            }
            //DIV
            ...
            case opcode_1.WasmOpcode.F64_DIV: {
                var a_8 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_8.value / b.value));
                break;
            }
            //REM
            ...
            case opcode_1.WasmOpcode.I64_REM_U: {
                var a_9 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_9.value % b.value));
                break;
            }
            //GT
            ...
            case opcode_1.WasmOpcode.F64_GT: {
                var a_10 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_10.value > b.value ? 1 : 0));
                break;
            }
            //GE
            ...
            case opcode_1.WasmOpcode.F64_GE: {
                var a_11 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_11.value >= b.value ? 1 : 0));
                break;
            }
            //LT
            ...
            case opcode_1.WasmOpcode.F64_LT: {
                var a_12 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_12.value < b.value ? 1 : 0));
                break;
            }
            //LE
            ...
            case opcode_1.WasmOpcode.F64_LE: {
                var a_13 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_13.value <= b.value ? 1 : 0));
                break;
            }
            //EQ
            ...
            case opcode_1.WasmOpcode.F64_EQ: {
                var a_14 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_14.value === b.value ? 1 : 0));
                break;
            }
            //NE
            ...
            case opcode_1.WasmOpcode.F64_NE: {
                var a_15 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_15.value !== b.value ? 1 : 0));
                break;
            }
            //EQZ
            case opcode_1.WasmOpcode.I32_EQZ:
            case opcode_1.WasmOpcode.I64_EQZ: {
                var a_16 = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_16.value === 0 ? 1 : 0));
                break;
            }
            //AND
            case opcode_1.WasmOpcode.I32_AND:
            case opcode_1.WasmOpcode.I64_AND: {
                var a_17 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_17.value & b.value));
                break;
            }
            //OR
            case opcode_1.WasmOpcode.I32_OR:
            case opcode_1.WasmOpcode.I64_OR: {
                var a_18 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_18.value | b.value));
                break;
            }
            //XOR
            case opcode_1.WasmOpcode.I32_XOR:
            case opcode_1.WasmOpcode.I64_XOR: {
                var a_19 = this.context.stack.pop();
                var b = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, a_19.value ^ b.value));
                break;
            }
            //CTZ
            ...
            case opcode_1.WasmOpcode.I64_CLZ: {
                var a_20 = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(type, clz32(a_20.value)));
                break;
            }
            //CLZ
            ...
            case opcode_1.WasmOpcode.F64_SQRT: {
                var a_21 = this.context.stack.pop();
                this.context.stack.push(new WasmStackItem(a_21.type, Math.sqrt(a_21.value)));
                break;
            }
            //LOAD
            ...
            case opcode_1.WasmOpcode.F64_STORE: {
                var a_22 = this.context.stack.pop(); // address
...
var node_1 = __webpack_require__(4);
var opcode_1 = __webpack_require__(7);
var builtins_helper_1 = __webpack_require__(35);
var assert_1 = __webpack_require__(0);
var wasm_type_1 = __webpack_require__(9);
var logger_1 = __webpack_require__(10);
var wasm_signature_1 = __webpack_require__(42);
var bitness_1 = __webpack_require__(32);
var wasm_section_1 = __webpack_require__(13);
var wasm_external_kind_1 = __webpack_require__(36);
var wasm_global_1 = __webpack_require__(38);
var wasm_function_1 = __webpack_require__(37);
var wasm_import_1 = __webpack_require__(39);
var wasm_local_1 = __webpack_require__(40);
var wasm_shared_offset_1 = __webpack_require__(41);
var wasm_assembler_1 = __webpack_require__(33);
var terminal_1 = __webpack_require__(1);
...
var WasmModule = (function () {
    ...
    WasmModule.prototype.emitGlobalDeclarations = function (array) {
        ...
        while (global) {
            var dataType = typeToDataType(global.symbol.resolvedType, this.bitness);
    ...
    WasmModule.prototype.emitExportTable = function (array) {
        ...
        while (fn != null) {
            if (fn.isExported) {
                var fnName = getWasmFunctionName(fn.symbol);
    ...
    WasmModule.prototype.emitFunctionBodies = function (array) {
        ...
        while (fn != null) {
            ...
            var wasmFunctionName = getWasmFunctionName(fn.symbol);
    ...
    WasmModule.prototype.emitNames = function (array) {
        ...
        while (fn != null) {
            ...
            var name_1 = getWasmFunctionName(fn.symbol);
    ...
    WasmModule.prototype.prepareToEmit = function (node) {
        if (node.kind == node_1.NodeKind.STRING) {
            ...
            while (argument != returnType) {
                ...
                var type = wasmWrapType(wasmType);
            ...
            var signatureIndex = this.allocateSignature(argumentTypesFirst, wasmWrapType(wasmReturnType), argumentCount);
            var body = node.functionBody();
            // Functions without bodies are imports
            if (body == null) {
                var wasmFunctionName = getWasmFunctionName(symbol);
    ...
    WasmModule.prototype.emitConstructor = function (array, byteOffset, fn) {
        ...
        if (type.resolvedType.isArray()) {
            ...
            var elementSize = getTypedArrayElementSize(type.resolvedType.symbol.name);
            this.assembler.appendOpcode(array, byteOffset, opcode_1.WasmOpcode.GET_LOCAL, 0);
            this.assembler.writeUnsignedLEB128(array, 0);
    ...
    WasmModule.prototype.emitNode = function (array, byteOffset, node) {
        ...
        if (node.kind == node_1.NodeKind.BLOCK) {
            ...
            if (returnNode == null && branch === null) {
                ...
                if (returnNode !== null) {
                    var returnType = symbolToValueType(returnNode.resolvedType.symbol);
            ...
            if (branch != null) {
                ...
                this.assembler.appendOpcode(array, byteOffset, opcode_1.WasmOpcode.IF_ELSE);
                var dataType = typeToDataType(returnNode.resolvedType, this.bitness);
            ...
            var trueValueType = symbolToValueType(trueValue.resolvedType.symbol);
            ...
            if (kind == node_1.NodeKind.POSTFIX_INCREMENT || kind == node_1.NodeKind.POSTFIX_DECREMENT) {
                ...
                var dataType = typeToDataType(value.resolvedType, this.bitness);
            ...
            var dataTypeLeft = typeToDataType(left.resolvedType, this.bitness);
            var dataTypeRight = typeToDataType(right.resolvedType, this.bitness);
...
var scope_1 = __webpack_require__(15);
var utils_1 = __webpack_require__(6);
var const_1 = __webpack_require__(47);
var assert_1 = __webpack_require__(0);
var compiler_1 = __webpack_require__(11);
var terminal_1 = __webpack_require__(1);
/**
...
var filesystem_1 = __webpack_require__(20);
var terminal_1 = __webpack_require__(1);
var javascript = __webpack_require__(22);
...
var jstypes = __webpack_require__(28);
var runtime = __webpack_require__(27);
var wrapper = __webpack_require__(29);
var malloc = __webpack_require__(24);
var builtins = __webpack_require__(30);
var initializer = __webpack_require__(31);
