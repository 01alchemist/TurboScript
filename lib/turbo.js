...
System.register("backends/javascript/turbojs", ["utils/stringbuilder", "compiler/core/node", "compiler/parser/parser", "backends/javascript/js", "compiler/core/symbol"], function (exports_10, context_10) {
    "use strict";
...
System.register("utils/imports", [], function (exports_11, context_11) {
    "use strict";
...
System.register("backends/webassembly/opcode", [], function (exports_12, context_12) {
    "use strict";
...
System.register("utils/utils", [], function (exports_13, context_13) {
    "use strict";
...
System.register("backends/webassembly/webassembly", ["compiler/core/symbol", "utils/bytearray", "utils/imports", "compiler/core/node", "backends/webassembly/opcode", "utils/utils"], function (exports_14, context_14) {
    "use strict";
            ...
            WasmModule = class WasmModule {
                ...
                emitFunctionBodies(array) {
                    ...
                    while (fn != null) {
                        ...
                        // }
                        if (lastChild && lastChild.kind !== node_6.NodeKind.RETURN) {
                ...
                prepareToEmit(node) {
                    if (node.kind == node_6.NodeKind.STRING) {
                        ...
                        (node.symbol.kind != symbol_6.SymbolKind.FUNCTION_INSTANCE ||
                            node.symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE && !node.parent.isTemplate())) {
                        let returnType = node.functionReturnType();
                ...
                emitNode(array, byteOffset, node) {
                    ...
                    if (node.kind == node_6.NodeKind.BLOCK) {
                        ...
                        if (node.parent.kind === node_6.NodeKind.IF || node.parent.kind === node_6.NodeKind.WHILE) {
                        ...
                        else if (node.symbol.kind == symbol_6.SymbolKind.VARIABLE_LOCAL) {
                            if (value &&
                                value.kind != node_6.NodeKind.NAME &&
                                value.kind != node_6.NodeKind.CALL &&
                                value.kind != node_6.NodeKind.NEW &&
                                value.kind != node_6.NodeKind.DOT &&
                                value.rawValue) {
                        ...
                        if (!symbol.node.isExternalImport() && symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE) {
                            ...
                            if (dotTarget.kind == node_6.NodeKind.NEW) {
...
System.register("backends/asmjs/asmjs", ["utils/bytearray", "utils/stringbuilder", "compiler/core/node", "compiler/parser/parser", "backends/javascript/js", "compiler/core/symbol", "utils/imports"], function (exports_16, context_16) {
    "use strict";
                            ...
                            if (value.symbol != null || !value.symbol.isGetter()) {
                                ...
                                if (node.firstChild) {
                                    ...
                                    if (value.kind == node_7.NodeKind.DOT && !value.resolvedType.symbol.node.isDeclare()) {
                                        let dotTarget = value.dotTarget();
                                        if (dotTarget.kind == node_7.NodeKind.NEW) {
                                            this.emitExpression(dotTarget, parser_5.Precedence.LOWEST);
                                        }
                                        else if (dotTarget.symbol.kind == symbol_7.SymbolKind.VARIABLE_GLOBAL) {
...
System.register("compiler/parser/preparser", ["utils/log", "compiler/scanner/scanner", "turboscript", "utils/stringbuilder"], function (exports_17, context_17) {
    "use strict";
    ...
    function resolveImport(importPath) {
        ...
        if (contents == null) {
            turboscript_1.printError(stringbuilder_9.StringBuilder_new().append("Cannot read from ").append(importPath).finish());
            return null;
        }
        return contents;
    }
    var log_4, scanner_4, turboscript_1, stringbuilder_9;
    return {
        setters: [
            function (log_4_1) {
                log_4 = log_4_1;
...
System.register("compiler/compiler", ["compiler/analyzer/type-checker", "compiler/core/node", "utils/log", "compiler/preprocessor/preprocessor", "compiler/core/scope", "compiler/scanner/scanner", "compiler/parser/parser", "compiler/optimizer/shaking", "utils/stringbuilder", "backends/webassembly/webassembly", "library/library", "backends/asmjs/asmjs", "compiler/parser/preparser"], function (exports_18, context_18) {
    "use strict";
    ...
    var type_checker_1, node_8, log_5, preprocessor_1, scope_1, scanner_5, parser_6, shaking_1, stringbuilder_10, webassembly_1, library_1, asmjs_1, preparser_1, CompileTarget, Compiler;
    return {
        setters: [
        ...
        execute: function () {
            ...
            (function (CompileTarget) {
                ...
                CompileTarget[CompileTarget["CPP"] = 1] = "CPP";
                CompileTarget[CompileTarget["JAVASCRIPT"] = 2] = "JAVASCRIPT";
                CompileTarget[CompileTarget["ASMJS"] = 3] = "ASMJS";
...
System.register("compiler/const", [], function (exports_19, context_19) {
    "use strict";
...
System.register("compiler/analyzer/type-checker", ["compiler/core/symbol", "compiler/core/type", "compiler/core/node", "compiler/compiler", "utils/log", "compiler/core/scope", "utils/stringbuilder", "utils/imports", "compiler/const"], function (exports_20, context_20) {
    "use strict";
            ...
            if (symbol.kind == symbol_8.SymbolKind.FUNCTION_INSTANCE) {
                ...
                if (symbol.name == "constructor") {
                    ...
                    if (body !== null) {
                        ...
                        if (variablesNode.kind !== node_9.NodeKind.VARIABLES) {
                            let _variablesNode = node_9.createVariables();
                        ...
                        if (firstVariable !== undefined) {
                            if (firstVariable.stringValue !== "this") {
                                variablesNode.insertChildBefore(firstVariable, node_9.createVariable("this", node_9.createType(parent.resolvedType), null));
                            }
                            ...
                            variablesNode.appendChild(node_9.createVariable("this", node_9.createType(parent.resolvedType), null));
                        }
                        // All constructors have special return "this" type
                        let returnNode = node_9.createReturn(node_9.createName("this"));
                    ...
                    if (firstArgument.stringValue !== "this") {
                        node.insertChildBefore(firstArgument, node_9.createVariable("this", node_9.createType(parent.resolvedType), null));
                    }
    ...
    function cloneChildren(child, parentNode, parameters, templateName, typeName) {
        ...
        while (child) {
            if (child.stringValue == "this" && child.parent.symbol &&
                child.parent.symbol.kind == symbol_8.SymbolKind.FUNCTION_INSTANCE && child.kind == node_9.NodeKind.TYPE) {
                child = child.nextSibling;
                continue;
            }
            let childNode;
    ...
    function resolve(context, node, parentScope) {
        ...
        if (kind == node_9.NodeKind.FILE || kind == node_9.NodeKind.GLOBAL) {
                ...
                if (target.isType() && (target.resolvedType.isEnum() || target.resolvedType.hasInstanceMembers()) ||
                    ...
                    if (name.length > 0) {
                        ...
                        if (symbol == null) {
                            ...
                            if (node.parent.stringValue === node.stringValue && node.parent.kind === node_9.NodeKind.CALL) {
            ...
            if (yes.resolvedType != commonType && (yes.resolvedType != context.nullType || !commonType.isReference()) &&
                ...
                context.log.error(log_6.spanRanges(yes.range, no.range), stringbuilder_11.StringBuilder_new()
                    .append("Type '")
        ...
        else if (kind == node_9.NodeKind.TYPE) {
            //ignore types
        }
        else {
    ...
    var symbol_8, type_2, node_9, compiler_3, log_6, scope_2, stringbuilder_11, imports_3, const_1, CheckContext, CheckMode;
    return {
        setters: [
            function (symbol_8_1) {
                symbol_8 = symbol_8_1;
...
System.register("compiler/core/symbol", ["compiler/core/node", "utils/imports"], function (exports_21, context_21) {
    "use strict";
...
System.register("compiler/core/type", ["compiler/core/symbol", "utils/stringbuilder"], function (exports_22, context_22) {
    "use strict";
...
System.register("compiler/core/node", ["compiler/core/symbol"], function (exports_23, context_23) {
    "use strict";
...
System.register("utils/log", ["utils/stringbuilder"], function (exports_24, context_24) {
    "use strict";
...
System.register("turboscript", ["utils/log", "utils/stringbuilder", "compiler/compiler"], function (exports_25, context_25) {
    "use strict";
...
`);
    ...
    var log_7, stringbuilder_14, compiler_4, Color, CommandLineArgument, firstArgument, lastArgument, main;
    return {
        setters: [
            function (log_7_1) {
                log_7 = log_7_1;
