            ...
            WasmModule = class WasmModule {
                ...
                emitFunctionBodies(array) {
                    ...
                    while (fn != null) {
                        ...
                        appendOpcode(bodyData, sectionOffset, opcode_1.WasmOpcode.END); //end, 0x0b, indicating the end of the bod
                ...
                emitConstructor(array, byteOffset, node) {
                    ...
                    if (type.resolvedType.isArray()) {
                        ...
                        **/
                        ...
                        let callIndex = this.getWasmFunctionCallIndex(callSymbol) + 1;
