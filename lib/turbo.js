...
System.register("compiler/optimizer/shaking", ["compiler/core/symbol", "compiler/core/node"], function (exports_7, context_7) {
    "use strict";
...
System.register("backends/c++/c++", ["utils/stringbuilder", "compiler/compiler", "compiler/core/node", "compiler/parser/parser", "compiler/core/symbol", "compiler/scanner/scanner"], function (exports_8, context_8) {
    ...
    var stringbuilder_5, compiler_1, node_3, parser_2, symbol_3, scanner_3, TypeMode, SourceMode, CResult;
    return {
        setters: [
...
System.register("backends/webassembly/webassembly", ["compiler/core/symbol", "utils/bytearray", "utils/imports", "compiler/core/node", "backends/webassembly/opcode", "utils/utils", "backends/webassembly/builtins-helper"], function (exports_14, context_14) {
    "use strict";
    ...
    function logOpcode(array, offset = 0, opcode) {
        if (debug) {
            array.log += `${utils_1.toHex(offset + array.position)}: ${utils_1.toHex(opcode, 2)}                    ; ${opcode_2.WasmOpcode[opcode]}\n`;
        }
    }
    ...
    var symbol_5, bytearray_1, imports_1, node_5, opcode_2, utils_1, builtins_helper_1, WASM_MAGIC, WASM_VERSION, WASM_SIZE_IN_PAGES, WASM_SET_MAX_MEMORY, WASM_MAX_MEMORY, WASM_MEMORY_INITIALIZER_BASE, debug, Bitness, WasmType, WasmSection, WasmExternalKind, WasmWrappedType, WasmSignature, SectionBuffer, WasmGlobal, WasmLocal, WasmFunction, WasmImport, WasmModule, WasmSharedOffset;
    return {
        setters: [
            function (symbol_5_1) {
                symbol_5 = symbol_5_1;
            ...
            WasmModule = class WasmModule {
                ...
                emitGlobalDeclarations(array) {
                    ...
                    while (global) {
                        ...
                        if (value) {
                            if (value.rawValue) {
                                section.data.writeUnsignedLEB128(opcode_2.WasmOpcode[`${dataType}_CONST`]);
                                switch (dataType) {
                                    case "I32":
                        ...
                        section.data.writeUnsignedLEB128(opcode_2.WasmOpcode.END);
                        global = global.next;
                    }
                    wasmFinishSection(array, section);
                }
                ...
                emitFunctionBodies(array) {
                    ...
                    while (fn != null) {
                        ...
                        // }
                        if (lastChild && lastChild.kind !== node_5.NodeKind.RETURN) {
                            appendOpcode(bodyData, sectionOffset, opcode_2.WasmOpcode.RETURN);
                        }
                        appendOpcode(bodyData, sectionOffset, opcode_2.WasmOpcode.END); //end, 0x0b, indicating the end of the body
                ...
                emitDataSegments(array) {
                    ...
                    appendOpcode(section.data, array.position, opcode_2.WasmOpcode.I32_CONST);
                    ...
                    appendOpcode(section.data, array.position, opcode_2.WasmOpcode.END);
                ...
                prepareToEmit(node) {
                    if (node.kind == node_5.NodeKind.STRING) {
                        ...
                        if (symbol.kind == symbol_5.SymbolKind.FUNCTION_GLOBAL && symbol.name == "init_malloc") {
                ...
                emitLoadFromMemory(array, byteOffset, type, relativeBase, offset) {
                    ...
                    if (relativeBase != null) {
                        ...
                        opcode = opcode_2.WasmOpcode.I32_CONST;
                        appendOpcode(array, byteOffset, opcode);
                    ...
                    if (sizeOf == 1) {
                        opcode = type.isUnsigned() ? opcode_2.WasmOpcode.I32_LOAD8_U : opcode_2.WasmOpcode.I32_LOAD8_S;
                        appendOpcode(array, byteOffset, opcode);
                        log(array, byteOffset, 0, "alignment");
                        array.writeUnsignedLEB128(0);
                    }
                    else if (sizeOf == 2) {
                        opcode = type.isUnsigned() ? opcode_2.WasmOpcode.I32_LOAD16_U : opcode_2.WasmOpcode.I32_LOAD16_S;
                        appendOpcode(array, byteOffset, opcode);
                        ...
                        if (type.isFloat()) {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F32_LOAD);
                        }
                        else {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_LOAD);
                        }
                        ...
                        if (type.isDouble()) {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F64_LOAD);
                        }
                        else {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I64_LOAD);
                        }
                ...
                emitStoreToMemory(array, byteOffset, type, relativeBase, offset, value) {
                    ...
                    if (relativeBase != null) {
                        ...
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_CONST);
                        log(array, byteOffset, 0, "i32 literal");
                        array.writeUnsignedLEB128(0);
                    }
                    ...
                    let sizeOf = type.variableSizeOf(this.context);
                    if (sizeOf == 1) {
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_STORE8);
                        log(array, byteOffset, 0, "alignment");
                        array.writeUnsignedLEB128(0);
                    }
                    else if (sizeOf == 2) {
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_STORE16);
                        log(array, byteOffset, 1, "alignment");
                        array.writeUnsignedLEB128(1);
                    }
                    else if (sizeOf == 4 || type.isClass()) {
                        if (type.isFloat()) {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F32_STORE);
                        }
                        else {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_STORE);
                        }
                        log(array, byteOffset, 2, "alignment");
                        array.writeUnsignedLEB128(2);
                    }
                        ...
                        if (type.isDouble()) {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F64_STORE);
                        }
                        else if (type.isLong()) {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I64_STORE);
                        }
                        log(array, byteOffset, 3, "alignment");
                        array.writeUnsignedLEB128(3);
                    }
                ...
                emitInstance(array, byteOffset, node) {
                    ...
                    if (type.resolvedType.isArray()) {
                        ...
                        if (lengthNode.kind == node_5.NodeKind.INT32) {
                            ...
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_MUL); //array byteLength
                        }
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_CONST);
                        array.writeLEB128(size); // array element size
                        let callIndex = this.getWasmFunctionCallIndex(callSymbol);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.CALL);
                ...
                emitConstructor(array, byteOffset, fn) {
                    ...
                    assert(size > 0);
                    if (type.resolvedType.isArray()) {
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.GET_LOCAL);
                        array.writeUnsignedLEB128(0); // array parameter byteLength
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_CONST);
                        log(array, byteOffset, size, "i32 literal");
                        array.writeLEB128(size); // size of array class, default is 8 bytes
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_ADD);
                    }
                    else if (type.resolvedType.isTypedArray()) {
                        let elementSize = getTypedArrayElementSize(type.resolvedType.symbol.name);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.GET_LOCAL);
                        ...
                        array.writeLEB128(elementSize);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_SHL);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_CONST);
                        log(array, byteOffset, size, "i32 literal");
                        array.writeLEB128(size);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_ADD);
                    ...
                    appendOpcode(array, byteOffset, opcode_2.WasmOpcode.SET_LOCAL);
                ...
                emitNode(array, byteOffset, node) {
                    ...
                    if (node.kind == node_5.NodeKind.BLOCK) {
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.BLOCK);
                        if (node.parent.kind === node_5.NodeKind.IF || node.parent.kind === node_5.NodeKind.WHILE) {
                        ...
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.END);
                    }
                        ...
                        array.append(WasmType.block_type);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.LOOP);
                        log(array, 0, WasmType.block_type, WasmType[WasmType.block_type]);
                        array.append(WasmType.block_type);
                        if (value.kind != node_5.NodeKind.BOOLEAN) {
                            this.emitNode(array, byteOffset, value);
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_EQZ);
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.BR_IF);
                        ...
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.BR);
                        ...
                        assert(label > 0);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.BR);
                        array.writeUnsignedLEB128(label - (node.kind == node_5.NodeKind.BREAK ? 0 : 1));
                    }
                        ...
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.RETURN);
                    }
                        ...
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.IF);
                        append(array, 0, WasmType.block_type, WasmType[WasmType.block_type]);
                        this.emitNode(array, byteOffset, node.ifTrue());
                        if (branch != null) {
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.IF_ELSE);
                        ...
                        if (node.symbol.name == "this" && this.currentFunction.symbol.name == "constructor") {
                            ...
                            if (value &&
                                ...
                                if (node.symbol.resolvedType.isFloat()) {
                                    appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F32_CONST);
                                    ...
                                    appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F64_CONST);
                                    ...
                                    appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I64_CONST);
                        ...
                        let wasmFunctionName = getWasmFunctionName(symbol);
                        if (builtins_helper_1.isBuiltin(wasmFunctionName)) {
                            appendOpcode(array, byteOffset, builtins_helper_1.getBuiltinOpcode(symbol.name));
                        }
                        else {
                        ...
                        if (resolvedType.isFloat()) {
                            this.emitNode(array, byteOffset, node.unaryValue());
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F32_NEG);
                        }
                        else if (resolvedType.isDouble()) {
                            this.emitNode(array, byteOffset, node.unaryValue());
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F64_NEG);
                        }
                            ...
                            array.writeLEB128(0);
                            this.emitNode(array, byteOffset, node.unaryValue());
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_SUB);
                        }
                            ...
                            array.writeLEB128(0);
                            this.emitNode(array, byteOffset, node.unaryValue());
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I64_SUB);
                        }
                    }
                        ...
                        array.writeLEB128(~0);
                        this.emitNode(array, byteOffset, node.unaryValue());
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_XOR);
                    }
                        ...
                        if ((from == context.int32Type || from == context.uint32Type) &&
                            ...
                            if (value.kind == node_5.NodeKind.INT32) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.I64_EXTEND_U_I32 : opcode_2.WasmOpcode.I64_EXTEND_S_I32);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.INT32) {
                                ...
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.F32_CONVERT_U_I32 : opcode_2.WasmOpcode.F32_CONVERT_S_I32);
                            }
                        }
                        else if ((from == context.int32Type || from == context.uint32Type) &&
                            ...
                            if (value.kind == node_5.NodeKind.INT32) {
                                ...
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.F64_CONVERT_U_I32 : opcode_2.WasmOpcode.F64_CONVERT_S_I32);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.INT64) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_WRAP_I64);
                            }
                        }
                        else if ((from == context.int64Type || from == context.uint64Type) &&
                            type == context.float32Type) {
                            if (value.kind == node_5.NodeKind.INT32) {
                                ...
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.F32_CONVERT_U_I64 : opcode_2.WasmOpcode.F32_CONVERT_S_I64);
                            }
                        }
                        else if ((from == context.int64Type || from == context.uint64Type) &&
                            type == context.float64Type) {
                            if (value.kind == node_5.NodeKind.INT64) {
                                ...
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.F64_CONVERT_U_I64 : opcode_2.WasmOpcode.F64_CONVERT_S_I64);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT32) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.I32_TRUNC_U_F32 : opcode_2.WasmOpcode.I32_TRUNC_S_F32);
                            }
                        }
                        else if (from == context.float32Type &&
                            (type == context.int64Type || type == context.uint64Type)) {
                            if (value.kind == node_5.NodeKind.FLOAT32) {
                                ...
                                let isUnsigned = type.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.I64_TRUNC_U_F32 : opcode_2.WasmOpcode.I64_TRUNC_S_F32);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT32) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F64_PROMOTE_F32);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT64) {
                                ...
                                let isUnsigned = type.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.I32_TRUNC_U_F64 : opcode_2.WasmOpcode.I32_TRUNC_S_F64);
                            }
                        }
                        else if (from == context.float64Type &&
                            (type == context.int64Type || type == context.uint64Type)) {
                            if (value.kind == node_5.NodeKind.FLOAT64) {
                                ...
                                let isUnsigned = type.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, isUnsigned ? opcode_2.WasmOpcode.I64_TRUNC_U_F64 : opcode_2.WasmOpcode.I64_TRUNC_S_F64);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT64) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                appendOpcode(array, byteOffset, opcode_2.WasmOpcode.F32_DEMOTE_F64);
                            }
                        }
                        else {
                            this.emitNode(array, byteOffset, value);
                        ...
                        this.emitNode(array, byteOffset, node.binaryLeft());
                        this.emitNode(array, byteOffset, node.binaryRight());
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_AND);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_CONST);
                        log(array, byteOffset, 1, "i32 literal");
                        array.writeLEB128(1);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_EQ);
                    }
                    else if (node.kind == node_5.NodeKind.LOGICAL_OR) {
                        this.emitNode(array, byteOffset, node.binaryLeft());
                        this.emitNode(array, byteOffset, node.binaryRight());
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_OR);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_CONST);
                        log(array, byteOffset, 1, "i32 literal");
                        array.writeLEB128(1);
                        appendOpcode(array, byteOffset, opcode_2.WasmOpcode.I32_EQ);
                        ...
                        if (kind == node_5.NodeKind.POSTFIX_INCREMENT || kind == node_5.NodeKind.POSTFIX_DECREMENT) {
                            ...
                            if (node.parent.kind != node_5.NodeKind.RETURN) {
                                ...
                                appendOpcode(array, byteOffset, opcode_2.WasmOpcode[`${dataType}_${operation}`]);
                                if (value.symbol.kind == symbol_5.SymbolKind.VARIABLE_GLOBAL) {
                                    appendOpcode(array, byteOffset, opcode_2.WasmOpcode.SET_GLOBAL);
                        ...
                        if (node.kind == node_5.NodeKind.ADD) {
                            ...
                            appendOpcode(array, byteOffset, opcode_2.WasmOpcode[`${dataTypeLeft}_ADD`]);
                        }
                        else if (node.kind == node_5.NodeKind.BITWISE_AND) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_AND`]);
                        }
                        else if (node.kind == node_5.NodeKind.BITWISE_OR) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_OR`]);
                        }
                        else if (node.kind == node_5.NodeKind.BITWISE_XOR) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_XOR`]);
                        }
                        else if (node.kind == node_5.NodeKind.EQUAL) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_EQ`]);
                        }
                        else if (node.kind == node_5.NodeKind.MULTIPLY) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_MUL`]);
                        }
                        else if (node.kind == node_5.NodeKind.NOT_EQUAL) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_NE`]);
                        }
                        else if (node.kind == node_5.NodeKind.SHIFT_LEFT) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_SHL`]);
                        }
                        else if (node.kind == node_5.NodeKind.SUBTRACT) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_2.WasmOpcode[`${dataTypeLeft}_SUB`]);
                        }
                        else if (node.kind == node_5.NodeKind.DIVIDE) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_DIV`] :
                                (isUnsigned ? opcode_2.WasmOpcode[`${dataTypeLeft}_DIV_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_DIV_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.GREATER_THAN) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_GT`] :
                                (isUnsigned ? opcode_2.WasmOpcode[`${dataTypeLeft}_GT_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_GT_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.GREATER_THAN_EQUAL) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_GE`] :
                                (isUnsigned ? opcode_2.WasmOpcode[`${dataTypeLeft}_GE_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_GE_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.LESS_THAN) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_LT`] :
                                (isUnsigned ? opcode_2.WasmOpcode[`${dataTypeLeft}_LT_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_LT_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.LESS_THAN_EQUAL) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_LE`] :
                                (isUnsigned ? opcode_2.WasmOpcode[`${dataTypeLeft}_LE_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_LE_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.REMAINDER) {
                            this.emitBinaryExpression(array, byteOffset, node, isUnsigned ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_REM_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_REM_S`]);
                        }
                        else if (node.kind == node_5.NodeKind.SHIFT_RIGHT) {
                            this.emitBinaryExpression(array, byteOffset, node, isUnsigned ?
                                opcode_2.WasmOpcode[`${dataTypeLeft}_SHR_U`] : opcode_2.WasmOpcode[`${dataTypeLeft}_SHR_S`]);
                        }
                        else {
                            assert(false);
                        }
...
System.register("library/library", ["compiler/compiler"], function (exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    function readLibraryFile(path) {
        return stdlib.IO_readTextFile(TURBO_LIBRARY_PATH + path);
    }
    var compiler_2, TURBO_LIBRARY_PATH, Library;
    return {
        setters: [
        ...
        execute: function () {
            ...
            Library = class Library {
                static get(target) {
                    let lib;
                    switch (target) {
                        case compiler_2.CompileTarget.JAVASCRIPT:
...
System.register("compiler/parser/preparser", ["utils/log", "compiler/scanner/scanner", "turboscript", "utils/stringbuilder"], function (exports_16, context_16) {
    "use strict";
...
System.register("compiler/compiler", ["compiler/analyzer/type-checker", "compiler/core/node", "utils/log", "compiler/preprocessor/preprocessor", "compiler/core/scope", "compiler/scanner/scanner", "compiler/parser/parser", "compiler/optimizer/shaking", "utils/stringbuilder", "backends/webassembly/webassembly", "library/library", "compiler/parser/preparser"], function (exports_17, context_17) {
    "use strict";
...
System.register("compiler/const", [], function (exports_18, context_18) {
    "use strict";
...
System.register("compiler/analyzer/type-checker", ["compiler/core/symbol", "compiler/core/type", "compiler/core/node", "compiler/compiler", "utils/log", "compiler/core/scope", "utils/stringbuilder", "utils/imports", "compiler/const"], function (exports_19, context_19) {
    "use strict";
    ...
    var symbol_6, type_2, node_7, compiler_3, log_6, scope_2, stringbuilder_9, imports_2, const_1, CheckContext, CheckMode;
    return {
        setters: [
            function (symbol_6_1) {
                symbol_6 = symbol_6_1;
...
System.register("compiler/core/symbol", ["compiler/core/node", "utils/imports"], function (exports_20, context_20) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_20("SYMBOL_FLAG_IS_TEMPLATE", SYMBOL_FLAG_IS_TEMPLATE = 1 << 12);
            Symbol = class Symbol {
                constructor() {
...
System.register("compiler/core/type", ["compiler/core/symbol", "utils/stringbuilder"], function (exports_21, context_21) {
    "use strict";
...
System.register("compiler/core/node", ["compiler/core/symbol"], function (exports_22, context_22) {
    "use strict";
    ...
    exports_22("createImportFrom", createImportFrom);
    ...
    return {
        ...
        execute: function () {
            ...
            exports_22("NODE_FLAG_LIBRARY", NODE_FLAG_LIBRARY = 1 << 3);
            exports_22("NODE_FLAG_GET", NODE_FLAG_GET = 1 << 4);
            exports_22("NODE_FLAG_OPERATOR", NODE_FLAG_OPERATOR = 1 << 5);
            exports_22("NODE_FLAG_POSITIVE", NODE_FLAG_POSITIVE = 1 << 6);
            exports_22("NODE_FLAG_PRIVATE", NODE_FLAG_PRIVATE = 1 << 7);
            exports_22("NODE_FLAG_PROTECTED", NODE_FLAG_PROTECTED = 1 << 8);
            exports_22("NODE_FLAG_PUBLIC", NODE_FLAG_PUBLIC = 1 << 9);
            exports_22("NODE_FLAG_SET", NODE_FLAG_SET = 1 << 10);
            exports_22("NODE_FLAG_STATIC", NODE_FLAG_STATIC = 1 << 11);
            exports_22("NODE_FLAG_UNSAFE", NODE_FLAG_UNSAFE = 1 << 12);
            exports_22("NODE_FLAG_JAVASCRIPT", NODE_FLAG_JAVASCRIPT = 1 << 13);
            exports_22("NODE_FLAG_UNSIGNED_OPERATOR", NODE_FLAG_UNSIGNED_OPERATOR = 1 << 14);
            exports_22("NODE_FLAG_VIRTUAL", NODE_FLAG_VIRTUAL = 1 << 15);
            exports_22("NODE_FLAG_START", NODE_FLAG_START = 1 << 16);
            exports_22("NODE_FLAG_ANYFUNC", NODE_FLAG_ANYFUNC = 1 << 17);
            exports_22("NODE_FLAG_GENERIC", NODE_FLAG_GENERIC = 1 << 18);
...
System.register("utils/log", ["utils/stringbuilder"], function (exports_23, context_23) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_23("SourceRange", SourceRange);
...
System.register("turboscript", ["utils/log", "utils/stringbuilder", "compiler/compiler"], function (exports_24, context_24) {
    "use strict";
...
`);
    ...
    function main_entry() {
        ...
        while (argument != null) {
            ...
            if (text.startsWith("-")) {
                if (text == "-h" || text == "-help" || text == "--help" || text == "/?") {
                    ...
                    target = compiler_4.CompileTarget.CPP;
                }
                else if (text == "--js") {
        ...
        if (!compiler.log.hasErrors()) {
            if (target == compiler_4.CompileTarget.CPP && stdlib.IO_writeTextFile(output, compiler.outputCPP) &&
    ...
    var log_7, stringbuilder_12, compiler_4, Color, CommandLineArgument, firstArgument, lastArgument, main;
    return {
        setters: [
            function (log_7_1) {
                log_7 = log_7_1;
