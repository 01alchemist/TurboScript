            ...
            ParserContext = class ParserContext {
                ...
                parseInternalImports() {
                    ...
                    if (this.peek(lexer_1.TokenKind.MULTIPLY)) {
                        ...
                        this.expect(lexer_1.TokenKind.RIGHT_BRACE);
                    }
...
System.register("preparser", ["log", "lexer", "main", "stringbuilder"], function (exports_17, context_17) {
    "use strict";
    ...
    var log_4, lexer_4, main_1, stringbuilder_9;
    return {
        setters: [
            function (log_4_1) {
                log_4 = log_4_1;
...
System.register("compiler", ["checker", "node", "log", "preprocessor", "scope", "lexer", "parser", "shaking", "stringbuilder", "wasm", "library/library", "asmjs", "preparser"], function (exports_18, context_18) {
    ...
    var checker_1, node_8, log_5, preprocessor_1, scope_1, lexer_5, parser_6, shaking_1, stringbuilder_10, wasm_1, library_1, asmjs_1, preparser_1, CompileTarget, Compiler;
    return {
        setters: [
