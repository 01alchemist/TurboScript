System.register("utils/stringbuilder", [], function (exports_1, context_1) {
    "use strict";
...
System.register("compiler/scanner/scanner", ["utils/log", "utils/stringbuilder"], function (exports_2, context_2) {
    "use strict";
...
System.register("utils/bytearray", [], function (exports_3, context_3) {
    "use strict";
...
System.register("compiler/parser/parser", ["compiler/scanner/scanner", "utils/log", "utils/stringbuilder", "compiler/core/node"], function (exports_4, context_4) {
    "use strict";
    ...
    var scanner_1, log_2, stringbuilder_2, node_1, Precedence, ParseKind, StatementMode, ParserContext;
    return {
        setters: [
        ...
        execute: function () {
            ...
            ParserContext = class ParserContext {
                ...
                parseDelete() {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.DELETE);
                    this.advance();
                    let value = null;
                ...
                parseIf() {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.IF);
                    this.advance();
                    if (!this.expect(scanner_1.TokenKind.LEFT_PARENTHESIS)) {
                        return null;
                    }
                ...
                parseWhile() {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.WHILE);
                    this.advance();
                    if (!this.expect(scanner_1.TokenKind.LEFT_PARENTHESIS)) {
                        return null;
                    }
                ...
                parseReturn() {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.RETURN);
                    this.advance();
                    let value = null;
                    if (!this.peek(scanner_1.TokenKind.SEMICOLON)) {
                        value = this.parseExpression(Precedence.LOWEST, ParseKind.EXPRESSION);
                ...
                parseEnum(firstFlag) {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.ENUM);
                    this.advance();
                    let name = this.current;
                ...
                parseParameters() {
                    ...
                    let open = this.current;
                    let close;
                    assert(open.kind == scanner_1.TokenKind.LESS_THAN);
                    this.advance();
                    while (true) {
                        let name = this.current;
                        if (!this.expect(scanner_1.TokenKind.IDENTIFIER)) {
                ...
                parseImports() {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.IMPORT);
                    this.advance();
                    ...
                    if (this.peek(scanner_1.TokenKind.MULTIPLY)) {
                        ...
                        assert(this.eat(scanner_1.TokenKind.MULTIPLY));
                        assert(this.eat(scanner_1.TokenKind.AS));
                ...
                parseModule(firstFlag) {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.MODULE);
                    this.advance();
                    let name = this.current;
                    if (!this.expect(scanner_1.TokenKind.IDENTIFIER)) {
                        return null;
                ...
                parseClass(firstFlag) {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.CLASS);
                    this.advance();
                    let name = this.current;
                    if (!this.expect(scanner_1.TokenKind.IDENTIFIER)) {
                        return null;
                ...
                parseFunction(firstFlag, parent) {
                    ...
                    if (parent != null && this.eat(scanner_1.TokenKind.OPERATOR)) {
                        ...
                        if (parent == null) {
                            assert(token.kind == scanner_1.TokenKind.FUNCTION);
                            this.advance();
                        }
                ...
                parseVariables(firstFlag, parent) {
                    ...
                    if (parent == null) {
                        assert(token.kind == scanner_1.TokenKind.CONST || token.kind == scanner_1.TokenKind.LET || token.kind == scanner_1.TokenKind.VAR);
                        this.advance();
                    }
...
System.register("compiler/preprocessor/preprocessor", ["utils/log", "utils/stringbuilder", "compiler/scanner/scanner", "compiler/parser/parser"], function (exports_5, context_5) {
    "use strict";
    var __moduleName = context_5 && context_5.id;
    var log_3, stringbuilder_3, scanner_2, parser_1, PreprocessorValue, PreprocessorFlag, Preprocessor;
    return {
        setters: [
            function (log_3_1) {
                log_3 = log_3_1;
            ...
            function (scanner_2_1) {
                scanner_2 = scanner_2_1;
            },
            function (parser_1_1) {
                parser_1 = parser_1_1;
            }
        ...
        execute: function () {
            ...
            Preprocessor = class Preprocessor {
                ...
                advance() {
                    if (!this.peek(scanner_2.TokenKind.END_OF_FILE)) {
                        this.previous = this.current;
                        this.current = this.current.next;
                    }
                }
                unexpectedToken() {
                    this.log.error(this.current.range, stringbuilder_3.StringBuilder_new()
                        .append("Unexpected ")
                        .append(scanner_2.tokenToString(this.current.kind))
                        .finish());
                }
                expect(kind) {
                    if (!this.peek(kind)) {
                        this.log.error(this.current.range, stringbuilder_3.StringBuilder_new()
                            .append("Expected ")
                            .append(scanner_2.tokenToString(kind))
                            .append(" but found ")
                            .append(scanner_2.tokenToString(this.current.kind))
                            .finish());
                        return false;
                ...
                run(source, log) {
                    ...
                    if (firstToken != null && firstToken.kind == scanner_2.TokenKind.PREPROCESSOR_NEEDED) {
                ...
                // this block.
                scan(isParentLive) {
                    while (!this.peek(scanner_2.TokenKind.END_OF_FILE) &&
                        !this.peek(scanner_2.TokenKind.PREPROCESSOR_ELIF) &&
                        !this.peek(scanner_2.TokenKind.PREPROCESSOR_ELSE) &&
                        !this.peek(scanner_2.TokenKind.PREPROCESSOR_ENDIF)) {
                        var previous = this.previous;
                        var current = this.current;
                        // #define or #undef
                        if (this.eat(scanner_2.TokenKind.PREPROCESSOR_DEFINE) || this.eat(scanner_2.TokenKind.PREPROCESSOR_UNDEF)) {
                            // Only process the directive if control flow is live at this point
                            if (this.expect(scanner_2.TokenKind.IDENTIFIER) && isParentLive) {
                                this.define(this.previous.range.toString(), current.kind == scanner_2.TokenKind.PREPROCESSOR_DEFINE);
                            }
                            // Help out people trying to use this like C
                            if (this.eat(scanner_2.TokenKind.FALSE) || this.eat(scanner_2.TokenKind.INT32) && this.previous.range.toString() == "0") {
                                this.log.error(this.previous.range, "Use '#undef' to turn a preprocessor flag off");
                            }
                            // Scan up to the next newline
                            if (!this.peek(scanner_2.TokenKind.END_OF_FILE) && !this.expect(scanner_2.TokenKind.PREPROCESSOR_NEWLINE)) {
                                while (!this.eat(scanner_2.TokenKind.PREPROCESSOR_NEWLINE) && !this.eat(scanner_2.TokenKind.END_OF_FILE)) {
                                    this.advance();
                                }
                            }
                        ...
                        else if (this.eat(scanner_2.TokenKind.PREPROCESSOR_WARNING) || this.eat(scanner_2.TokenKind.PREPROCESSOR_ERROR)) {
                            var next = this.current;
                            // Scan up to the next newline
                            while (!this.peek(scanner_2.TokenKind.PREPROCESSOR_NEWLINE) && !this.peek(scanner_2.TokenKind.END_OF_FILE)) {
                                this.advance();
                            }
                            // Only process the directive if control flow is live at this point
                            if (isParentLive) {
                                var range = this.current == next ? current.range : log_3.spanRanges(next.range, this.previous.range);
                                this.log.append(range, range.toString(), current.kind == scanner_2.TokenKind.PREPROCESSOR_WARNING ? log_3.DiagnosticKind.WARNING : log_3.DiagnosticKind.ERROR);
                            }
                            // Remove all of these tokens
                            this.eat(scanner_2.TokenKind.PREPROCESSOR_NEWLINE);
                            this.removeTokensFrom(previous);
                        }
                        else if (this.eat(scanner_2.TokenKind.PREPROCESSOR_IF)) {
                            ...
                            while (true) {
                                ...
                                if (condition == PreprocessorValue.ERROR || !this.expect(scanner_2.TokenKind.PREPROCESSOR_NEWLINE)) {
                                    return false;
                                }
                                ...
                                // #elif
                                if (this.eat(scanner_2.TokenKind.PREPROCESSOR_ELIF)) {
                                    continue;
                                }
                                // #else
                                if (this.eat(scanner_2.TokenKind.PREPROCESSOR_ELSE)) {
                                    if (!this.expect(scanner_2.TokenKind.PREPROCESSOR_NEWLINE)) {
                                        return false;
                                    }
                                    // Remove the #else
                                    this.removeTokensFrom(previous);
                            ...
                            previous = this.previous;
                            if (!this.expect(scanner_2.TokenKind.PREPROCESSOR_ENDIF) || !this.peek(scanner_2.TokenKind.END_OF_FILE) && !this.expect(scanner_2.TokenKind.PREPROCESSOR_NEWLINE)) {
                                return false;
                            }
                            this.removeTokensFrom(previous);
                        }
                ...
                parsePrefix() {
                    ...
                    // true or false
                    if (this.eat(scanner_2.TokenKind.TRUE))
                        return PreprocessorValue.TRUE;
                    if (this.eat(scanner_2.TokenKind.FALSE))
                        return PreprocessorValue.FALSE;
                    // Identifier
                    if (this.eat(scanner_2.TokenKind.IDENTIFIER)) {
                        var name = this.previous.range.toString();
                        // Recover from a C-style define operator
                        if (this.peek(scanner_2.TokenKind.LEFT_PARENTHESIS) && name == "defined") {
                    ...
                    // !
                    if (this.eat(scanner_2.TokenKind.NOT)) {
                    ...
                    // Group
                    if (this.eat(scanner_2.TokenKind.LEFT_PARENTHESIS)) {
                        var first = this.current;
                        var value = this.parseExpression(parser_1.Precedence.LOWEST);
                        if (value == PreprocessorValue.ERROR || !this.expect(scanner_2.TokenKind.RIGHT_PARENTHESIS)) {
                            return PreprocessorValue.ERROR;
                        }
                        // Recover from a C-style define operator
                        if (isDefinedOperator) {
                            var builder = stringbuilder_3.StringBuilder_new().append("There is no 'defined' operator");
                            if (first.kind == scanner_2.TokenKind.IDENTIFIER && this.previous == first.next) {
                    ...
                    if (this.eat(scanner_2.TokenKind.INT32)) {
                ...
                parseInfix(precedence, left) {
                    ...
                    // == or !=
                    if (precedence < parser_1.Precedence.EQUAL && (this.eat(scanner_2.TokenKind.EQUAL) || this.eat(scanner_2.TokenKind.NOT_EQUAL))) {
                        var right = this.parseExpression(parser_1.Precedence.EQUAL);
                        if (right == PreprocessorValue.ERROR)
                            return PreprocessorValue.ERROR;
                        return (operator == scanner_2.TokenKind.EQUAL) == (left == right) ? PreprocessorValue.TRUE : PreprocessorValue.FALSE;
                    }
                    // &&
                    if (precedence < parser_1.Precedence.LOGICAL_AND && this.eat(scanner_2.TokenKind.LOGICAL_AND)) {
                    ...
                    // ||
                    if (precedence < parser_1.Precedence.LOGICAL_OR && this.eat(scanner_2.TokenKind.LOGICAL_OR)) {
                    ...
                    // Hook
                    if (precedence == parser_1.Precedence.LOWEST && this.eat(scanner_2.TokenKind.QUESTION_MARK)) {
                        var middle = this.parseExpression(parser_1.Precedence.LOWEST);
                        if (middle == PreprocessorValue.ERROR || !this.expect(scanner_2.TokenKind.COLON)) {
                            return PreprocessorValue.ERROR;
                        }
...
System.register("compiler/core/scope", ["compiler/core/symbol", "utils/stringbuilder", "compiler/core/type"], function (exports_6, context_6) {
    "use strict";
        ...
        execute: function () {
            ...
            Scope = class Scope {
                ...
                define(log, symbol, hint) {
                    ...
                    if (existing != null) {
                        if (symbol.name == "this") {
                            log.warning(symbol.range, stringbuilder_4.StringBuilder_new()
...
System.register("compiler/optimizer/shaking", ["compiler/core/symbol", "compiler/core/node", "compiler/compiler"], function (exports_7, context_7) {
    "use strict";
    ...
    var symbol_2, node_2, compiler_1;
    return {
        setters: [
            function (symbol_2_1) {
                symbol_2 = symbol_2_1;
...
System.register("backends/c++/c++", ["utils/stringbuilder", "compiler/compiler", "compiler/core/node", "compiler/parser/parser", "compiler/core/symbol", "compiler/scanner/scanner"], function (exports_8, context_8) {
    "use strict";
    var __moduleName = context_8 && context_8.id;
    function cEmitCharacter(builder, c) {
        if (scanner_3.isASCII(c.charCodeAt(0))) {
            builder.append('\'');
            if (c == '\\' || c == '\'') {
                builder.append('\\');
            }
    ...
    function cppEmit(compiler) {
        ...
        result.headerName = compiler_2.replaceFileExtension(compiler.outputName, ".h");
        if (child != null) {
            // Emit implementation
    ...
    exports_8("cppEmit", cppEmit);
    var stringbuilder_5, compiler_2, node_3, parser_2, symbol_3, scanner_3, TypeMode, SourceMode, CResult;
    return {
        setters: [
            ...
            function (scanner_3_1) {
                scanner_3 = scanner_3_1;
            }
        ],
        execute: function () {
            (function (TypeMode) {
...
`);
                        ...
                        while (i < length && i < 32) {
                            var c = value[i];
                            if (scanner_3.isAlpha(c) || scanner_3.isNumber(c)) {
                                if (underscore) {
                                    builder.append('_');
                                    underscore = false;
                                }
...
System.register("backends/javascript/js", ["utils/stringbuilder", "compiler/core/symbol", "compiler/core/node", "compiler/parser/parser"], function (exports_9, context_9) {
    "use strict";
...
System.register("utils/imports", [], function (exports_10, context_10) {
    "use strict";
    ...
    exports_10("isPositivePowerOf2", isPositivePowerOf2);
    function alignToNextMultipleOf(offset, alignment) {
        assert(isPositivePowerOf2(alignment));
        return (offset + alignment - 1) & -alignment;
    }
    exports_10("alignToNextMultipleOf", alignToNextMultipleOf);
    return {
        setters: [],
...
System.register("backends/webassembly/opcode", [], function (exports_11, context_11) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_11("WasmOpcode", WasmOpcode = {
...
System.register("utils/utils", [], function (exports_12, context_12) {
    "use strict";
...
System.register("backends/webassembly/builtins-helper", ["backends/webassembly/opcode"], function (exports_13, context_13) {
    "use strict";
    ...
    exports_13("getBuiltinOpcode", getBuiltinOpcode);
    function isBuiltin(name) {
        return builtins.indexOf(name) > -1;
    }
    exports_13("isBuiltin", isBuiltin);
    var opcode_1, builtins;
    return {
        setters: [
            function (opcode_1_1) {
                opcode_1 = opcode_1_1;
...
System.register("backends/webassembly/core/wasm-type", [], function (exports_14, context_14) {
    "use strict";
    var __moduleName = context_14 && context_14.id;
    var WasmType, WasmWrappedType;
    return {
        setters: [],
        execute: function () {
            /**
            ...
            exports_14("WasmType", WasmType);
            WasmWrappedType = class WasmWrappedType {
            };
            exports_14("WasmWrappedType", WasmWrappedType);
        }
    };
});
System.register("backends/webassembly/utils/logger", ["utils/utils"], function (exports_15, context_15) {
    "use strict";
...
System.register("backends/webassembly/core/wasm-signature", [], function (exports_16, context_16) {
    "use strict";
    ...
    exports_16("wasmAreSignaturesEqual", wasmAreSignaturesEqual);
    var WasmSignature;
    return {
        setters: [],
        execute: function () {
            ...
            exports_16("WasmSignature", WasmSignature);
        }
    };
});
System.register("backends/bitness", [], function (exports_17, context_17) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_17("Bitness", Bitness);
        }
    };
});
System.register("backends/webassembly/core/wasm-section", [], function (exports_18, context_18) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_18("WasmSection", WasmSection);
        }
    };
});
System.register("backends/webassembly/core/wasm-external-kind", [], function (exports_19, context_19) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_19("WasmExternalKind", WasmExternalKind);
        }
    };
});
System.register("backends/webassembly/core/wasm-global", [], function (exports_20, context_20) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_20("WasmGlobal", WasmGlobal);
        }
    };
});
System.register("backends/webassembly/core/wasm-local", [], function (exports_21, context_21) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_21("WasmLocal", WasmLocal);
        }
    };
});
System.register("backends/webassembly/core/wasm-function", [], function (exports_22, context_22) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_22("WasmFunction", WasmFunction);
        }
    };
});
System.register("backends/webassembly/core/wasm-import", [], function (exports_23, context_23) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_23("WasmImport", WasmImport);
        }
    };
});
System.register("backends/webassembly/core/wasm-shared-offset", [], function (exports_24, context_24) {
    "use strict";
    var __moduleName = context_24 && context_24.id;
    var WasmSharedOffset;
    return {
        setters: [],
        execute: function () {
            /**
            ...
            exports_24("WasmSharedOffset", WasmSharedOffset);
        }
    };
});
System.register("backends/webassembly/stack-machine/wasm-runtime-local", [], function (exports_25, context_25) {
    "use strict";
    var __moduleName = context_25 && context_25.id;
    var WasmRuntimeLocal;
    return {
        setters: [],
        execute: function () {
            /**
             ...
             */
            WasmRuntimeLocal = class WasmRuntimeLocal {
                constructor(type) {
                    this.type = type;
                }
            };
            exports_25("WasmRuntimeLocal", WasmRuntimeLocal);
        }
    };
});
System.register("backends/webassembly/stack-machine/wasm-stack-tracer", ["backends/webassembly/core/wasm-type", "backends/webassembly/opcode", "backends/webassembly/stack-machine/wasm-runtime-local", "utils/bytearray"], function (exports_26, context_26) {
    "use strict";
    var __moduleName = context_26 && context_26.id;
    function getOprandType(opcode) {
        switch (opcode) {
            // Int32
            case opcode_2.WasmOpcode.I32_CONST:
            case opcode_2.WasmOpcode.I32_ADD:
            case opcode_2.WasmOpcode.I32_MUL:
            case opcode_2.WasmOpcode.I32_SUB:
            case opcode_2.WasmOpcode.I32_DIV_S:
            case opcode_2.WasmOpcode.I32_DIV_U:
            case opcode_2.WasmOpcode.I32_REM_S:
            case opcode_2.WasmOpcode.I32_REM_U:
            case opcode_2.WasmOpcode.I32_GE_S:
            case opcode_2.WasmOpcode.I32_GE_U:
            case opcode_2.WasmOpcode.I32_LE_S:
            case opcode_2.WasmOpcode.I32_LE_U:
            case opcode_2.WasmOpcode.I32_GT_S:
            case opcode_2.WasmOpcode.I32_GT_U:
            case opcode_2.WasmOpcode.I32_LT_S:
            case opcode_2.WasmOpcode.I32_LT_U:
            case opcode_2.WasmOpcode.I32_EQ:
            case opcode_2.WasmOpcode.I32_NE:
            case opcode_2.WasmOpcode.I32_EQZ:
            case opcode_2.WasmOpcode.I32_AND:
            case opcode_2.WasmOpcode.I32_OR:
            case opcode_2.WasmOpcode.I32_XOR:
            case opcode_2.WasmOpcode.I32_CTZ:
            case opcode_2.WasmOpcode.I32_CLZ:
            case opcode_2.WasmOpcode.I32_ROTL:
            case opcode_2.WasmOpcode.I32_ROTR:
            case opcode_2.WasmOpcode.I32_SHL:
            case opcode_2.WasmOpcode.I32_SHR_S:
            case opcode_2.WasmOpcode.I32_SHR_U:
            case opcode_2.WasmOpcode.I32_POPCNT:
            case opcode_2.WasmOpcode.I32_LOAD:
            case opcode_2.WasmOpcode.I32_LOAD8_S:
            case opcode_2.WasmOpcode.I32_LOAD8_U:
            case opcode_2.WasmOpcode.I32_LOAD16_S:
            case opcode_2.WasmOpcode.I32_LOAD16_U:
            case opcode_2.WasmOpcode.I32_STORE16:
            case opcode_2.WasmOpcode.I32_STORE8:
            case opcode_2.WasmOpcode.I32_STORE:
            case opcode_2.WasmOpcode.I32_REINTERPRET_F32:
            case opcode_2.WasmOpcode.I32_TRUNC_S_F32:
            case opcode_2.WasmOpcode.I32_TRUNC_U_F32:
            case opcode_2.WasmOpcode.I32_TRUNC_S_F64:
            case opcode_2.WasmOpcode.I32_TRUNC_U_F64:
            case opcode_2.WasmOpcode.I32_WRAP_I64:
                return wasm_type_1.WasmType.I32;
            // Int64
            case opcode_2.WasmOpcode.I64_CONST:
            case opcode_2.WasmOpcode.I64_ADD:
            case opcode_2.WasmOpcode.I64_MUL:
            case opcode_2.WasmOpcode.I64_SUB:
            case opcode_2.WasmOpcode.I64_DIV_S:
            case opcode_2.WasmOpcode.I64_DIV_U:
            case opcode_2.WasmOpcode.I64_CLZ:
            case opcode_2.WasmOpcode.I64_ROTL:
            case opcode_2.WasmOpcode.I64_AND:
            case opcode_2.WasmOpcode.I64_CTZ:
            case opcode_2.WasmOpcode.I64_EQ:
            case opcode_2.WasmOpcode.I64_EQZ:
            case opcode_2.WasmOpcode.I64_GE_S:
            case opcode_2.WasmOpcode.I64_GE_U:
            case opcode_2.WasmOpcode.I64_LE_S:
            case opcode_2.WasmOpcode.I64_LE_U:
            case opcode_2.WasmOpcode.I64_GT_S:
            case opcode_2.WasmOpcode.I64_GT_U:
            case opcode_2.WasmOpcode.I64_LT_S:
            case opcode_2.WasmOpcode.I64_LT_U:
            case opcode_2.WasmOpcode.I64_LOAD:
            case opcode_2.WasmOpcode.I64_LOAD8_S:
            case opcode_2.WasmOpcode.I64_LOAD8_U:
            case opcode_2.WasmOpcode.I64_LOAD16_S:
            case opcode_2.WasmOpcode.I64_LOAD16_U:
            case opcode_2.WasmOpcode.I64_NE:
            case opcode_2.WasmOpcode.I64_XOR:
            case opcode_2.WasmOpcode.I64_STORE16:
            case opcode_2.WasmOpcode.I64_STORE8:
            case opcode_2.WasmOpcode.I64_STORE:
            case opcode_2.WasmOpcode.I64_SHR_S:
            case opcode_2.WasmOpcode.I64_SHR_U:
            case opcode_2.WasmOpcode.I64_SHL:
            case opcode_2.WasmOpcode.I64_ROTR:
            case opcode_2.WasmOpcode.I64_REM_S:
            case opcode_2.WasmOpcode.I64_REM_U:
            case opcode_2.WasmOpcode.I64_POPCNT:
            case opcode_2.WasmOpcode.I64_OR:
            case opcode_2.WasmOpcode.I64_REINTERPRET_F64:
            case opcode_2.WasmOpcode.I64_TRUNC_S_F32:
            case opcode_2.WasmOpcode.I64_TRUNC_U_F32:
            case opcode_2.WasmOpcode.I64_TRUNC_S_F64:
            case opcode_2.WasmOpcode.I64_TRUNC_U_F64:
            case opcode_2.WasmOpcode.I64_EXTEND_S_I32:
            case opcode_2.WasmOpcode.I64_EXTEND_U_I32:
                return wasm_type_1.WasmType.I64;
            // Float32
            case opcode_2.WasmOpcode.F32_CONST:
            case opcode_2.WasmOpcode.F32_ADD:
            case opcode_2.WasmOpcode.F32_SUB:
            case opcode_2.WasmOpcode.F32_MUL:
            case opcode_2.WasmOpcode.F32_DIV:
            case opcode_2.WasmOpcode.F32_SQRT:
            case opcode_2.WasmOpcode.F32_NEG:
            case opcode_2.WasmOpcode.F32_NE:
            case opcode_2.WasmOpcode.F32_ABS:
            case opcode_2.WasmOpcode.F32_CEIL:
            case opcode_2.WasmOpcode.F32_EQ:
            case opcode_2.WasmOpcode.F32_FLOOR:
            case opcode_2.WasmOpcode.F32_NEAREST:
            case opcode_2.WasmOpcode.F32_MIN:
            case opcode_2.WasmOpcode.F32_MAX:
            case opcode_2.WasmOpcode.F32_GE:
            case opcode_2.WasmOpcode.F32_GT:
            case opcode_2.WasmOpcode.F32_LT:
            case opcode_2.WasmOpcode.F32_LE:
            case opcode_2.WasmOpcode.F32_COPYSIGN:
            case opcode_2.WasmOpcode.F32_LOAD:
            case opcode_2.WasmOpcode.F32_STORE:
            case opcode_2.WasmOpcode.F32_TRUNC:
            case opcode_2.WasmOpcode.F32_DEMOTE_F64:
            case opcode_2.WasmOpcode.F32_CONVERT_S_I32:
            case opcode_2.WasmOpcode.F32_CONVERT_U_I32:
            case opcode_2.WasmOpcode.F32_CONVERT_S_I64:
            case opcode_2.WasmOpcode.F32_CONVERT_U_I64:
            case opcode_2.WasmOpcode.F32_REINTERPRET_I32:
                return wasm_type_1.WasmType.F32;
            // Float64
            case opcode_2.WasmOpcode.F64_CONST:
            case opcode_2.WasmOpcode.F64_ADD:
            case opcode_2.WasmOpcode.F64_SUB:
            case opcode_2.WasmOpcode.F64_MUL:
            case opcode_2.WasmOpcode.F64_DIV:
            case opcode_2.WasmOpcode.F64_SQRT:
            case opcode_2.WasmOpcode.F64_NEG:
            case opcode_2.WasmOpcode.F64_NE:
            case opcode_2.WasmOpcode.F64_ABS:
            case opcode_2.WasmOpcode.F64_CEIL:
            case opcode_2.WasmOpcode.F64_EQ:
            case opcode_2.WasmOpcode.F64_FLOOR:
            case opcode_2.WasmOpcode.F64_NEAREST:
            case opcode_2.WasmOpcode.F64_MIN:
            case opcode_2.WasmOpcode.F64_MAX:
            case opcode_2.WasmOpcode.F64_GE:
            case opcode_2.WasmOpcode.F64_GT:
            case opcode_2.WasmOpcode.F64_LT:
            case opcode_2.WasmOpcode.F64_LE:
            case opcode_2.WasmOpcode.F64_COPYSIGN:
            case opcode_2.WasmOpcode.F64_LOAD:
            case opcode_2.WasmOpcode.F64_STORE:
            case opcode_2.WasmOpcode.F64_TRUNC:
            case opcode_2.WasmOpcode.F64_PROMOTE_F32:
            case opcode_2.WasmOpcode.F64_CONVERT_S_I32:
            case opcode_2.WasmOpcode.F64_CONVERT_U_I32:
            case opcode_2.WasmOpcode.F64_CONVERT_S_I64:
            case opcode_2.WasmOpcode.F64_CONVERT_U_I64:
            case opcode_2.WasmOpcode.F64_REINTERPRET_I64:
                return wasm_type_1.WasmType.F64;
            // No types
            case opcode_2.WasmOpcode.CALL:
            case opcode_2.WasmOpcode.END:
            case opcode_2.WasmOpcode.RETURN:
            case opcode_2.WasmOpcode.GET_GLOBAL:
            case opcode_2.WasmOpcode.GET_LOCAL:
            case opcode_2.WasmOpcode.SET_LOCAL:
            case opcode_2.WasmOpcode.SET_GLOBAL:
            case opcode_2.WasmOpcode.BLOCK:
            case opcode_2.WasmOpcode.LOOP:
            case opcode_2.WasmOpcode.IF:
            case opcode_2.WasmOpcode.IF_ELSE:
            case opcode_2.WasmOpcode.BR:
            case opcode_2.WasmOpcode.BR_IF:
            case opcode_2.WasmOpcode.BR_TABLE:
            case opcode_2.WasmOpcode.NOP:
                return null;
            default:
                console.warn("Unhandled Opcode " + opcode_2.WasmOpcode[opcode]);
                break;
        }
    }
    var wasm_type_1, opcode_2, wasm_runtime_local_1, bytearray_1, WasmStackItem, WasmStack, WasmRuntimeFunction, WasmStackContext, WasmStackTracer;
    return {
        setters: [
            function (wasm_type_1_1) {
                wasm_type_1 = wasm_type_1_1;
            },
            function (opcode_2_1) {
                opcode_2 = opcode_2_1;
            },
            function (wasm_runtime_local_1_1) {
                wasm_runtime_local_1 = wasm_runtime_local_1_1;
            },
        ...
        execute: function () {
             ...
             * Created by n.vinayakan on 02.06.17.
             */
            WasmStackItem = class WasmStackItem {
                constructor(type, value) {
                    this.type = type;
                    this.value = value;
                }
            };
            exports_26("WasmStackItem", WasmStackItem);
            WasmStack = class WasmStack {
                constructor() {
                    this.list = [];
                }
                get length() {
            ...
            exports_26("WasmStack", WasmStack);
            WasmRuntimeFunction = class WasmRuntimeFunction {
                constructor() {
                }
                get returnType() {
            ...
            exports_26("WasmRuntimeFunction", WasmRuntimeFunction);
            WasmStackContext = class WasmStackContext {
                constructor(fn) {
                    this.fn = fn;
            ...
            exports_26("WasmStackContext", WasmStackContext);
            /**
             ...
             */
            WasmStackTracer = class WasmStackTracer {
                constructor() {
                    this.context = null;
            ...
            exports_26("WasmStackTracer", WasmStackTracer);
        }
    };
});
System.register("backends/webassembly/buffer/section-buffer", ["backends/webassembly/utils/logger", "utils/bytearray"], function (exports_27, context_27) {
    "use strict";
    var __moduleName = context_27 && context_27.id;
    var logger_1, bytearray_2, SectionBuffer;
    return {
        setters: [
            function (logger_1_1) {
                logger_1 = logger_1_1;
        ...
        execute: function () {
            ...
            exports_27("SectionBuffer", SectionBuffer);
        }
    };
});
System.register("backends/webassembly/assembler/wasm-assembler", ["backends/webassembly/stack-machine/wasm-stack-tracer", "utils/utils", "backends/webassembly/opcode", "backends/webassembly/buffer/section-buffer", "backends/webassembly/utils/logger", "backends/webassembly/core/wasm-section"], function (exports_28, context_28) {
    "use strict";
    var __moduleName = context_28 && context_28.id;
    function append(array, offset = 0, value = null, msg = null) {
        if (global["debug"]) {
            array.log += (value != null ? `${utils_2.toHex(offset + array.position)}: ${utils_2.toHex(value, 2)}                    ; ` : "") + (msg != null ? `${msg}\n` : "\n");
        }
        if (value) {
            array.append(value);
        }
    }
    exports_28("append", append);
    function logOpcode(array, offset = 0, opcode, inline_value) {
        if (global["debug"]) {
            array.log += `${utils_2.toHex(offset + array.position)}: ${utils_2.toHex(opcode, 2)}                    ; ${opcode_3.WasmOpcode[opcode]} ${inline_value ? inline_value : ""}\n`;
        }
    }
    exports_28("logOpcode", logOpcode);
    var wasm_stack_tracer_1, utils_2, opcode_3, section_buffer_1, logger_2, wasm_section_1, WasmAssembler;
    return {
        setters: [
            function (wasm_stack_tracer_1_1) {
                wasm_stack_tracer_1 = wasm_stack_tracer_1_1;
            },
            function (utils_2_1) {
                utils_2 = utils_2_1;
            },
            ...
            function (section_buffer_1_1) {
                section_buffer_1 = section_buffer_1_1;
            },
            function (logger_2_1) {
                logger_2 = logger_2_1;
            },
            function (wasm_section_1_1) {
                wasm_section_1 = wasm_section_1_1;
            }
        ],
        execute: function () {
            /**
             * Created by n.vinayakan on 02.06.17.
             */
            WasmAssembler = class WasmAssembler {
                constructor() {
                    this.sectionList = [];
                    this.importList = [];
                    this.functionList = [];
                ...
                startSection(array, id, name) {
                    ...
                    logger_2.log(array, 0, null, ` - section: ${wasm_section_1.WasmSection[id]} [0x${utils_2.toHex(id, 2)}]`);
                ...
                dropStack(array, max = 1) {
                    ...
                    while (item !== undefined && max > 0) {
                        array.append(opcode_3.WasmOpcode.DROP);
            ...
            exports_28("WasmAssembler", WasmAssembler);
        }
    };
});
System.register("backends/webassembly/webassembly", ["compiler/core/symbol", "utils/bytearray", "utils/imports", "compiler/core/node", "backends/webassembly/opcode", "utils/utils", "backends/webassembly/builtins-helper", "backends/webassembly/core/wasm-type", "backends/webassembly/utils/logger", "backends/webassembly/core/wasm-signature", "backends/bitness", "backends/webassembly/core/wasm-section", "backends/webassembly/core/wasm-external-kind", "backends/webassembly/core/wasm-global", "backends/webassembly/core/wasm-function", "backends/webassembly/core/wasm-import", "backends/webassembly/core/wasm-local", "backends/webassembly/core/wasm-shared-offset", "backends/webassembly/assembler/wasm-assembler"], function (exports_29, context_29) {
    "use strict";
    var __moduleName = context_29 && context_29.id;
    function getWasmFunctionName(symbol) {
        let moduleName = symbol.kind == symbol_5.SymbolKind.FUNCTION_INSTANCE ? symbol.parent().internalName : "";
        return (moduleName == "" ? "" : moduleName + "_") + symbol.internalName;
    }
    function wasmWrapType(id) {
        assert(id == wasm_type_2.WasmType.VOID || id == wasm_type_2.WasmType.I32 || id == wasm_type_2.WasmType.I64 || id == wasm_type_2.WasmType.F32 || id == wasm_type_2.WasmType.F64);
        let type = new wasm_type_2.WasmWrappedType();
        type.id = id;
        return type;
    }
    ...
    function wasmAssignLocalVariableOffsets(fn, node, shared, bitness) {
        if (node.kind == node_5.NodeKind.VARIABLE) {
            assert(node.symbol.kind == symbol_5.SymbolKind.VARIABLE_LOCAL);
    ...
    function wasmEmit(compiler, bitness = bitness_1.Bitness.x32) {
        ...
        module.memoryInitializer = new bytearray_3.ByteArray();
        ...
        compiler.outputWASM = new bytearray_3.ByteArray();
        module.emitModule(compiler.outputWASM);
    }
    exports_29("wasmEmit", wasmEmit);
    var symbol_5, bytearray_3, imports_1, node_5, opcode_4, utils_3, builtins_helper_1, wasm_type_2, logger_3, wasm_signature_1, bitness_1, wasm_section_2, wasm_external_kind_1, wasm_global_1, wasm_function_1, wasm_import_1, wasm_local_1, wasm_shared_offset_1, wasm_assembler_1, WASM_MAGIC, WASM_VERSION, WASM_SIZE_IN_PAGES, WASM_SET_MAX_MEMORY, WASM_MAX_MEMORY, WASM_MEMORY_INITIALIZER_BASE, WasmModule;
    return {
        setters: [
            function (symbol_5_1) {
                symbol_5 = symbol_5_1;
            ...
            function (builtins_helper_1_1) {
                builtins_helper_1 = builtins_helper_1_1;
            },
            function (wasm_type_2_1) {
                wasm_type_2 = wasm_type_2_1;
            },
            function (logger_3_1) {
                logger_3 = logger_3_1;
            },
            function (wasm_signature_1_1) {
                wasm_signature_1 = wasm_signature_1_1;
            },
            function (bitness_1_1) {
                bitness_1 = bitness_1_1;
            },
            function (wasm_section_2_1) {
                wasm_section_2 = wasm_section_2_1;
            },
            function (wasm_external_kind_1_1) {
                wasm_external_kind_1 = wasm_external_kind_1_1;
            },
            function (wasm_global_1_1) {
                wasm_global_1 = wasm_global_1_1;
            },
            function (wasm_function_1_1) {
                wasm_function_1 = wasm_function_1_1;
            },
            function (wasm_import_1_1) {
                wasm_import_1 = wasm_import_1_1;
            },
            function (wasm_local_1_1) {
                wasm_local_1 = wasm_local_1_1;
            },
            function (wasm_shared_offset_1_1) {
                wasm_shared_offset_1 = wasm_shared_offset_1_1;
            },
            function (wasm_assembler_1_1) {
                wasm_assembler_1 = wasm_assembler_1_1;
            }
        ],
        execute: function () {
            ...
            WasmModule = class WasmModule {
                ...
                emitSignatures(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Type, "signatures");
                    ...
                    while (signature != null) {
                        ...
                        logger_3.log(section.data, array.position, wasm_type_2.WasmType.func, "func sig " + sigCount++);
                        this.assembler.writeUnsignedLEB128(section.data, wasm_type_2.WasmType.func); //form, the value for the func type constructor
                        logger_3.log(section.data, array.position, count, "num params");
                        ...
                        while (type != null) {
                            logger_3.log(section.data, array.position, type.id, wasm_type_2.WasmType[type.id]);
                        ...
                        if (returnTypeId > 0) {
                            logger_3.log(section.data, array.position, "01", "num results");
                            this.assembler.writeUnsignedLEB128(section.data, 1); //return_count, the number of results from the function
                            logger_3.log(section.data, array.position, signature.returnType.id, wasm_type_2.WasmType[signature.returnType.id]);
                ...
                emitImportTable(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Import, "import_table");
                    logger_3.log(section.data, array.position, this.importCount, "num imports");
                    this.assembler.writeUnsignedLEB128(section.data, this.importCount);
                    let current = this.firstImport;
                    let count = 0;
                    while (current != null) {
                        logger_3.log(section.data, array.position, null, `import func (${count}) ${current.module} ${current.name}`);
                ...
                emitFunctionDeclarations(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Function, "function_declarations");
                    logger_3.log(section.data, array.position, this.functionCount, "num functions");
                    this.assembler.writeUnsignedLEB128(section.data, this.functionCount);
                    let fn = this.firstFunction;
                    let count = this.importCount;
                    while (fn != null) {
                        logger_3.log(section.data, array.position, fn.signatureIndex, `func ${count} sig ${getWasmFunctionName(fn.symbol)}`);
                ...
                emitMemory(array) {
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Memory, "memory");
                    logger_3.log(section.data, array.position, "01", "num memories");
                    ...
                    //resizable_limits
                    logger_3.log(section.data, array.position, "00", "memory flags");
                    ...
                    logger_3.log(section.data, array.position, WASM_SIZE_IN_PAGES, "memory initial pages");
                    ...
                    if (WASM_SET_MAX_MEMORY) {
                        logger_3.log(section.data, array.position, WASM_MAX_MEMORY, "maximum memory");
                ...
                emitGlobalDeclarations(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Global, "global");
                    ...
                    while (global) {
                        ...
                        section.data.append(wasm_type_2.WasmType[dataType]); //content_type
                        ...
                        if (value) {
                            let rawValue = 0;
                            if (value.kind === node_5.NodeKind.NULL || value.kind === node_5.NodeKind.UNDEFINED) {
                                rawValue = 0;
                            }
                            ...
                            this.assembler.appendOpcode(section.data, array.position, opcode_4.WasmOpcode[`${dataType}_CONST`], rawValue);
                            switch (dataType) {
                                case "I32":
                            ...
                            this.assembler.appendOpcode(section.data, array.position, opcode_4.WasmOpcode[`${dataType}_CONST`], 0);
                            this.assembler.writeUnsignedLEB128(section.data, 0); //const value
                        }
                        this.assembler.appendOpcode(section.data, array.position, opcode_4.WasmOpcode.END);
                        global = global.next;
                    }
                    this.assembler.endSection(array, section);
                }
                addGlobalToStartFunction(global) {
                    ...
                    this.assembler.appendOpcode(startFn.body, 0, opcode_4.WasmOpcode.SET_GLOBAL);
                ...
                emitExportTable(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Export, "export_table");
                    logger_3.log(section.data, array.position, exportedCount, "num exports");
                    this.assembler.writeUnsignedLEB128(section.data, exportedCount + 1);
                    //Export main memory
                    let memoryName = "memory";
                    logger_3.log(section.data, array.position, memoryName.length, "export name length");
                    logger_3.log(section.data, null, null, `${utils_3.toHex(section.data.position + array.position + 4)}: ${memoryName} // export name`);
                    this.assembler.writeWasmString(section.data, memoryName);
                    logger_3.log(section.data, array.position, wasm_external_kind_1.WasmExternalKind.Function, "export kind");
                    this.assembler.writeUnsignedLEB128(section.data, wasm_external_kind_1.WasmExternalKind.Memory);
                    logger_3.log(section.data, array.position, 0, "export memory index");
                    this.assembler.writeUnsignedLEB128(section.data, 0);
                    ...
                    while (fn != null) {
                        if (fn.isExported) {
                            ...
                            logger_3.log(section.data, array.position, fnName.length, "export name length");
                            logger_3.log(section.data, null, null, `${utils_3.toHex(section.data.position + array.position + 4)}: ${fnName} // export name`);
                            this.assembler.writeWasmString(section.data, fnName);
                            logger_3.log(section.data, array.position, wasm_external_kind_1.WasmExternalKind.Function, "export kind");
                            this.assembler.writeUnsignedLEB128(section.data, wasm_external_kind_1.WasmExternalKind.Function);
                            logger_3.log(section.data, array.position, i, "export func index");
                ...
                emitStartFunctionDeclaration(array) {
                    if (this.startFunctionIndex != -1) {
                        let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Start, "start_function");
                        logger_3.log(section.data, array.position, this.startFunctionIndex, "start function index");
                ...
                emitFunctionBodies(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Code, "function_bodies");
                    logger_3.log(section.data, offset, this.functionCount, "num functions");
                    this.assembler.writeUnsignedLEB128(section.data, this.functionCount);
                    let count = 0;
                    let fn = this.firstFunction;
                    while (fn != null) {
                        ...
                        let bodyData = new bytearray_3.ByteArray();
                        logger_3.log(bodyData, sectionOffset, fn.localCount ? fn.localCount : 0, "local var count");
                        ...
                        if (fn.localCount > 0) {
                            ...
                            while (local) {
                                logger_3.log(bodyData, sectionOffset, 1, "local index");
                                bodyData.writeUnsignedLEB128(1); //count
                                logger_3.log(bodyData, sectionOffset, local.type, wasm_type_2.WasmType[local.type]);
                        ...
                        if (fn.body) {
                            ...
                            if (lastChild && lastChild.kind !== node_5.NodeKind.RETURN && fn.returnType != wasm_type_2.WasmType.VOID) {
                                this.assembler.appendOpcode(bodyData, sectionOffset, opcode_4.WasmOpcode.RETURN);
                            }
                        }
                        if (fn.returnType === wasm_type_2.WasmType.VOID) {
                            // Drop stack if not empty
                            this.assembler.dropStack(bodyData);
                        }
                        this.assembler.appendOpcode(bodyData, sectionOffset, opcode_4.WasmOpcode.END); //end, 0x0b, indicating the end of the body
                        this.assembler.stackTracer.endFunction();
                        //Copy and finish body
                        section.data.writeUnsignedLEB128(bodyData.length);
                        logger_3.log(section.data, offset, null, ` - func body ${this.importCount + (count++)} (${wasmFunctionName})`);
                        logger_3.log(section.data, offset, bodyData.length, "func body size");
                ...
                emitDataSegments(array) {
                    ...
                    let section = this.assembler.startSection(array, wasm_section_2.WasmSection.Data, "data_segments");
                    // This only writes one single section containing everything
                    logger_3.log(section.data, array.position, 1, "num data segments");
                    this.assembler.writeUnsignedLEB128(section.data, 1);
                    //data_segment
                    logger_3.log(section.data, array.position, null, " - data segment header 0");
                    logger_3.log(section.data, array.position, 0, "memory index");
                    ...
                    this.assembler.appendOpcode(section.data, array.position, opcode_4.WasmOpcode.I32_CONST);
                    logger_3.log(section.data, array.position, WASM_MEMORY_INITIALIZER_BASE, "i32 literal");
                    this.assembler.writeUnsignedLEB128(section.data, WASM_MEMORY_INITIALIZER_BASE); //const value
                    this.assembler.appendOpcode(section.data, array.position, opcode_4.WasmOpcode.END);
                    logger_3.log(section.data, array.position, initializerLength, "data segment size");
                    this.assembler.writeUnsignedLEB128(section.data, initializerLength); //size, size of data (in bytes)
                    logger_3.log(section.data, array.position, null, " - data segment data 0");
                    ...
                    while (i < initializerLength) {
                        for (let j = 0; j < 16; j++) {
                            if (i + j < initializerLength) {
                                ...
                                logger_3.logData(section.data, array.position, value, j == 0);
                            }
                        }
                        section.data.log += "\n";
                        i = i + 16;
                ...
                emitNames(array) {
                    ...
                    let subsectionFunc = new bytearray_3.ByteArray();
                    let subsectionLocal = new bytearray_3.ByteArray();
                ...
                prepareToEmit(node) {
                    if (node.kind == node_5.NodeKind.STRING) {
                        ...
                        bytearray_3.ByteArray_set32(memoryInitializer, offset, length);
                        bytearray_3.ByteArray_setString(memoryInitializer, offset + 4, text);
                    }
                    else if (node.kind == node_5.NodeKind.VARIABLE) {
                        ...
                        if (symbol.kind == symbol_5.SymbolKind.VARIABLE_GLOBAL) {
                        ...
                        (node.symbol.kind != symbol_5.SymbolKind.FUNCTION_INSTANCE ||
                            node.symbol.kind == symbol_5.SymbolKind.FUNCTION_INSTANCE && !node.parent.isTemplate())) {
                        ...
                        if (body == null) {
                            ...
                            if (!builtins_helper_1.isBuiltin(wasmFunctionName)) {
                                let moduleName = symbol.kind == symbol_5.SymbolKind.FUNCTION_INSTANCE ? symbol.parent().name : "global";
                ...
                emitLoadFromMemory(array, byteOffset, type, relativeBase, offset) {
                    ...
                    if (relativeBase != null) {
                        ...
                        opcode = opcode_4.WasmOpcode.I32_CONST;
                        this.assembler.appendOpcode(array, byteOffset, opcode);
                        logger_3.log(array, byteOffset, 0, "i32 literal");
                        this.assembler.writeUnsignedLEB128(array, 0);
                    }
                    let sizeOf = type.variableSizeOf(this.context);
                    if (sizeOf == 1) {
                        opcode = type.isUnsigned() ? opcode_4.WasmOpcode.I32_LOAD8_U : opcode_4.WasmOpcode.I32_LOAD8_S;
                        this.assembler.appendOpcode(array, byteOffset, opcode);
                        logger_3.log(array, byteOffset, 0, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 0);
                    }
                    else if (sizeOf == 2) {
                        opcode = type.isUnsigned() ? opcode_4.WasmOpcode.I32_LOAD16_U : opcode_4.WasmOpcode.I32_LOAD16_S;
                        this.assembler.appendOpcode(array, byteOffset, opcode);
                        logger_3.log(array, byteOffset, 1, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 1);
                    }
                    else if (sizeOf == 4 || type.isClass()) {
                        if (type.isFloat()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_LOAD);
                        }
                        else {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_LOAD);
                        }
                        logger_3.log(array, byteOffset, 2, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 2);
                    }
                    else if (sizeOf == 8) {
                        if (type.isDouble()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_LOAD);
                        }
                        else {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_LOAD);
                        }
                        logger_3.log(array, byteOffset, 3, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 3);
                    }
                    else {
                        assert(false);
                    }
                    logger_3.log(array, byteOffset, offset, "load offset");
                ...
                emitStoreToMemory(array, byteOffset, type, relativeBase, offset, value) {
                    ...
                    if (relativeBase != null) {
                        ...
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST);
                        logger_3.log(array, byteOffset, 0, "i32 literal");
                        this.assembler.writeUnsignedLEB128(array, 0);
                    }
                    ...
                    let sizeOf = type.variableSizeOf(this.context);
                    if (sizeOf == 1) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_STORE8);
                        logger_3.log(array, byteOffset, 0, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 0);
                    }
                    else if (sizeOf == 2) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_STORE16);
                        logger_3.log(array, byteOffset, 1, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 1);
                    }
                    else if (sizeOf == 4 || type.isClass()) {
                        if (type.isFloat()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_STORE);
                        }
                        else {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_STORE);
                        }
                        logger_3.log(array, byteOffset, 2, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 2);
                    }
                        ...
                        if (type.isDouble()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_STORE);
                        }
                        else if (type.isLong()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_STORE);
                        }
                        logger_3.log(array, byteOffset, 3, "alignment");
                        this.assembler.writeUnsignedLEB128(array, 3);
                    }
                ...
                emitInstance(array, byteOffset, node) {
                    ...
                    if (type.resolvedType.isArray()) {
                        ...
                        if (lengthNode.kind == node_5.NodeKind.INT32) {
                            let length = size * lengthNode.intValue;
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, length);
                            this.assembler.writeLEB128(array, length); //array byteLength
                        }
                        else {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, size);
                            this.assembler.writeLEB128(array, size);
                            this.emitNode(array, byteOffset, lengthNode);
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_MUL); //array byteLength
                        }
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, size);
                        this.assembler.writeLEB128(array, size); // array element size
                        let callIndex = this.getWasmFunctionCallIndex(callSymbol);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.CALL);
                        logger_3.log(array, byteOffset, callIndex, `call func index (${callIndex})`);
                        ...
                        let callIndex = this.getWasmFunctionCallIndex(callSymbol);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.CALL, callIndex);
                        this.assembler.writeUnsignedLEB128(array, callIndex);
                    }
                }
                /**
                ...
                emitConstructor(array, byteOffset, fn) {
                    ...
                    assert(size > 0);
                    if (type.resolvedType.isArray()) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.GET_LOCAL, 0);
                        ...
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_ADD);
                    }
                    else if (type.resolvedType.isTypedArray()) {
                        let elementSize = getTypedArrayElementSize(type.resolvedType.symbol.name);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.GET_LOCAL, 0);
                        this.assembler.writeUnsignedLEB128(array, 0);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, elementSize);
                        this.assembler.writeLEB128(array, elementSize);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_SHL);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, size);
                        this.assembler.writeLEB128(array, size);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_ADD);
                    }
                    ...
                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.CALL, mallocIndex);
                    this.assembler.writeUnsignedLEB128(array, mallocIndex);
                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_LOCAL, fn.signature.argumentCount);
                ...
                emitNode(array, byteOffset, node) {
                    // Assert
                    assert(!node_5.isExpression(node) || node.resolvedType != null);
                    if (node.kind == node_5.NodeKind.BLOCK) {
                        /**
                         * Skip emitting block if parent is 'if' or 'loop' since it is already a block
                         */
                        let skipBlock = node.parent.kind === node_5.NodeKind.IF || node.parent.kind === node_5.NodeKind.WHILE;
                        if (!skipBlock) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.BLOCK);
                            if (node.returnNode !== undefined) {
                                logger_3.log(array, byteOffset, this.currentFunction.returnType, wasm_type_2.WasmType[this.currentFunction.returnType]);
                                array.append(this.currentFunction.returnType);
                            }
                            else {
                                logger_3.log(array, byteOffset, wasm_type_2.WasmType.block_type, wasm_type_2.WasmType[wasm_type_2.WasmType.block_type]);
                                array.append(wasm_type_2.WasmType.block_type);
                            }
                        }
                        let child = node.firstChild;
                        while (child != null) {
                        ...
                        if (!skipBlock) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.END);
                        }
                    }
                        ...
                        // Ignore "while (false) { ... }"
                        if (value.kind == node_5.NodeKind.BOOLEAN && value.intValue == 0) {
                            return 0;
                        }
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.BLOCK);
                        logger_3.log(array, 0, wasm_type_2.WasmType.block_type, wasm_type_2.WasmType[wasm_type_2.WasmType.block_type]);
                        array.append(wasm_type_2.WasmType.block_type);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.LOOP);
                        logger_3.log(array, 0, wasm_type_2.WasmType.block_type, wasm_type_2.WasmType[wasm_type_2.WasmType.block_type]);
                        array.append(wasm_type_2.WasmType.block_type);
                        if (value.kind != node_5.NodeKind.BOOLEAN) {
                            this.emitNode(array, byteOffset, value);
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_EQZ);
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.BR_IF);
                        ...
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.BR);
                        this.assembler.writeUnsignedLEB128(array, 0); // Continue back to the immediately enclosing loop
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.END); // end inner block
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.END); // end outer block
                    }
                    else if (node.kind == node_5.NodeKind.BREAK || node.kind == node_5.NodeKind.CONTINUE) {
                        let label = 0;
                        let parent = node.parent;
                        while (parent != null && parent.kind != node_5.NodeKind.WHILE) {
                            if (parent.kind == node_5.NodeKind.BLOCK) {
                                label = label + 1;
                            }
                        ...
                        assert(label > 0);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.BR);
                        this.assembler.writeUnsignedLEB128(array, label - (node.kind == node_5.NodeKind.BREAK ? 0 : 1));
                    }
                        ...
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.RETURN);
                    }
                        ...
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.IF);
                        let returnNode = node.ifReturnNode();
                        let needEmptyElse = false;
                        if (returnNode == null && branch === null) {
                            wasm_assembler_1.append(array, 0, wasm_type_2.WasmType.block_type, wasm_type_2.WasmType[wasm_type_2.WasmType.block_type]);
                        }
                        else {
                            if (returnNode !== null) {
                                let returnType = symbolToValueType(returnNode.resolvedType.symbol);
                                wasm_assembler_1.append(array, 0, returnType, wasm_type_2.WasmType[returnType]);
                                if (branch == null) {
                                    needEmptyElse = true;
                                }
                            }
                        ...
                        if (branch != null) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.IF_ELSE);
                            ...
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode[`${dataType}_CONST`]);
                        ...
                        wasm_assembler_1.append(array, 0, trueValueType, wasm_type_2.WasmType[trueValueType]);
                        ...
                        else if (node.symbol.kind == symbol_5.SymbolKind.VARIABLE_LOCAL) {
                            if (value &&
                                value.kind != node_5.NodeKind.NAME &&
                                value.kind != node_5.NodeKind.CALL &&
                                value.kind != node_5.NodeKind.NEW &&
                                value.kind != node_5.NodeKind.DOT &&
                                value.rawValue) {
                                if (node.symbol.resolvedType.isFloat()) {
                                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, value.floatValue);
                                    this.assembler.writeFloat(array, value.floatValue);
                                }
                                else if (node.symbol.resolvedType.isDouble()) {
                                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_CONST, value.doubleValue);
                                    this.assembler.writeDouble(array, value.doubleValue);
                                }
                                else if (node.symbol.resolvedType.isLong()) {
                                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, value.longValue);
                                    this.assembler.writeLEB128(array, value.longValue);
                                }
                                else {
                                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, value.intValue);
                                ...
                                if (value != null) {
                                    ...
                                    // Default value
                                    if (node.symbol.resolvedType.isFloat()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, 0);
                                        this.assembler.writeFloat(array, 0);
                                    }
                                    else if (node.symbol.resolvedType.isDouble()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_CONST, 0);
                                        this.assembler.writeDouble(array, 0);
                                    }
                                    else if (node.symbol.resolvedType.isLong()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, 0);
                                        this.assembler.writeLEB128(array, 0);
                                    }
                                    else {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, 0);
                                        this.assembler.writeLEB128(array, 0);
                                    }
                                }
                            }
                            let skipSetLocal = value && node_5.isUnaryPostfix(value.kind);
                            if (skipSetLocal == false) {
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_LOCAL, node.symbol.offset);
                    ...
                    else if (node.kind == node_5.NodeKind.NAME) {
                        let symbol = node.symbol;
                        if (symbol.kind == symbol_5.SymbolKind.VARIABLE_ARGUMENT || symbol.kind == symbol_5.SymbolKind.VARIABLE_LOCAL) {
                            // FIXME This should handle in checker.
                            if (symbol.name === "this" && this.currentFunction.symbol.name === "constructor") {
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.GET_LOCAL, this.currentFunction.signature.argumentCount);
                                this.assembler.writeUnsignedLEB128(array, this.currentFunction.signature.argumentCount);
                            }
                            else {
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.GET_LOCAL, symbol.offset);
                                this.assembler.writeUnsignedLEB128(array, symbol.offset);
                            }
                        }
                        else if (symbol.kind == symbol_5.SymbolKind.VARIABLE_GLOBAL) {
                            // FIXME: Final spec allow immutable global variables
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.GET_GLOBAL, symbol.offset);
                            this.assembler.writeUnsignedLEB128(array, symbol.offset);
                    ...
                    else if (node.kind == node_5.NodeKind.DEREFERENCE) {
                    ...
                    else if (node.kind == node_5.NodeKind.INT32 || node.kind == node_5.NodeKind.BOOLEAN) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, node.intValue);
                        this.assembler.writeLEB128(array, node.intValue || 0);
                    }
                    else if (node.kind == node_5.NodeKind.INT64) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, node.longValue);
                        this.assembler.writeLEB128(array, node.longValue);
                    }
                    else if (node.kind == node_5.NodeKind.FLOAT32) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, node.floatValue);
                        this.assembler.writeFloat(array, node.floatValue);
                    }
                    else if (node.kind == node_5.NodeKind.FLOAT64) {
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_CONST, node.doubleValue);
                        ...
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, value);
                        this.assembler.writeLEB128(array, value);
                    }
                    else if (node.kind == node_5.NodeKind.CALL) {
                        let value = node.callValue();
                        let symbol = value.symbol;
                        assert(symbol_5.isFunction(symbol.kind));
                        // Write out the implicit "this" argument
                        if (!symbol.node.isExternalImport() && symbol.kind == symbol_5.SymbolKind.FUNCTION_INSTANCE) {
                            let dotTarget = value.dotTarget();
                            this.emitNode(array, byteOffset, dotTarget);
                            if (dotTarget.kind == node_5.NodeKind.NEW) {
                    ...
                    else if (node.kind == node_5.NodeKind.DELETE) {
                        let value = node.deleteValue();
                        this.emitNode(array, byteOffset, value);
                        let freeIndex = this.calculateWasmFunctionIndex(this.freeFunctionIndex);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.CALL, freeIndex);
                        ...
                        if (resolvedType.isFloat()) {
                            this.emitNode(array, byteOffset, node.unaryValue());
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_NEG);
                        }
                        else if (resolvedType.isDouble()) {
                            this.emitNode(array, byteOffset, node.unaryValue());
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_NEG);
                        }
                        else if (resolvedType.isInteger()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, 0);
                            this.assembler.writeLEB128(array, 0);
                            this.emitNode(array, byteOffset, node.unaryValue());
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_SUB);
                        }
                        else if (resolvedType.isLong()) {
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, 0);
                            this.assembler.writeLEB128(array, 0);
                            this.emitNode(array, byteOffset, node.unaryValue());
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_SUB);
                        }
                    }
                        ...
                        this.assembler.writeLEB128(array, ~0);
                        this.emitNode(array, byteOffset, node.unaryValue());
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_XOR);
                    }
                        ...
                        if ((from == context.nullType || from == context.int32Type || from == context.uint32Type) &&
                            ...
                            if (value.kind == node_5.NodeKind.NULL) {
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, 0);
                                this.assembler.writeLEB128(array, 0);
                            }
                            else if (value.kind == node_5.NodeKind.INT32) {
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, value.longValue);
                                this.assembler.writeLEB128(array, value.longValue);
                            }
                            else {
                                ...
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.I64_EXTEND_U_I32 : opcode_4.WasmOpcode.I64_EXTEND_S_I32);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.NULL) {
                                ...
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, floatValue);
                                this.assembler.writeFloat(array, floatValue);
                            }
                            else {
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.F32_CONVERT_U_I32 : opcode_4.WasmOpcode.F32_CONVERT_S_I32);
                            }
                        }
                        else if ((from == context.nullType || from == context.int32Type || from == context.uint32Type) &&
                            ...
                            if (value.kind == node_5.NodeKind.NULL) {
                                ...
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_CONST, doubleValue);
                                this.assembler.writeDouble(array, doubleValue);
                            }
                            else {
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.F64_CONVERT_U_I32 : opcode_4.WasmOpcode.F64_CONVERT_S_I32);
                            }
                        }
                        else if ((from == context.int64Type || from == context.uint64Type) &&
                            (type == context.int32Type || type == context.uint32Type)) {
                            if (value.kind == node_5.NodeKind.INT64) {
                                let intValue = value.intValue || 0;
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, intValue);
                                this.assembler.writeLEB128(array, intValue);
                            }
                            else {
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_WRAP_I64);
                            }
                        }
                        else if ((from == context.int64Type || from == context.uint64Type) &&
                            type == context.float32Type) {
                            if (value.kind == node_5.NodeKind.INT32) {
                                let floatValue = value.floatValue || 0;
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, floatValue);
                                this.assembler.writeFloat(array, floatValue);
                            }
                                ...
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.F32_CONVERT_U_I64 : opcode_4.WasmOpcode.F32_CONVERT_S_I64);
                            }
                        }
                        else if ((from == context.int64Type || from == context.uint64Type) &&
                            type == context.float64Type) {
                            if (value.kind == node_5.NodeKind.INT64) {
                                ...
                                let isUnsigned = value.resolvedType.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.F64_CONVERT_U_I64 : opcode_4.WasmOpcode.F64_CONVERT_S_I64);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT32) {
                                let intValue = value.intValue || 0;
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, intValue);
                                this.assembler.writeLEB128(array, intValue);
                            }
                                ...
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.I32_TRUNC_U_F32 : opcode_4.WasmOpcode.I32_TRUNC_S_F32);
                            }
                        }
                        else if (from == context.float32Type &&
                            (type == context.int64Type || type == context.uint64Type)) {
                            if (value.kind == node_5.NodeKind.FLOAT32) {
                                ...
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, longValue);
                                this.assembler.writeLEB128(array, longValue);
                            }
                            else {
                                let isUnsigned = type.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.I64_TRUNC_U_F32 : opcode_4.WasmOpcode.I64_TRUNC_S_F32);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT32) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_PROMOTE_F32);
                            }
                        }
                            ...
                            (type == context.uint8Type || type == context.int8Type ||
                                type == context.uint16Type || type == context.int16Type ||
                                type == context.uint32Type || type == context.int32Type)) {
                            if (value.kind == node_5.NodeKind.FLOAT64) {
                                let intValue = value.intValue || 0;
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, intValue);
                                this.assembler.writeLEB128(array, intValue);
                            }
                                ...
                                let isUnsigned = type.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.I32_TRUNC_U_F64 : opcode_4.WasmOpcode.I32_TRUNC_S_F64);
                            }
                        }
                        else if (from == context.float64Type &&
                            (type == context.int64Type || type == context.uint64Type)) {
                            if (value.kind == node_5.NodeKind.FLOAT64) {
                                ...
                                let isUnsigned = type.isUnsigned();
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, isUnsigned ? opcode_4.WasmOpcode.I64_TRUNC_U_F64 : opcode_4.WasmOpcode.I64_TRUNC_S_F64);
                            }
                        }
                            ...
                            if (value.kind == node_5.NodeKind.FLOAT64) {
                                ...
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_DEMOTE_F64);
                            }
                        }
                        else {
                            this.emitNode(array, byteOffset, value);
                        ...
                        let symbol = node.symbol;
                        if (symbol.kind == symbol_5.SymbolKind.VARIABLE_INSTANCE) {
                        ...
                        if (left.kind == node_5.NodeKind.DEREFERENCE) {
                            ...
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_GLOBAL);
                            this.assembler.writeUnsignedLEB128(array, symbol.offset);
                            // this.emitStoreToMemory(array, byteOffset, symbol.resolvedType, null, WASM_MEMORY_INITIALIZER_BASE + symbol.offset, right);
                        }
                        else if (symbol.kind == symbol_5.SymbolKind.VARIABLE_ARGUMENT || symbol.kind == symbol_5.SymbolKind.VARIABLE_LOCAL) {
                            this.emitNode(array, byteOffset, right);
                            if (!node_5.isUnaryPostfix(right.kind)) {
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_LOCAL, symbol.offset);
                                this.assembler.writeUnsignedLEB128(array, symbol.offset);
                            }
                        }
                        else {
                        ...
                        this.emitNode(array, byteOffset, node.binaryLeft());
                        this.emitNode(array, byteOffset, node.binaryRight());
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_AND);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, 1);
                        this.assembler.writeLEB128(array, 1);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_EQ);
                    }
                    else if (node.kind == node_5.NodeKind.LOGICAL_OR) {
                        this.emitNode(array, byteOffset, node.binaryLeft());
                        this.emitNode(array, byteOffset, node.binaryRight());
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_OR);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST);
                        logger_3.log(array, byteOffset, 1, "i32 literal");
                        this.assembler.writeLEB128(array, 1);
                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_EQ);
                    }
                    else if (node_5.isUnary(node.kind)) {
                        let kind = node.kind;
                        if (kind == node_5.NodeKind.POSTFIX_INCREMENT || kind == node_5.NodeKind.POSTFIX_DECREMENT) {
                            let value = node.unaryValue();
                            let dataType = typeToDataType(value.resolvedType, this.bitness);
                            //TODO handle instance variable
                            if (node.parent.kind == node_5.NodeKind.VARIABLE) {
                                this.emitNode(array, byteOffset, value);
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_LOCAL, node.parent.symbol.offset);
                                this.assembler.writeUnsignedLEB128(array, node.parent.symbol.offset);
                            }
                            else if (node.parent.kind == node_5.NodeKind.ASSIGN) {
                                this.emitNode(array, byteOffset, value);
                                let left = node.parent.binaryLeft();
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_LOCAL, left.symbol.offset);
                                this.assembler.writeUnsignedLEB128(array, left.symbol.offset);
                            }
                            this.emitNode(array, byteOffset, value);
                            if (node.parent.kind != node_5.NodeKind.RETURN) {
                                ...
                                if (size == 1 || size == 2) {
                                    if (value.kind == node_5.NodeKind.INT32 || value.resolvedType.isInteger()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, 1);
                                        this.assembler.writeLEB128(array, 1);
                                    }
                                    else {
                                    ...
                                    else if (value.kind == node_5.NodeKind.FLOAT32 || value.resolvedType.isFloat()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, 1.0);
                                    ...
                                    if (value.kind == node_5.NodeKind.INT64 || value.resolvedType.isLong()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, 1);
                                        this.assembler.writeLEB128(array, 1);
                                    }
                                    else if (value.kind == node_5.NodeKind.FLOAT64 || value.resolvedType.isDouble()) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_CONST, 1.0);
                                ...
                                let operation = kind == node_5.NodeKind.POSTFIX_INCREMENT ? "ADD" : "SUB";
                                this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode[`${dataType}_${operation}`]);
                                if (value.symbol.kind == symbol_5.SymbolKind.VARIABLE_GLOBAL) {
                                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_GLOBAL, value.symbol.offset);
                                    this.assembler.writeLEB128(array, value.symbol.offset);
                                }
                                else if (value.symbol.kind == symbol_5.SymbolKind.VARIABLE_LOCAL || value.symbol.kind == symbol_5.SymbolKind.VARIABLE_ARGUMENT) {
                                    this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.SET_LOCAL, value.symbol.offset);
                                    this.assembler.writeLEB128(array, value.symbol.offset);
                                }
                                else if (value.symbol.kind == symbol_5.SymbolKind.VARIABLE_INSTANCE) {
                                    //FIXME
                        ...
                        if (node.kind == node_5.NodeKind.ADD) {
                            ...
                            if (left.resolvedType.pointerTo == null) {
                                ...
                                if (size == 2) {
                                    if (right.kind == node_5.NodeKind.INT32) {
                                        let _value = right.intValue << 1;
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, _value);
                                        this.assembler.writeLEB128(array, _value);
                                    }
                                    else {
                                        this.emitNode(array, byteOffset, right);
                                    ...
                                    else if (right.kind == node_5.NodeKind.FLOAT32) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F32_CONST, right.floatValue);
                                        this.assembler.writeFloat(array, right.floatValue);
                                    }
                                    else {
                                        this.emitNode(array, byteOffset, right);
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_CONST, 2);
                                        this.assembler.writeLEB128(array, 2);
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I32_SHL);
                                    }
                                }
                                else if (size == 8) {
                                    if (right.kind == node_5.NodeKind.INT64) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.I64_CONST, right.longValue);
                                        this.assembler.writeLEB128(array, right.longValue);
                                    }
                                    else if (right.kind == node_5.NodeKind.FLOAT64) {
                                        this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode.F64_CONST, right.doubleValue);
                            ...
                            this.assembler.appendOpcode(array, byteOffset, opcode_4.WasmOpcode[`${dataTypeLeft}_ADD`]);
                        }
                        else if (node.kind == node_5.NodeKind.BITWISE_AND) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_AND`]);
                        }
                        else if (node.kind == node_5.NodeKind.BITWISE_OR) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_OR`]);
                        }
                        else if (node.kind == node_5.NodeKind.BITWISE_XOR) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_XOR`]);
                        }
                        else if (node.kind == node_5.NodeKind.EQUAL) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_EQ`]);
                        }
                        else if (node.kind == node_5.NodeKind.MULTIPLY) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_MUL`]);
                        }
                        else if (node.kind == node_5.NodeKind.NOT_EQUAL) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_NE`]);
                        }
                        else if (node.kind == node_5.NodeKind.SHIFT_LEFT) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_SHL`]);
                        }
                        else if (node.kind == node_5.NodeKind.SUBTRACT) {
                            this.emitBinaryExpression(array, byteOffset, node, opcode_4.WasmOpcode[`${dataTypeLeft}_SUB`]);
                        }
                        else if (node.kind == node_5.NodeKind.DIVIDE) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_DIV`] :
                                (isUnsigned ? opcode_4.WasmOpcode[`${dataTypeLeft}_DIV_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_DIV_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.GREATER_THAN) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_GT`] :
                                (isUnsigned ? opcode_4.WasmOpcode[`${dataTypeLeft}_GT_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_GT_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.GREATER_THAN_EQUAL) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_GE`] :
                                (isUnsigned ? opcode_4.WasmOpcode[`${dataTypeLeft}_GE_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_GE_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.LESS_THAN) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_LT`] :
                                (isUnsigned ? opcode_4.WasmOpcode[`${dataTypeLeft}_LT_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_LT_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.LESS_THAN_EQUAL) {
                            let opcode = (isFloat || isDouble) ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_LE`] :
                                (isUnsigned ? opcode_4.WasmOpcode[`${dataTypeLeft}_LE_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_LE_S`]);
                            this.emitBinaryExpression(array, byteOffset, node, opcode);
                        }
                        else if (node.kind == node_5.NodeKind.REMAINDER) {
                            this.emitBinaryExpression(array, byteOffset, node, isUnsigned ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_REM_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_REM_S`]);
                        }
                        else if (node.kind == node_5.NodeKind.SHIFT_RIGHT) {
                            this.emitBinaryExpression(array, byteOffset, node, isUnsigned ?
                                opcode_4.WasmOpcode[`${dataTypeLeft}_SHR_U`] : opcode_4.WasmOpcode[`${dataTypeLeft}_SHR_S`]);
                        }
                        else {
                            assert(false);
                        }
                ...
                getWasmType(type) {
                    ...
                    if (type == context.voidType) {
                        return wasm_type_2.WasmType.VOID;
                    }
                    assert(false);
                    return wasm_type_2.WasmType.VOID;
                }
...
System.register("library/library", ["compiler/compiler"], function (exports_30, context_30) {
    "use strict";
    var __moduleName = context_30 && context_30.id;
    function readLibraryFile(path) {
        return stdlib.IO_readTextFile(TURBO_LIBRARY_PATH + path);
    }
    var compiler_3, TURBO_LIBRARY_PATH, Library;
    return {
        setters: [
        ...
        execute: function () {
            TURBO_LIBRARY_PATH = TURBO_PATH + "/src/library";
            Library = class Library {
                static get(target) {
                    let lib;
                    switch (target) {
                        case compiler_3.CompileTarget.JAVASCRIPT:
                            lib = readLibraryFile("/turbo/types.tbs") + "\n";
                            break;
                        case compiler_3.CompileTarget.WEBASSEMBLY:
                            lib = [
            ...
            exports_30("Library", Library);
        }
    };
});
System.register("compiler/parser/preparser", ["utils/log", "compiler/scanner/scanner", "turboscript", "utils/stringbuilder"], function (exports_31, context_31) {
    "use strict";
    ...
    function preparse(source, compiler, log) {
        ...
        while (i < limit) {
            ...
            let kind = scanner_4.TokenKind.END_OF_FILE;
            // Newline
            if (c == '\n') {
                if (!wantNewline) {
                    continue;
                ...
                if (i < limit && contents[i] == '*') {
                    ...
                    if (!foundEnd) {
                        log.error(log_4.createRange(source, start, start + 2), "Unterminated multi-line comment");
                        return null;
                    }
                }
            }
            else if (scanner_4.isAlpha(c)) {
                while (i < limit && (scanner_4.isAlpha(contents[i]) || scanner_4.isNumber(contents[i]))) {
                    i = i + 1;
                }
                // Keywords
                let length = i - start;
                ...
                while (i < limit) {
                    ...
                    if (i + 1 < limit && next == '\\') {
                        ...
                        if (next == c) {
                            ...
                            kind = c == '\'' ? scanner_4.TokenKind.CHARACTER : scanner_4.TokenKind.STRING;
                            break;
                        }
                    }
                }
    ...
    function resolveImport(importPath, original) {
        ...
        if (contents == null) {
            turboscript_1.printError(stringbuilder_7.StringBuilder_new().append("Cannot read from ").append(importPath).finish());
            return null;
        }
        return contents;
    }
    var log_4, scanner_4, turboscript_1, stringbuilder_7;
    return {
        setters: [
            function (log_4_1) {
                log_4 = log_4_1;
            },
            function (scanner_4_1) {
                scanner_4 = scanner_4_1;
            },
            function (turboscript_1_1) {
                turboscript_1 = turboscript_1_1;
            },
...
System.register("compiler/compiler", ["compiler/analyzer/type-checker", "compiler/core/node", "utils/log", "compiler/preprocessor/preprocessor", "compiler/core/scope", "compiler/scanner/scanner", "compiler/parser/parser", "compiler/optimizer/shaking", "utils/stringbuilder", "backends/webassembly/webassembly", "library/library", "compiler/parser/preparser"], function (exports_32, context_32) {
    "use strict";
    var __moduleName = context_32 && context_32.id;
    function replaceFileExtension(path, extension) {
        let builder = stringbuilder_8.StringBuilder_new();
    ...
    exports_32("replaceFileExtension", replaceFileExtension);
    var type_checker_1, node_6, log_5, preprocessor_1, scope_1, scanner_5, parser_4, shaking_1, stringbuilder_8, webassembly_1, library_1, preparser_1, CompileTarget, Compiler;
    return {
        setters: [
            ...
            function (scanner_5_1) {
                scanner_5 = scanner_5_1;
            },
            function (parser_4_1) {
                parser_4 = parser_4_1;
            },
            ...
            function (webassembly_1_1) {
                webassembly_1 = webassembly_1_1;
            },
        ...
        execute: function () {
            ...
            exports_32("CompileTarget", CompileTarget);
            Compiler = class Compiler {
                initialize(target, outputName) {
                    assert(this.log == null);
                    this.log = new log_5.Log();
                ...
                createGlobals() {
                    ...
                    let global = new node_6.Node();
                    global.kind = node_6.NodeKind.GLOBAL;
                ...
                finish() {
                    ...
                    while (source != null) {
                        source.firstToken = scanner_5.tokenize(source, this.log);
                        source = source.next;
                    }
                    ...
                    while (source != null) {
                        if (source.firstToken != null) {
                            source.file = parser_4.parse(source.firstToken, this.log);
                        }
                        source = source.next;
                    }
                    ...
                    while (source != null) {
                        ...
                        if (file != null) {
                            if (source.isLibrary) {
                                file.flags |= node_6.NODE_FLAG_LIBRARY;
            ...
            exports_32("Compiler", Compiler);
        }
    };
});
System.register("compiler/const", [], function (exports_33, context_33) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_33("MIN_INT32_VALUE", MIN_INT32_VALUE = -Math.pow(2, 31));
            exports_33("MAX_INT32_VALUE", MAX_INT32_VALUE = Math.pow(2, 31) - 1);
            exports_33("MIN_UINT32_VALUE", MIN_UINT32_VALUE = 0);
            exports_33("MAX_UINT32_VALUE", MAX_UINT32_VALUE = Math.pow(2, 32) - 1);
            //FIXME: Cannot represent 64 bit integer in javascript
            exports_33("MIN_INT64_VALUE", MIN_INT64_VALUE = -Math.pow(2, 63));
            exports_33("MAX_INT64_VALUE", MAX_INT64_VALUE = Math.pow(2, 63) - 1);
            exports_33("MIN_UINT64_VALUE", MIN_UINT64_VALUE = 0);
            exports_33("MAX_UINT64_VALUE", MAX_UINT64_VALUE = Math.pow(2, 64) - 1);
        }
    };
});
System.register("compiler/analyzer/type-checker", ["compiler/core/symbol", "compiler/core/type", "compiler/core/node", "compiler/compiler", "utils/log", "compiler/core/scope", "utils/stringbuilder", "utils/imports", "compiler/const"], function (exports_34, context_34) {
    "use strict";
    ...
    exports_34("addScopeToSymbol", addScopeToSymbol);
    ...
    exports_34("linkSymbolToNode", linkSymbolToNode);
    function initialize(context, node, parentScope, mode) {
        let kind = node.kind;
        if (node.parent != null) {
            let parentKind = node.parent.kind;
            // Validate node placement
            if (kind != node_7.NodeKind.IMPORTS &&
                kind != node_7.NodeKind.VARIABLE &&
                kind != node_7.NodeKind.VARIABLES &&
                (kind != node_7.NodeKind.FUNCTION || parentKind != node_7.NodeKind.CLASS) &&
                (parentKind == node_7.NodeKind.FILE || parentKind == node_7.NodeKind.GLOBAL) != (parentKind == node_7.NodeKind.MODULE ||
                    kind == node_7.NodeKind.MODULE ||
                    kind == node_7.NodeKind.CLASS ||
                    kind == node_7.NodeKind.ENUM ||
                    kind == node_7.NodeKind.FUNCTION ||
                    kind == node_7.NodeKind.CONSTANTS)) {
                context.log.error(node.range, "This statement is not allowed here");
            }
        }
        // Module
        if (kind == node_7.NodeKind.MODULE) {
            assert(node.symbol == null);
            let symbol = new symbol_6.Symbol();
            symbol.kind = symbol_6.SymbolKind.TYPE_MODULE;
            symbol.name = node.stringValue;
            symbol.resolvedType = new type_2.Type();
            symbol.resolvedType.symbol = symbol;
            symbol.flags = symbol_6.SYMBOL_FLAG_IS_REFERENCE;
        ...
        // Class
        if (kind == node_7.NodeKind.CLASS || kind == node_7.NodeKind.ENUM) {
            assert(node.symbol == null);
            let symbol = new symbol_6.Symbol();
            symbol.kind = kind == node_7.NodeKind.CLASS ? symbol_6.SymbolKind.TYPE_CLASS : symbol_6.SymbolKind.TYPE_ENUM;
            symbol.name = node.stringValue;
            symbol.resolvedType = new type_2.Type();
            symbol.resolvedType.symbol = symbol;
            symbol.flags = symbol_6.SYMBOL_FLAG_IS_REFERENCE;
            ...
            if (node.parameterCount() > 0) {
                ...
                symbol.kind = symbol_6.SymbolKind.TYPE_TEMPLATE;
                symbol.flags |= symbol_6.SYMBOL_FLAG_IS_TEMPLATE;
                //TODO: Lift generic parameter limit from 1 to many
                let genericType = node.firstGenericType();
                let genericSymbol = new symbol_6.Symbol();
                genericSymbol.kind = symbol_6.SymbolKind.TYPE_GENERIC;
                ...
                genericSymbol.flags = symbol_6.SYMBOL_FLAG_IS_GENERIC;
                genericType.flags = node_7.NODE_FLAG_GENERIC;
        ...
        else if (kind == node_7.NodeKind.FUNCTION) {
            assert(node.symbol == null);
            let symbol = new symbol_6.Symbol();
            symbol.kind =
                node.parent.kind == node_7.NodeKind.CLASS ? symbol_6.SymbolKind.FUNCTION_INSTANCE :
                    symbol_6.SymbolKind.FUNCTION_GLOBAL;
            symbol.name = node.stringValue;
            if (node.isOperator()) {
                if (symbol.name == "+" || symbol.name == "-") {
                    if (node.functionFirstArgument() == node.functionReturnType()) {
                        symbol.flags = symbol_6.SYMBOL_FLAG_IS_UNARY_OPERATOR;
                        symbol.rename = symbol.name == "+" ? "op_positive" : "op_negative";
                    }
                    else {
                        symbol.flags = symbol_6.SYMBOL_FLAG_IS_BINARY_OPERATOR;
            ...
            if (symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE) {
                ...
                if (symbol.name == "constructor") {
                    ...
                    if (body !== null) {
                        ...
                        if (variablesNode.kind !== node_7.NodeKind.VARIABLES) {
                            let _variablesNode = node_7.createVariables();
                        ...
                        if (firstVariable !== undefined) {
                            if (firstVariable.stringValue !== "this") {
                                variablesNode.insertChildBefore(firstVariable, node_7.createVariable("this", node_7.createType(parent.resolvedType), null));
                            }
                            ...
                            variablesNode.appendChild(node_7.createVariable("this", node_7.createType(parent.resolvedType), null));
                        }
                        // All constructors have special return "this" type
                        let returnNode = node_7.createReturn(node_7.createName("this"));
                        if (node.lastChild.lastChild && node.lastChild.lastChild.kind == node_7.NodeKind.RETURN) {
                    ...
                    if (firstArgument.stringValue !== "this") {
                        node.insertChildBefore(firstArgument, node_7.createVariable("this", node_7.createType(parent.resolvedType), null));
                    }
        ...
        else if (kind == node_7.NodeKind.VARIABLE) {
            assert(node.symbol == null);
            let symbol = new symbol_6.Symbol();
            symbol.kind =
                node.parent.kind == node_7.NodeKind.CLASS ? symbol_6.SymbolKind.VARIABLE_INSTANCE :
                    node.parent.kind == node_7.NodeKind.FUNCTION ? symbol_6.SymbolKind.VARIABLE_ARGUMENT :
                        node.parent.kind == node_7.NodeKind.CONSTANTS || node.parent.kind == node_7.NodeKind.ENUM ? symbol_6.SymbolKind.VARIABLE_CONSTANT :
                            node.parent.kind == node_7.NodeKind.VARIABLES && node.parent.parent.kind == node_7.NodeKind.FILE ? symbol_6.SymbolKind.VARIABLE_GLOBAL :
                                symbol_6.SymbolKind.VARIABLE_LOCAL;
            symbol.name = node.stringValue;
            symbol.scope = parentScope;
            linkSymbolToNode(symbol, node);
            parentScope.define(context.log, symbol, scope_2.ScopeHint.NORMAL);
        }
        else if (kind == node_7.NodeKind.BLOCK) {
            if (node.parent.kind != node_7.NodeKind.FUNCTION) {
                let scope = new scope_2.Scope();
                scope.parent = parentScope;
                parentScope = scope;
            }
        ...
        while (child != null) {
            if (mode == CheckMode.INITIALIZE) {
                child.flags |= node_7.NODE_FLAG_LIBRARY;
            }
            initialize(context, child, parentScope, mode);
            child = child.nextSibling;
        }
        if (kind == node_7.NodeKind.FILE && mode == CheckMode.INITIALIZE) {
            ...
            prepareNativeType(context.uint8Type, 1, symbol_6.SYMBOL_FLAG_NATIVE_INTEGER | symbol_6.SYMBOL_FLAG_IS_UNSIGNED);
            prepareNativeType(context.int8Type, 1, symbol_6.SYMBOL_FLAG_NATIVE_INTEGER);
            prepareNativeType(context.int16Type, 2, symbol_6.SYMBOL_FLAG_NATIVE_INTEGER);
            prepareNativeType(context.uint16Type, 2, symbol_6.SYMBOL_FLAG_NATIVE_INTEGER | symbol_6.SYMBOL_FLAG_IS_UNSIGNED);
            prepareNativeType(context.int32Type, 4, symbol_6.SYMBOL_FLAG_NATIVE_INTEGER);
            prepareNativeType(context.int64Type, 8, symbol_6.SYMBOL_FLAG_NATIVE_LONG);
            prepareNativeType(context.uint32Type, 4, symbol_6.SYMBOL_FLAG_NATIVE_INTEGER | symbol_6.SYMBOL_FLAG_IS_UNSIGNED);
            prepareNativeType(context.uint64Type, 8, symbol_6.SYMBOL_FLAG_NATIVE_LONG | symbol_6.SYMBOL_FLAG_IS_UNSIGNED);
            prepareNativeType(context.stringType, 4, symbol_6.SYMBOL_FLAG_IS_REFERENCE);
            prepareNativeType(context.float32Type, 4, symbol_6.SYMBOL_FLAG_NATIVE_FLOAT);
            prepareNativeType(context.float64Type, 8, symbol_6.SYMBOL_FLAG_NATIVE_DOUBLE);
    ...
    exports_34("initialize", initialize);
    function prepareNativeType(type, byteSizeAndMaxAlignment, flags) {
        let symbol = type.symbol;
        symbol.kind = symbol_6.SymbolKind.TYPE_NATIVE;
    ...
    function prepareBuiltinType(type, byteSizeAndMaxAlignment, flags) {
        let symbol = type.symbol;
        symbol.kind = symbol_6.SymbolKind.TYPE_CLASS;
        symbol.byteSize = byteSizeAndMaxAlignment;
        symbol.maxAlignment = byteSizeAndMaxAlignment;
        symbol.flags = flags;
    }
    function forbidFlag(context, node, flag, text) {
        if ((node.flags & flag) != 0) {
            let range = node_7.rangeForFlag(node.firstFlag, flag);
            if (range != null) {
    ...
    exports_34("forbidFlag", forbidFlag);
    ...
    exports_34("requireFlag", requireFlag);
    function initializeSymbol(context, symbol) {
        if (symbol.state == symbol_6.SymbolState.INITIALIZED) {
            assert(symbol.resolvedType != null);
            return;
        }
        assert(symbol.state == symbol_6.SymbolState.UNINITIALIZED);
        symbol.state = symbol_6.SymbolState.INITIALIZING;
        // Most flags aren't supported yet
        let node = symbol.node;
        // forbidFlag(context, node, NODE_FLAG_EXPORT, "Unsupported flag 'export'");
        forbidFlag(context, node, node_7.NODE_FLAG_PROTECTED, "Unsupported flag 'protected'");
        //forbidFlag(context, node, NODE_FLAG_STATIC, "Unsupported flag 'static'");
        // Module
        if (symbol.kind == symbol_6.SymbolKind.TYPE_MODULE) {
            forbidFlag(context, node, node_7.NODE_FLAG_GET, "Cannot use 'get' on a module");
            forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use 'set' on a module");
            forbidFlag(context, node, node_7.NODE_FLAG_PUBLIC, "Cannot use 'public' on a module");
            forbidFlag(context, node, node_7.NODE_FLAG_PRIVATE, "Cannot use 'private' on a module");
        }
        else if (symbol.kind == symbol_6.SymbolKind.TYPE_CLASS || symbol.kind == symbol_6.SymbolKind.TYPE_NATIVE ||
            symbol.kind == symbol_6.SymbolKind.TYPE_GENERIC || symbol.kind == symbol_6.SymbolKind.TYPE_TEMPLATE) {
            forbidFlag(context, node, node_7.NODE_FLAG_GET, "Cannot use 'get' on a class");
            forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use 'set' on a class");
            forbidFlag(context, node, node_7.NODE_FLAG_PUBLIC, "Cannot use 'public' on a class");
            forbidFlag(context, node, node_7.NODE_FLAG_PRIVATE, "Cannot use 'private' on a class");
        }
        else if (symbol.kind == symbol_6.SymbolKind.TYPE_INTERFACE) {
            forbidFlag(context, node, node_7.NODE_FLAG_GET, "Cannot use 'get' on a interface");
            forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use 'set' on a interface");
            forbidFlag(context, node, node_7.NODE_FLAG_PUBLIC, "Cannot use 'public' on a interface");
            forbidFlag(context, node, node_7.NODE_FLAG_PRIVATE, "Cannot use 'private' on a interface");
        }
        else if (symbol.kind == symbol_6.SymbolKind.TYPE_ENUM) {
            forbidFlag(context, node, node_7.NODE_FLAG_GET, "Cannot use 'get' on an enum");
            forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use 'set' on an enum");
            forbidFlag(context, node, node_7.NODE_FLAG_PUBLIC, "Cannot use 'public' on an enum");
            forbidFlag(context, node, node_7.NODE_FLAG_PRIVATE, "Cannot use 'private' on an enum");
            symbol.resolvedType = new type_2.Type();
            symbol.resolvedType.symbol = symbol;
        ...
        else if (symbol_6.isFunction(symbol.kind)) {
            let body = node.functionBody();
            let returnType = node.functionReturnType();
            ...
            while (child != returnType) {
                ...
                assert(child.symbol.kind == symbol_6.SymbolKind.VARIABLE_ARGUMENT);
            ...
            if (symbol.kind != symbol_6.SymbolKind.FUNCTION_INSTANCE) {
                forbidFlag(context, node, node_7.NODE_FLAG_GET, "Cannot use 'get' here");
                forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use 'set' here");
                forbidFlag(context, node, node_7.NODE_FLAG_PUBLIC, "Cannot use 'public' here");
                forbidFlag(context, node, node_7.NODE_FLAG_PRIVATE, "Cannot use 'private' here");
            }
            else if (node.isGet()) {
                forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use both 'get' and 'set'");
                ...
                symbol.rename = stringbuilder_9.StringBuilder_new()
                    .append("set_")
                    .append(symbol.name)
                    .finish();
                // Validate argument count including "this"
                ...
                if (symbol.name == "~" || symbol.name == "++" || symbol.name == "--") {
                    if (argumentCount != 1) {
                        context.log.error(symbol.range, stringbuilder_9.StringBuilder_new()
                            .append("Operator '")
                            .append(symbol.name)
            ...
            if (symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE) {
                ...
                forbidFlag(context, node, node_7.NODE_FLAG_EXPORT, "Cannot use 'export' on an instance function");
                forbidFlag(context, node, node_7.NODE_FLAG_DECLARE, "Cannot use 'declare' on an instance function");
                // Functions inside declared classes are automatically declared
                if (parent.node.isDeclare()) {
                    if (body == null) {
                        node.flags = node.flags | node_7.NODE_FLAG_DECLARE;
                    }
                    else {
                    ...
                    if (parent.node.isExport()) {
                        node.flags = node.flags | node_7.NODE_FLAG_EXPORT;
                    }
                }
                // Rewrite this symbol as a global function instead of an instance function
                if (shouldConvertInstanceToGlobal) {
                    symbol.kind = symbol_6.SymbolKind.FUNCTION_GLOBAL;
                    symbol.flags = symbol.flags | symbol_6.SYMBOL_FLAG_CONVERT_INSTANCE_TO_GLOBAL;
                    symbol.rename = stringbuilder_9.StringBuilder_new()
                        .append(parent.name)
                        .appendChar('_')
                ...
                forbidFlag(context, node, node_7.NODE_FLAG_EXPORT, "Cannot use 'export' on an unimplemented function");
                if (!node.parent || !node.parent.isDeclare()) {
                    requireFlag(context, node, node_7.NODE_FLAG_DECLARE, "Declared functions must be prefixed with 'declare'");
                }
            }
            else {
                forbidFlag(context, node, node_7.NODE_FLAG_DECLARE, "Cannot use 'declare' on a function with an implementation");
            }
            context.isUnsafeAllowed = oldUnsafeAllowed;
        }
        else if (symbol_6.isVariable(symbol.kind)) {
            forbidFlag(context, node, node_7.NODE_FLAG_GET, "Cannot use 'get' on a variable");
            forbidFlag(context, node, node_7.NODE_FLAG_SET, "Cannot use 'set' on a variable");
            ...
            if (symbol.resolvedType == context.voidType || symbol.resolvedType == context.nullType) {
                context.log.error(node.internalRange, stringbuilder_9.StringBuilder_new()
            ...
            if (symbol.kind == symbol_6.SymbolKind.VARIABLE_CONSTANT) {
                if (value != null) {
                    resolveAsExpression(context, value, symbol.scope);
                    checkConversion(context, value, symbol.resolvedTypeUnderlyingIfEnumValue(context), type_2.ConversionKind.IMPLICIT);
                    if (value.kind == node_7.NodeKind.INT32 || value.kind == node_7.NodeKind.INT64 || value.kind == node_7.NodeKind.BOOLEAN) {
                        symbol.offset = value.intValue;
                    }
                    else if (value.kind == node_7.NodeKind.FLOAT32 || value.kind == node_7.NodeKind.FLOAT64) {
        ...
        assert(symbol.resolvedType != null);
        symbol.state = symbol_6.SymbolState.INITIALIZED;
    }
    exports_34("initializeSymbol", initializeSymbol);
    /**
    ...
    function deriveConcreteClass(context, type, parameters, scope) {
        ...
        if (symbol) {
            ...
            let genericSymbol = scope.parent.findNested(type.firstChild.firstChild.stringValue, scope_2.ScopeHint.NORMAL, scope_2.FindNested.NORMAL);
        ...
        node.symbol.flags |= symbol_6.SYMBOL_FLAG_USED;
        ...
        type.firstChild.firstChild.kind = node_7.NodeKind.NAME;
        resolve(context, type.firstChild.firstChild, scope.parent);
    ...
    function cloneChildren(child, parentNode, parameters, templateName, typeName) {
        ...
        while (child) {
            if (child.stringValue == "this" && child.parent.symbol &&
                child.parent.symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE && child.kind == node_7.NodeKind.TYPE) {
                child = child.nextSibling;
                continue;
            }
            let childNode;
            if (child.kind == node_7.NodeKind.PARAMETERS || child.kind == node_7.NodeKind.PARAMETER) {
                child = child.nextSibling;
                continue;
            }
            if (child.isGeneric()) {
                ...
                if (child.symbol && symbol_6.isVariable(child.symbol.kind)) {
                    childNode = child.clone();
                }
                else {
                    childNode = parameters[offset].clone();
                }
                childNode.kind = node_7.NodeKind.NAME;
            }
            else {
            ...
            if (childNode.stringValue == "constructor" && childNode.parent.kind == node_7.NodeKind.CLASS) {
    ...
    exports_34("resolveChildren", resolveChildren);
    ...
    exports_34("resolveChildrenAsExpressions", resolveChildrenAsExpressions);
    function resolveAsExpression(context, node, parentScope) {
        assert(node_7.isExpression(node));
        ...
        if (node.resolvedType != context.errorType) {
            ...
            else if (node.resolvedType == context.voidType && node.parent.kind != node_7.NodeKind.EXPRESSION) {
                context.log.error(node.range, "This expression does not return a value");
                node.resolvedType = context.errorType;
            }
        }
    }
    exports_34("resolveAsExpression", resolveAsExpression);
    ...
    exports_34("resolveAsType", resolveAsType);
    function canConvert(context, node, to, kind) {
        ...
        if (from == to || from == context.errorType || to == context.errorType) {
            ...
            if (kind == type_2.ConversionKind.EXPLICIT || from.symbol.byteSize < to.symbol.byteSize ||
                node.kind == node_7.NodeKind.INT32 && (to.isUnsigned()
    ...
    exports_34("canConvert", canConvert);
    function checkConversion(context, node, to, kind) {
        if (!canConvert(context, node, to, kind)) {
            context.log.error(node.range, stringbuilder_9.StringBuilder_new()
    ...
    exports_34("checkConversion", checkConversion);
    function checkStorage(context, target) {
        assert(node_7.isExpression(target));
        if (target.resolvedType != context.errorType && target.kind != node_7.NodeKind.INDEX && target.kind != node_7.NodeKind.DEREFERENCE &&
            (target.kind != node_7.NodeKind.NAME && target.kind != node_7.NodeKind.DOT || target.symbol != null && (!symbol_6.isVariable(target.symbol.kind) || target.symbol.kind == symbol_6.SymbolKind.VARIABLE_CONSTANT))) {
            context.log.error(target.range, "Cannot store to this location");
            target.resolvedType = context.errorType;
        }
    }
    exports_34("checkStorage", checkStorage);
    function createDefaultValueForType(context, type) {
        if (type.isLong()) {
            return node_7.createLong(0);
        }
        else if (type.isInteger()) {
            return node_7.createInt(0);
        }
        else if (type.isDouble()) {
            return node_7.createDouble(0);
        }
        else if (type.isFloat()) {
            return node_7.createFloat(0);
        }
        if (type == context.booleanType) {
            return node_7.createboolean(false);
        }
        if (type.isClass()) {
            return node_7.createNull();
        }
        assert(type.isReference());
        return node_7.createNull();
    }
    exports_34("createDefaultValueForType", createDefaultValueForType);
    function simplifyBinary(node) {
        let left = node.binaryLeft();
        let right = node.binaryRight();
        // Canonicalize commutative operators
        if ((node.kind == node_7.NodeKind.ADD || node.kind == node_7.NodeKind.MULTIPLY ||
            node.kind == node_7.NodeKind.BITWISE_AND || node.kind == node_7.NodeKind.BITWISE_OR || node.kind == node_7.NodeKind.BITWISE_XOR) &&
            left.kind == node_7.NodeKind.INT32 && right.kind != node_7.NodeKind.INT32) {
        ...
        if ((node.kind == node_7.NodeKind.MULTIPLY || (node.kind == node_7.NodeKind.DIVIDE || node.kind == node_7.NodeKind.REMAINDER) && node.resolvedType.isUnsigned()) &&
            right.kind == node_7.NodeKind.INT32 && imports_2.isPositivePowerOf2(right.intValue)) {
            ...
            // "x * 16" => "x << 4"
            if (node.kind == node_7.NodeKind.MULTIPLY) {
                node.kind = node_7.NodeKind.SHIFT_LEFT;
                right.intValue = shift;
            }
            else if (node.kind == node_7.NodeKind.DIVIDE) {
                node.kind = node_7.NodeKind.SHIFT_RIGHT;
                right.intValue = shift;
            }
            else if (node.kind == node_7.NodeKind.REMAINDER) {
                node.kind = node_7.NodeKind.BITWISE_AND;
        ...
        else if (node.kind == node_7.NodeKind.ADD && right.kind == node_7.NodeKind.NEGATIVE) {
            node.kind = node_7.NodeKind.SUBTRACT;
            right.replaceWith(right.unaryValue().remove());
        }
        else if (node.kind == node_7.NodeKind.ADD && right.isNegativeInteger()) {
            node.kind = node_7.NodeKind.SUBTRACT;
            right.intValue = -right.intValue;
        }
    }
    exports_34("simplifyBinary", simplifyBinary);
    ...
    exports_34("binaryHasUnsignedArguments", binaryHasUnsignedArguments);
    ...
    exports_34("isBinaryLong", isBinaryLong);
    ...
    function isSymbolAccessAllowed(context, symbol, node, range) {
        ...
        if (symbol_6.isFunction(symbol.kind) && (symbol.isSetter() ? !node.isAssignTarget() : !node.isCallValue())) {
            if (symbol.isSetter()) {
                context.log.error(range, stringbuilder_9.StringBuilder_new()
    ...
    exports_34("isSymbolAccessAllowed", isSymbolAccessAllowed);
    function resolve(context, node, parentScope) {
        let kind = node.kind;
        assert(kind == node_7.NodeKind.FILE || parentScope != null);
        if (node.resolvedType != null) {
            return;
        }
        node.resolvedType = context.errorType;
        if (kind == node_7.NodeKind.FILE || kind == node_7.NodeKind.GLOBAL) {
            resolveChildren(context, node, parentScope);
        }
        else if (kind == node_7.NodeKind.MODULE) {
        ...
        else if (kind == node_7.NodeKind.IMPORT || kind == node_7.NodeKind.IMPORT_FROM) {
            //ignore imports
        }
        else if (kind == node_7.NodeKind.CLASS) {
            let oldEnclosingClass = context.enclosingClass;
            initializeSymbol(context, node.symbol);
            context.enclosingClass = node.symbol;
            resolveChildren(context, node, node.scope);
            if (node.symbol.kind == symbol_6.SymbolKind.TYPE_CLASS) {
                node.symbol.determineClassLayout(context);
            }
            context.enclosingClass = oldEnclosingClass;
        }
        else if (kind == node_7.NodeKind.ENUM) {
            initializeSymbol(context, node.symbol);
            resolveChildren(context, node, node.scope);
        }
        else if (kind == node_7.NodeKind.FUNCTION) {
            let body = node.functionBody();
            initializeSymbol(context, node.symbol);
            if (node.stringValue == "constructor" && node.parent.kind == node_7.NodeKind.CLASS) {
        ...
        else if (kind == node_7.NodeKind.PARAMETER) {
            let symbol = node.symbol;
        }
        else if (kind == node_7.NodeKind.VARIABLE) {
            let symbol = node.symbol;
            ...
            if (value != null) {
                ...
                if (symbol.kind == symbol_6.SymbolKind.VARIABLE_GLOBAL && value.kind != node_7.NodeKind.INT32 && value.kind != node_7.NodeKind.BOOLEAN && value.kind != node_7.NodeKind.NULL) {
            ...
            if (symbol.kind == symbol_6.SymbolKind.VARIABLE_GLOBAL && symbol.resolvedType != context.errorType) {
        ...
        else if (kind == node_7.NodeKind.BREAK || kind == node_7.NodeKind.CONTINUE) {
            let found = false;
            let n = node;
            while (n != null) {
                if (n.kind == node_7.NodeKind.WHILE) {
                    found = true;
                    break;
                }
                n = n.parent;
        ...
        else if (kind == node_7.NodeKind.IMPORTS || kind == node_7.NodeKind.CONSTANTS || kind == node_7.NodeKind.VARIABLES) {
            resolveChildren(context, node, parentScope);
        }
        else if (kind == node_7.NodeKind.ANY) {
            //imported functions have anyType
            node.kind = node_7.NodeKind.TYPE;
            node.resolvedType = context.anyType;
        }
        else if (kind == node_7.NodeKind.INT32) {
            ...
            if (type != context.errorType) {
                ...
                if (symbol == null) {
                    ...
                    assert(symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE || symbol.kind == symbol_6.SymbolKind.FUNCTION_GLOBAL && symbol.shouldConvertInstanceToGlobal());
                    // Convert to a regular function call and resolve that instead
                    node.kind = node_7.NodeKind.CALL;
                    target.remove();
                    node.insertChildBefore(node.firstChild, node_7.createMemberReference(target, symbol));
                    node.resolvedType = null;
                    resolveAsExpression(context, node, parentScope);
                }
            }
        }
        else if (kind == node_7.NodeKind.ALIGN_OF) {
        ...
        else if (kind == node_7.NodeKind.SIZE_OF) {
        ...
        else if (kind == node_7.NodeKind.THIS) {
        ...
        else if (kind == node_7.NodeKind.PARSE_ERROR) {
            node.resolvedType = context.errorType;
        }
        else if (kind == node_7.NodeKind.NAME) {
            let name = node.stringValue;
            let symbol = parentScope.findNested(name, scope_2.ScopeHint.NORMAL, scope_2.FindNested.NORMAL);
            if (symbol == null) {
                let builder = stringbuilder_9.StringBuilder_new()
            ...
            else if (symbol.state == symbol_6.SymbolState.INITIALIZING) {
                context.log.error(node.range, stringbuilder_9.StringBuilder_new()
                ...
                if (node.resolvedType.isGeneric()) {
                    node.flags |= node_7.NODE_FLAG_GENERIC;
                }
                // Inline constants
                if (symbol.kind == symbol_6.SymbolKind.VARIABLE_CONSTANT) {
        ...
        else if (kind == node_7.NodeKind.CAST) {
            let value = node.castValue();
            ...
            if (value.kind == node_7.NodeKind.INT32 && castedType.isInteger()) {
            ...
            else if (value.kind == node_7.NodeKind.INT32 && castedType.isFloat()) {
                node.becomeFloatConstant(value.intValue);
            }
            else if (value.kind == node_7.NodeKind.INT32 && castedType.isDouble()) {
                node.becomeDoubleConstant(value.intValue);
            }
            else if (value.kind == node_7.NodeKind.FLOAT32 && castedType.isInteger()) {
                node.becomeIntegerConstant(Math.round(value.floatValue));
            }
        }
        else if (kind == node_7.NodeKind.DOT) {
                ...
                if (target.isType() && (target.resolvedType.isEnum() || target.resolvedType.hasInstanceMembers()) ||
                    ...
                    if (name.length > 0) {
                        ...
                        if (symbol == null) {
                            ...
                            if (node.parent.stringValue === node.stringValue && node.parent.kind === node_7.NodeKind.CALL) {
                                ...
                                node.kind = node_7.NodeKind.CALL;
                                node.appendChild(node_7.createMemberReference(target.remove(), symbol));
                                node.resolvedType = null;
                                resolveAsExpression(context, node, parentScope);
                            }
                            return;
        ...
        else if (kind == node_7.NodeKind.CALL) {
            let value = node.callValue();
            resolveAsExpression(context, value, parentScope);
            if (value.resolvedType != context.errorType) {
                let symbol = value.symbol;
                // Only functions are callable
                if (symbol == null || !symbol_6.isFunction(symbol.kind)) {
                    context.log.error(value.range, stringbuilder_9.StringBuilder_new()
                    ...
                    if (symbol.shouldConvertInstanceToGlobal()) {
                        let name = node_7.createSymbolReference(symbol);
        ...
        else if (kind == node_7.NodeKind.DELETE) {
        ...
        else if (kind == node_7.NodeKind.RETURN) {
            let value = node.returnValue();
            if (value != null) {
                resolveAsExpression(context, value, parentScope);
        ...
        else if (kind == node_7.NodeKind.EMPTY) {
        }
        else if (kind == node_7.NodeKind.PARAMETERS) {
        ...
        else if (kind == node_7.NodeKind.EXPRESSION) {
            resolveAsExpression(context, node.expressionValue(), parentScope);
        }
        else if (kind == node_7.NodeKind.WHILE) {
            let value = node.whileValue();
            let body = node.whileBody();
            resolveAsExpression(context, value, parentScope);
        ...
        else if (kind == node_7.NodeKind.IF) {
        ...
        else if (kind == node_7.NodeKind.HOOK) {
            ...
            if (yes.resolvedType != commonType && (yes.resolvedType != context.nullType || !commonType.isReference()) &&
                ...
                context.log.error(log_6.spanRanges(yes.range, no.range), stringbuilder_9.StringBuilder_new()
                    .append("Type '")
        ...
        else if (kind == node_7.NodeKind.ASSIGN) {
            let left = node.binaryLeft();
            let right = node.binaryRight();
            if (left.kind == node_7.NodeKind.INDEX) {
                ...
                if (type != context.errorType) {
                    let symbol = type.hasInstanceMembers() ? type.findMember("[]=", scope_2.ScopeHint.NORMAL) : null;
                    if (symbol == null) {
                        context.log.error(left.internalRange, stringbuilder_9.StringBuilder_new()
                            .append("Cannot index into type '")
                            .append(target.resolvedType.toString())
                            .appendChar('\'')
                            .finish());
                        ...
                        assert(symbol.kind == symbol_6.SymbolKind.FUNCTION_INSTANCE);
                        // Convert to a regular function call and resolve that instead
                        node.kind = node_7.NodeKind.CALL;
                        target.remove();
                        left.remove();
                        ...
                        node.insertChildBefore(node.firstChild, node_7.createMemberReference(target, symbol));
                        node.internalRange = log_6.spanRanges(left.internalRange, right.range);
                        node.resolvedType = null;
                        resolveAsExpression(context, node, parentScope);
                        return;
                    }
        ...
        else if (kind == node_7.NodeKind.NEW) {
            compiler_4.Compiler.mallocRequired = true;
            let type = node.newType();
            resolveAsType(context, type, parentScope);
            if (type.resolvedType.isTemplate() && type.hasParameters() && node.parent != type.resolvedType.symbol.node) {
                deriveConcreteClass(context, type, [type.firstChild.firstChild], type.resolvedType.symbol.scope);
            ...
            if (type.resolvedType != context.errorType) {
                if (!type.resolvedType.isClass()) {
                    context.log.error(type.range, stringbuilder_9.StringBuilder_new()
        ...
        else if (kind == node_7.NodeKind.POINTER_TYPE) {
            let value = node.unaryValue();
            resolveAsType(context, value, parentScope);
            if (context.target == compiler_4.CompileTarget.JAVASCRIPT) {
        ...
        else if (kind == node_7.NodeKind.DEREFERENCE) {
            let value = node.unaryValue();
            resolveAsExpression(context, value, parentScope);
            let type = value.resolvedType;
            if (type != context.errorType) {
            ...
            if (kind == node_7.NodeKind.NOT) {
                ...
                if (value.kind == node_7.NodeKind.INT64) {
                    ...
                    let output = input;
                    if (kind == node_7.NodeKind.COMPLEMENT)
                        output = ~input;
                    else if (kind == node_7.NodeKind.NEGATIVE)
                        output = -input;
                ...
                node.resolvedType = context.float64Type;
                // Automatically fold constants
                if (value.kind == node_7.NodeKind.FLOAT64) {
                ...
                node.resolvedType = context.float32Type;
                // Automatically fold constants
                if (value.kind == node_7.NodeKind.FLOAT32) {
                ...
                if (symbol != null) {
                    node.appendChild(node_7.createMemberReference(value.remove(), symbol).withRange(node.range).withInternalRange(node.internalRange));
                    node.kind = node_7.NodeKind.CALL;
                    node.resolvedType = null;
                    resolveAsExpression(context, node, parentScope);
                }
            ...
            if (kind == node_7.NodeKind.LOGICAL_OR || kind == node_7.NodeKind.LOGICAL_AND) {
            ...
            else if (kind == node_7.NodeKind.ADD && leftType.pointerTo != null && rightType.isInteger()) {
                node.resolvedType = leftType;
            }
            else if ((kind == node_7.NodeKind.LESS_THAN || kind == node_7.NodeKind.LESS_THAN_EQUAL ||
                kind == node_7.NodeKind.GREATER_THAN || kind == node_7.NodeKind.GREATER_THAN_EQUAL) && (leftType.pointerTo != null || rightType.pointerTo != null)) {
                node.resolvedType = context.booleanType;
                ...
                kind != node_7.NodeKind.EQUAL && kind != node_7.NodeKind.NOT_EQUAL) {
                let isFloat = false;
                let isFloat64 = false;
                ...
                if (kind == node_7.NodeKind.ADD ||
                    kind == node_7.NodeKind.SUBTRACT ||
                    kind == node_7.NodeKind.MULTIPLY ||
                    kind == node_7.NodeKind.DIVIDE ||
                    kind == node_7.NodeKind.REMAINDER ||
                    kind == node_7.NodeKind.BITWISE_AND ||
                    kind == node_7.NodeKind.BITWISE_OR ||
                    kind == node_7.NodeKind.BITWISE_XOR ||
                    kind == node_7.NodeKind.SHIFT_LEFT ||
                    kind == node_7.NodeKind.SHIFT_RIGHT) {
                    ...
                    if (commonType == context.int64Type) {
                        if (left.kind == node_7.NodeKind.INT32) {
                            left.kind = node_7.NodeKind.INT64;
                            left.resolvedType = context.int64Type;
                        }
                        else if (right.kind == node_7.NodeKind.INT32) {
                            right.kind = node_7.NodeKind.INT64;
                            right.resolvedType = context.int64Type;
                        }
                    }
                    // Automatically fold constants
                    if ((left.kind == node_7.NodeKind.INT32 || left.kind == node_7.NodeKind.INT64) &&
                        (right.kind == node_7.NodeKind.INT32 || right.kind == node_7.NodeKind.INT64)) {
                        let inputLeft = left.intValue;
                        let inputRight = right.intValue;
                        let output = 0;
                        if (kind == node_7.NodeKind.ADD)
                            output = inputLeft + inputRight;
                        else if (kind == node_7.NodeKind.BITWISE_AND)
                            output = inputLeft & inputRight;
                        else if (kind == node_7.NodeKind.BITWISE_OR)
                            output = inputLeft | inputRight;
                        else if (kind == node_7.NodeKind.BITWISE_XOR)
                            output = inputLeft ^ inputRight;
                        else if (kind == node_7.NodeKind.DIVIDE)
                            output = inputLeft / inputRight;
                        else if (kind == node_7.NodeKind.MULTIPLY)
                            output = inputLeft * inputRight;
                        else if (kind == node_7.NodeKind.REMAINDER)
                            output = inputLeft % inputRight;
                        else if (kind == node_7.NodeKind.SHIFT_LEFT)
                            output = inputLeft << inputRight;
                        else if (kind == node_7.NodeKind.SHIFT_RIGHT)
                            output = isUnsigned ? ((inputLeft) >> (inputRight)) : inputLeft >> inputRight;
                        else if (kind == node_7.NodeKind.SUBTRACT)
                            output = inputLeft - inputRight;
                        else
                            return;
                        if (left.kind == node_7.NodeKind.INT32) {
                    ...
                    else if ((left.kind == node_7.NodeKind.FLOAT32 || left.kind == node_7.NodeKind.FLOAT64) &&
                        (right.kind == node_7.NodeKind.FLOAT32 || right.kind == node_7.NodeKind.FLOAT64)) {
                        ...
                        if (kind == node_7.NodeKind.ADD)
                            ...
                            return;
                        if (left.kind == node_7.NodeKind.FLOAT32) {
                            node.becomeFloatConstant(output);
                        }
                        else {
                            node.becomeDoubleConstant(output);
                ...
                else if (kind == node_7.NodeKind.LESS_THAN ||
                    kind == node_7.NodeKind.LESS_THAN_EQUAL ||
                    kind == node_7.NodeKind.GREATER_THAN ||
                    kind == node_7.NodeKind.GREATER_THAN_EQUAL) {
                ...
                let name = node.internalRange.toString();
                let symbol = leftType.findMember(kind == node_7.NodeKind.NOT_EQUAL ? "==" :
                    kind == node_7.NodeKind.LESS_THAN_EQUAL ? ">" :
                        kind == node_7.NodeKind.GREATER_THAN_EQUAL ? "<" :
                            name, scope_2.ScopeHint.NOT_UNARY);
                // Automatically call the function
                if (symbol != null) {
                    left = node_7.createMemberReference(left.remove(), symbol).withRange(node.range).withInternalRange(node.internalRange);
                    right.remove();
                    if (kind == node_7.NodeKind.NOT_EQUAL ||
                        kind == node_7.NodeKind.LESS_THAN_EQUAL ||
                        kind == node_7.NodeKind.GREATER_THAN_EQUAL) {
                        let call = node_7.createCall(left);
                        call.appendChild(right);
                        node.kind = node_7.NodeKind.NOT;
                ...
                else if (kind == node_7.NodeKind.EQUAL || kind == node_7.NodeKind.NOT_EQUAL) {
                    node.resolvedType = context.booleanType;
        ...
        else if (kind == node_7.NodeKind.TYPE) {
            //ignore types
        }
        else {
            console.error(`Unexpected kind: ${node_7.NodeKind[kind]}`);
            assert(false);
        }
    }
    exports_34("resolve", resolve);
    var symbol_6, type_2, node_7, compiler_4, log_6, scope_2, stringbuilder_9, imports_2, const_1, CheckContext, CheckMode;
    return {
        setters: [
            function (symbol_6_1) {
                symbol_6 = symbol_6_1;
...
System.register("compiler/core/symbol", ["compiler/core/node", "utils/imports"], function (exports_35, context_35) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_35("SymbolKind", SymbolKind);
            ...
            exports_35("SymbolState", SymbolState);
            exports_35("SYMBOL_FLAG_CONVERT_INSTANCE_TO_GLOBAL", SYMBOL_FLAG_CONVERT_INSTANCE_TO_GLOBAL = 1 << 0);
            exports_35("SYMBOL_FLAG_IS_BINARY_OPERATOR", SYMBOL_FLAG_IS_BINARY_OPERATOR = 1 << 1);
            exports_35("SYMBOL_FLAG_IS_REFERENCE", SYMBOL_FLAG_IS_REFERENCE = 1 << 2);
            exports_35("SYMBOL_FLAG_IS_UNARY_OPERATOR", SYMBOL_FLAG_IS_UNARY_OPERATOR = 1 << 3);
            exports_35("SYMBOL_FLAG_IS_UNSIGNED", SYMBOL_FLAG_IS_UNSIGNED = 1 << 4);
            exports_35("SYMBOL_FLAG_NATIVE_INTEGER", SYMBOL_FLAG_NATIVE_INTEGER = 1 << 5);
            exports_35("SYMBOL_FLAG_NATIVE_LONG", SYMBOL_FLAG_NATIVE_LONG = 1 << 6);
            exports_35("SYMBOL_FLAG_NATIVE_FLOAT", SYMBOL_FLAG_NATIVE_FLOAT = 1 << 7);
            exports_35("SYMBOL_FLAG_NATIVE_DOUBLE", SYMBOL_FLAG_NATIVE_DOUBLE = 1 << 8);
            exports_35("SYMBOL_FLAG_USED", SYMBOL_FLAG_USED = 1 << 9);
            exports_35("SYMBOL_FLAG_IS_ARRAY", SYMBOL_FLAG_IS_ARRAY = 1 << 10);
            exports_35("SYMBOL_FLAG_IS_GENERIC", SYMBOL_FLAG_IS_GENERIC = 1 << 11);
            exports_35("SYMBOL_FLAG_IS_TEMPLATE", SYMBOL_FLAG_IS_TEMPLATE = 1 << 12);
            Symbol = class Symbol {
                constructor() {
                ...
                isEnumValue() {
                    return this.node.parent.kind == node_8.NodeKind.ENUM;
                }
                isUnsafe() {
                ...
                parent() {
                    ...
                    return parent.kind == node_8.NodeKind.CLASS ? parent.symbol : null;
                }
                ...
                determineClassLayout(context) {
                    ...
                    var maxAlignment = 1;
                    while (child != null) {
                        if (child.kind == node_8.NodeKind.VARIABLE) {
            ...
            exports_35("Symbol", Symbol);
        }
    };
});
System.register("compiler/core/type", ["compiler/core/symbol", "utils/stringbuilder"], function (exports_36, context_36) {
    "use strict";
    var __moduleName = context_36 && context_36.id;
    var symbol_7, stringbuilder_10, ConversionKind, Type;
    return {
        setters: [
            function (symbol_7_1) {
                symbol_7 = symbol_7_1;
        ...
        execute: function () {
            ...
            exports_36("ConversionKind", ConversionKind);
            Type = class Type {
                isClass() {
                    return this.symbol != null && this.symbol.kind == symbol_7.SymbolKind.TYPE_CLASS;
                }
                isGeneric() {
                    let symbol = this.symbol || this.pointerTo.symbol;
                    return symbol != null && symbol.kind == symbol_7.SymbolKind.TYPE_GENERIC;
                }
                isTemplate() {
                    let symbol = this.symbol || this.pointerTo.symbol;
                    return symbol != null && symbol.kind == symbol_7.SymbolKind.TYPE_TEMPLATE;
                }
                isEnum() {
                    return this.symbol != null && this.symbol.kind == symbol_7.SymbolKind.TYPE_ENUM;
                }
                isInteger() {
                    return this.symbol != null && (this.symbol.flags & symbol_7.SYMBOL_FLAG_NATIVE_INTEGER) != 0 || this.isEnum();
                }
                isLong() {
                    return this.symbol != null && (this.symbol.flags & symbol_7.SYMBOL_FLAG_NATIVE_LONG) != 0;
                }
                isUnsigned() {
                    return this.symbol != null && (this.symbol.flags & symbol_7.SYMBOL_FLAG_IS_UNSIGNED) != 0;
                }
                isFloat() {
                    return this.symbol != null && (this.symbol.flags & symbol_7.SYMBOL_FLAG_NATIVE_FLOAT) != 0;
                }
                isDouble() {
                    return this.symbol != null && (this.symbol.flags & symbol_7.SYMBOL_FLAG_NATIVE_DOUBLE) != 0;
                }
                isArray() {
                ...
                isReference() {
                    return this.pointerTo != null || this.symbol != null && (this.symbol.flags & symbol_7.SYMBOL_FLAG_IS_REFERENCE) != 0;
                }
                ...
                toString() {
                    if (this.cachedToString == null) {
                        this.cachedToString =
                            this.pointerTo != null ? stringbuilder_10.StringBuilder_new().appendChar('*').append(this.pointerTo.toString()).finish() :
                                this.symbol.name;
                    }
                ...
                hasInstanceMembers() {
                    var symbol = this.symbol;
                    return symbol != null && (symbol.kind == symbol_7.SymbolKind.TYPE_TEMPLATE || symbol.kind == symbol_7.SymbolKind.TYPE_CLASS || symbol.kind == symbol_7.SymbolKind.TYPE_NATIVE);
                }
            };
            exports_36("Type", Type);
        }
    };
});
System.register("compiler/core/node", ["compiler/core/symbol"], function (exports_37, context_37) {
    "use strict";
    var __moduleName = context_37 && context_37.id;
    function isUnary(kind) {
        return kind >= NodeKind.ADDRESS_OF && kind <= NodeKind.PREFIX_INCREMENT;
    }
    exports_37("isUnary", isUnary);
    function isUnaryPostfix(kind) {
        return kind >= NodeKind.POSTFIX_DECREMENT && kind <= NodeKind.POSTFIX_INCREMENT;
    }
    exports_37("isUnaryPostfix", isUnaryPostfix);
    function isBinary(kind) {
        return kind >= NodeKind.ADD && kind <= NodeKind.SUBTRACT;
    }
    exports_37("isBinary", isBinary);
    ...
    exports_37("appendFlag", appendFlag);
    ...
    exports_37("rangeForFlag", rangeForFlag);
    ...
    exports_37("createNew", createNew);
    ...
    exports_37("createDelete", createDelete);
    ...
    exports_37("createHook", createHook);
    ...
    exports_37("createIndex", createIndex);
    function createNull() {
        let node = new Node();
        node.kind = NodeKind.NULL;
        return node;
    }
    exports_37("createNull", createNull);
    function createUndefined() {
        let node = new Node();
        node.kind = NodeKind.UNDEFINED;
        return node;
    }
    exports_37("createUndefined", createUndefined);
    function createThis() {
        let node = new Node();
        node.kind = NodeKind.THIS;
        return node;
    }
    exports_37("createThis", createThis);
    ...
    exports_37("createAddressOf", createAddressOf);
    ...
    exports_37("createDereference", createDereference);
    ...
    exports_37("createAlignOf", createAlignOf);
    ...
    exports_37("createSizeOf", createSizeOf);
    ...
    exports_37("createboolean", createboolean);
    ...
    exports_37("createInt", createInt);
    ...
    exports_37("createLong", createLong);
    ...
    exports_37("createFloat", createFloat);
    ...
    exports_37("createDouble", createDouble);
    ...
    exports_37("createString", createString);
    ...
    exports_37("createArray", createArray);
    ...
    exports_37("createName", createName);
    ...
    exports_37("createType", createType);
    function createAny() {
        let node = new Node();
        node.kind = NodeKind.ANY;
        return node;
    }
    exports_37("createAny", createAny);
    function createEmpty() {
        let node = new Node();
        node.kind = NodeKind.EMPTY;
        return node;
    }
    exports_37("createEmpty", createEmpty);
    ...
    exports_37("createExpression", createExpression);
    function createBlock() {
        let node = new Node();
        node.kind = NodeKind.BLOCK;
        return node;
    }
    exports_37("createBlock", createBlock);
    ...
    exports_37("createModule", createModule);
    ...
    exports_37("createClass", createClass);
    ...
    exports_37("createEnum", createEnum);
    ...
    exports_37("createWhile", createWhile);
    ...
    exports_37("createReturn", createReturn);
    function createImports() {
        let node = new Node();
        node.kind = NodeKind.IMPORTS;
        return node;
    }
    exports_37("createImports", createImports);
    ...
    exports_37("createImport", createImport);
    ...
    exports_37("createImportFrom", createImportFrom);
    function createVariables() {
        let node = new Node();
        node.kind = NodeKind.VARIABLES;
        return node;
    }
    exports_37("createVariables", createVariables);
    function createConstants() {
        let node = new Node();
        node.kind = NodeKind.CONSTANTS;
        return node;
    }
    exports_37("createConstants", createConstants);
    function createParameters() {
        let node = new Node();
        node.kind = NodeKind.PARAMETERS;
        return node;
    }
    exports_37("createParameters", createParameters);
    ...
    exports_37("createExtends", createExtends);
    function createImplements() {
        let node = new Node();
        node.kind = NodeKind.IMPLEMENTS;
        return node;
    }
    exports_37("createImplements", createImplements);
    ...
    exports_37("createParameter", createParameter);
    ...
    exports_37("createVariable", createVariable);
    ...
    exports_37("createFunction", createFunction);
    ...
    exports_37("createUnary", createUnary);
    ...
    exports_37("createBinary", createBinary);
    ...
    exports_37("createCall", createCall);
    ...
    exports_37("createCast", createCast);
    ...
    exports_37("createDot", createDot);
    ...
    exports_37("createSymbolReference", createSymbolReference);
    ...
    exports_37("createMemberReference", createMemberReference);
    function createParseError() {
        let node = new Node();
        node.kind = NodeKind.PARSE_ERROR;
        return node;
    }
    exports_37("createParseError", createParseError);
    //JavaScript
    ...
    return {
        ...
        execute: function () {
            ...
            exports_37("NodeKind", NodeKind);
            exports_37("NODE_FLAG_DECLARE", NODE_FLAG_DECLARE = 1 << 0);
            exports_37("NODE_FLAG_EXPORT", NODE_FLAG_EXPORT = 1 << 1);
            exports_37("NODE_FLAG_IMPORT", NODE_FLAG_IMPORT = 1 << 2);
            exports_37("NODE_FLAG_LIBRARY", NODE_FLAG_LIBRARY = 1 << 3);
            exports_37("NODE_FLAG_GET", NODE_FLAG_GET = 1 << 4);
            exports_37("NODE_FLAG_OPERATOR", NODE_FLAG_OPERATOR = 1 << 5);
            exports_37("NODE_FLAG_POSITIVE", NODE_FLAG_POSITIVE = 1 << 6);
            exports_37("NODE_FLAG_PRIVATE", NODE_FLAG_PRIVATE = 1 << 7);
            exports_37("NODE_FLAG_PROTECTED", NODE_FLAG_PROTECTED = 1 << 8);
            exports_37("NODE_FLAG_PUBLIC", NODE_FLAG_PUBLIC = 1 << 9);
            exports_37("NODE_FLAG_SET", NODE_FLAG_SET = 1 << 10);
            exports_37("NODE_FLAG_STATIC", NODE_FLAG_STATIC = 1 << 11);
            exports_37("NODE_FLAG_UNSAFE", NODE_FLAG_UNSAFE = 1 << 12);
            exports_37("NODE_FLAG_JAVASCRIPT", NODE_FLAG_JAVASCRIPT = 1 << 13);
            exports_37("NODE_FLAG_UNSIGNED_OPERATOR", NODE_FLAG_UNSIGNED_OPERATOR = 1 << 14);
            exports_37("NODE_FLAG_VIRTUAL", NODE_FLAG_VIRTUAL = 1 << 15);
            exports_37("NODE_FLAG_START", NODE_FLAG_START = 1 << 16);
            exports_37("NODE_FLAG_ANYFUNC", NODE_FLAG_ANYFUNC = 1 << 17);
            exports_37("NODE_FLAG_GENERIC", NODE_FLAG_GENERIC = 1 << 18);
            NodeFlag = class NodeFlag {
            };
            exports_37("NodeFlag", NodeFlag);
            Node = class Node {
                get hasValue() {
                ...
                isTemplate() {
                    return this.symbol && (this.symbol.flags & symbol_8.SYMBOL_FLAG_IS_TEMPLATE) != 0;
                }
                isUnsignedOperator() {
                ...
                isType() {
                    return this.kind == NodeKind.TYPE || this.kind == NodeKind.POINTER_TYPE || this.symbol != null && symbol_8.isType(this.symbol.kind);
                }
                isCallValue() {
                ...
                functionFirstArgumentIgnoringThis() {
                    ...
                    if (this.symbol.kind == symbol_8.SymbolKind.FUNCTION_INSTANCE) {
                        child = child.nextSibling;
                    }
                    return child;
                }
            ...
            exports_37("Node", Node);
        }
    };
});
System.register("utils/log", ["utils/stringbuilder"], function (exports_38, context_38) {
    "use strict";
    ...
    exports_38("createRange", createRange);
    ...
    exports_38("spanRanges", spanRanges);
    var stringbuilder_11, LineColumn, Source, SourceRange, DiagnosticKind, Diagnostic, Log;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_38("LineColumn", LineColumn);
            Source = class Source {
            ...
            exports_38("SourceRange", SourceRange);
            (function (DiagnosticKind) {
                DiagnosticKind[DiagnosticKind["ERROR"] = 0] = "ERROR";
                DiagnosticKind[DiagnosticKind["WARNING"] = 1] = "WARNING";
            })(DiagnosticKind || (DiagnosticKind = {}));
            exports_38("DiagnosticKind", DiagnosticKind);
            ...
            exports_38("Diagnostic", Diagnostic);
            Log = class Log {
                error(range, message) {
...
System.register("turboscript", ["utils/log", "utils/stringbuilder", "compiler/compiler"], function (exports_39, context_39) {
    "use strict";
    ...
    function writeLogToTerminal(log) {
        ...
        while (diagnostic != null) {
            if (diagnostic.range !== undefined) {
                ...
                // Kind
                builder = stringbuilder_12.StringBuilder_new();
                diagnostic.appendKind(builder);
                stdlib.Terminal_setColor(diagnostic.kind == log_7.DiagnosticKind.ERROR ? Color.RED : Color.MAGENTA);
                stdlib.Terminal_write(builder.finish());
                // Message
                builder = stringbuilder_12.StringBuilder_new();
                diagnostic.appendMessage(builder);
    ...
    exports_39("writeLogToTerminal", writeLogToTerminal);
    ...
    exports_39("printError", printError);
    ...
    exports_39("main_addArgument", main_addArgument);
    function main_reset() {
        firstArgument = null;
        lastArgument = null;
    }
    exports_39("main_reset", main_reset);
    function printUsage() {
        stdlib.Terminal_write(`
...
`);
    ...
    exports_39("printUsage", printUsage);
    function main_entry() {
        let target = compiler_5.CompileTarget.NONE;
        ...
        while (argument != null) {
            ...
            if (text.startsWith("-")) {
                if (text == "-h" || text == "-help" || text == "--help" || text == "/?") {
                    ...
                    target = compiler_5.CompileTarget.CPP;
                }
                else if (text == "--js") {
                    target = compiler_5.CompileTarget.JAVASCRIPT;
                }
                else if (text == "--wasm") {
                    target = compiler_5.CompileTarget.WEBASSEMBLY;
                }
                    ...
                    printError(stringbuilder_12.StringBuilder_new().append("Invalid flag: ").append(text).finish());
                    return 1;
                }
            }
            else {
        ...
        if (target == compiler_5.CompileTarget.NONE) {
        ...
        let compiler = new compiler_5.Compiler();
        ...
        while (argument != null) {
            ...
            if (text == "--define") {
                ...
                if (contents == null) {
                    printError(stringbuilder_12.StringBuilder_new().append("Cannot read from ").append(text).finish());
                    return 1;
                }
        ...
        if (!compiler.log.hasErrors()) {
            if (target == compiler_5.CompileTarget.CPP && stdlib.IO_writeTextFile(output, compiler.outputCPP) &&
                stdlib.IO_writeTextFile(compiler_5.replaceFileExtension(output, ".h"), compiler.outputH) ||
                target == compiler_5.CompileTarget.JAVASCRIPT && stdlib.IO_writeTextFile(output, compiler.outputJS) ||
                target == compiler_5.CompileTarget.WEBASSEMBLY && stdlib.IO_writeBinaryFile(output, compiler.outputWASM) &&
                    stdlib.IO_writeTextFile(output + ".log", compiler.outputWASM.log)) {
                return 0;
            }
            printError(stringbuilder_12.StringBuilder_new().append("Cannot write to ").append(output).finish());
        }
        return 1;
    }
    exports_39("main_entry", main_entry);
    var log_7, stringbuilder_12, compiler_5, Color, CommandLineArgument, firstArgument, lastArgument, main;
    return {
        setters: [
            function (log_7_1) {
                log_7 = log_7_1;
        ...
        execute: function () {
            ...
            exports_39("Color", Color);
            CommandLineArgument = class CommandLineArgument {
            };
            exports_39("CommandLineArgument", CommandLineArgument);
            exports_39("main", main = {
