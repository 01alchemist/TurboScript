...
Object.defineProperty(exports, "__esModule", { value: true });
const stringbuilder_1 = __webpack_require__(0);
const color_1 = __webpack_require__(34);
const assert_1 = __webpack_require__(36);
const terminal_1 = __webpack_require__(14);
class LineColumn {
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const symbol_1 = __webpack_require__(3);
const assert_1 = __webpack_require__(36);
/**
...
const symbol_1 = __webpack_require__(3);
const stringbuilder_1 = __webpack_require__(0);
const type_1 = __webpack_require__(9);
var FindNested;
(function (FindNested) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const scanner_1 = __webpack_require__(5);
const log_1 = __webpack_require__(1);
const stringbuilder_1 = __webpack_require__(0);
const node_1 = __webpack_require__(2);
const assert_1 = __webpack_require__(36);
...
const type_checker_1 = __webpack_require__(26);
const node_1 = __webpack_require__(2);
const log_1 = __webpack_require__(1);
const preprocessor_1 = __webpack_require__(30);
const scope_1 = __webpack_require__(8);
const scanner_1 = __webpack_require__(5);
const parser_1 = __webpack_require__(10);
const shaking_1 = __webpack_require__(28);
const stringbuilder_1 = __webpack_require__(0);
const webassembly_1 = __webpack_require__(25);
const library_1 = __webpack_require__(31);
const preparser_1 = __webpack_require__(29);
const compile_target_1 = __webpack_require__(4);
const assert_1 = __webpack_require__(36);
/**
 * Author: Nidin Vinayakan
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
const env_1 = __webpack_require__(11);
/**
 * Created by n.vinayakan on 06.06.17.
 */
let fs = null;
...
Object.defineProperty(exports, "__esModule", { value: true });
const symbol_1 = __webpack_require__(3);
const bytearray_1 = __webpack_require__(33);
const utils_1 = __webpack_require__(6);
const node_1 = __webpack_require__(2);
const opcode_1 = __webpack_require__(7);
const utils_2 = __webpack_require__(6);
const builtins_helper_1 = __webpack_require__(24);
const assert_1 = __webpack_require__(36);
...
class WasmModule {
    ...
    emitGlobalDeclarations(array) {
        ...
        while (global) {
            ...
            if (value) {
                ...
                appendOpcode(section.data, array.position, opcode_1.WasmOpcode[`${dataType}_CONST`]);
                switch (dataType) {
                    case "I32":
    ...
    addGlobalToStartFunction(global) {
        ...
        appendOpcode(startFn.body, 0, opcode_1.WasmOpcode.SET_GLOBAL);
    ...
    emitExportTable(array) {
        ...
        while (fn != null) {
            if (fn.isExported) {
                ...
                log(section.data, null, null, `${utils_2.toHex(section.data.position + array.position + 4)}: ${fnName} // export name`);
    ...
    emitFunctionBodies(array) {
        ...
        while (fn != null) {
            ...
            if (fn.body) {
                ...
                if (lastChild && lastChild.kind !== node_1.NodeKind.RETURN) {
    ...
    emitNode(array, byteOffset, node) {
        ...
        if (node.kind == node_1.NodeKind.BLOCK) {
            ...
            if (node.parent.kind === node_1.NodeKind.IF || node.parent.kind === node_1.NodeKind.WHILE) {
            ...
            appendOpcode(array, byteOffset, opcode_1.WasmOpcode.BR);
            array.writeUnsignedLEB128(label - (node.kind == node_1.NodeKind.BREAK ? 0 : 1));
        }
            ...
            if (symbol.kind == symbol_1.SymbolKind.VARIABLE_ARGUMENT || symbol.kind == symbol_1.SymbolKind.VARIABLE_LOCAL) {
                ...
                appendOpcode(array, byteOffset, opcode_1.WasmOpcode.GET_GLOBAL);
                array.writeUnsignedLEB128(symbol.offset);
            ...
            if (left.kind == node_1.NodeKind.DEREFERENCE) {
                ...
                appendOpcode(array, byteOffset, opcode_1.WasmOpcode.SET_GLOBAL);
                array.writeUnsignedLEB128(symbol.offset);
            ...
            if (kind == node_1.NodeKind.POSTFIX_INCREMENT || kind == node_1.NodeKind.POSTFIX_DECREMENT) {
                ...
                if (node.parent.kind != node_1.NodeKind.RETURN) {
                    ...
                    appendOpcode(array, byteOffset, opcode_1.WasmOpcode[`${dataType}_${operation}`]);
...
function wasmWrapType(id) {
    assert_1.assert(id == WasmType.VOID || id == WasmType.I32 || id == WasmType.I64 || id == WasmType.F32 || id == WasmType.F64);
...
function logOpcode(array, offset = 0, opcode) {
    if (debug) {
        array.log += `${utils_2.toHex(offset + array.position)}: ${utils_2.toHex(opcode, 2)}                    ; ${opcode_1.WasmOpcode[opcode]}\n`;
    }
}
...
const stringbuilder_1 = __webpack_require__(0);
const utils_1 = __webpack_require__(6);
const const_1 = __webpack_require__(27);
const assert_1 = __webpack_require__(36);
/**
 * Author : Nidin Vinayakan
 */
...
const log_1 = __webpack_require__(1);
const scanner_1 = __webpack_require__(5);
const log_2 = __webpack_require__(1);
const stringbuilder_1 = __webpack_require__(0);
...
const compile_target_1 = __webpack_require__(4);
// library files
const math = __webpack_require__(17);
const types = __webpack_require__(18);
const array = __webpack_require__(15);
const jstypes = __webpack_require__(20);
const runtime = __webpack_require__(19);
const wrapper = __webpack_require__(21);
const malloc = __webpack_require__(16);
const builtins = __webpack_require__(22);
const initializer = __webpack_require__(23);
class Library {
    static get(target) {
        let lib;
        switch (target) {
