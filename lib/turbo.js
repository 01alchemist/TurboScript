        ...
        execute: function () {
            ...
            ParserContext = class ParserContext {
                ...
                parseInternalImports() {
                    let token = this.current;
                    assert(token.kind == scanner_1.TokenKind.INTERNAL_IMPORT);
                    this.advance();
                ...
                parseFlags() {
                    ...
                    while (true) {
                        let token = this.current;
                        let flag;
                        if (this.eat(scanner_1.TokenKind.EXTERNAL_IMPORT))
                            flag = node_1.NODE_FLAG_EXTERNAL_IMPORT;
                        else if (this.eat(scanner_1.TokenKind.DECLARE))
                ...
                parseStatement(mode) {
                    ...
                    if (this.peek(scanner_1.TokenKind.INTERNAL_IMPORT) && firstFlag == null)
...
System.register("backends/webassembly/webassembly", ["compiler/core/symbol", "utils/bytearray", "utils/imports", "compiler/core/node", "backends/webassembly/opcode", "utils/utils"], function (exports_13, context_13) {
    "use strict";
                ...
                emitFunctionBodies(array) {
                    ...
                    while (fn != null) {
                        ...
                        if (lastChild && lastChild.kind !== node_5.NodeKind.RETURN) {
                            appendOpcode(bodyData, sectionOffset, opcode_1.WasmOpcode.RETURN);
                        }
                ...
                emitInstance(array, byteOffset, node) {
                    ...
                    if (type.resolvedType.isArray()) {
                        ...
                        if (lengthNode.kind == node_5.NodeKind.INT32) {
                            ...
                            appendOpcode(array, byteOffset, opcode_1.WasmOpcode.I32_MUL); //array byteLength
                        }
                        appendOpcode(array, byteOffset, opcode_1.WasmOpcode.I32_CONST);
                ...
                emitNode(array, byteOffset, node) {
                    ...
                    if (node.kind == node_5.NodeKind.BLOCK) {
                        ...
                        if (symbol.name === "sqrt32") {
                            appendOpcode(array, byteOffset, opcode_1.WasmOpcode.F32_SQRT);
                        }
                        else if (symbol.name === "sqrt64") {
                            appendOpcode(array, byteOffset, opcode_1.WasmOpcode.F64_SQRT);
                        }
                        else {
                        ...
                        if (resolvedType.isFloat()) {
                            this.emitNode(array, byteOffset, node.unaryValue());
                            appendOpcode(array, byteOffset, opcode_1.WasmOpcode.F32_NEG);
                        }
                        else if (resolvedType.isDouble()) {
                            this.emitNode(array, byteOffset, node.unaryValue());
                            appendOpcode(array, byteOffset, opcode_1.WasmOpcode.F64_NEG);
                        }
...
System.register("library/library", ["compiler/compiler"], function (exports_14, context_14) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_14("Library", Library);
        }
    };
});
System.register("compiler/parser/preparser", ["utils/log", "compiler/scanner/scanner", "turboscript", "utils/stringbuilder"], function (exports_15, context_15) {
    "use strict";
...
System.register("compiler/compiler", ["compiler/analyzer/type-checker", "compiler/core/node", "utils/log", "compiler/preprocessor/preprocessor", "compiler/core/scope", "compiler/scanner/scanner", "compiler/parser/parser", "compiler/optimizer/shaking", "utils/stringbuilder", "backends/webassembly/webassembly", "library/library", "compiler/parser/preparser"], function (exports_16, context_16) {
    "use strict";
    ...
    exports_16("replaceFileExtension", replaceFileExtension);
    ...
    return {
        ...
        execute: function () {
            ...
            exports_16("CompileTarget", CompileTarget);
            ...
            exports_16("Compiler", Compiler);
        }
    };
});
System.register("compiler/const", [], function (exports_17, context_17) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
             ...
             */
            exports_17("MIN_INT32_VALUE", MIN_INT32_VALUE = -Math.pow(2, 31));
            exports_17("MAX_INT32_VALUE", MAX_INT32_VALUE = Math.pow(2, 31) - 1);
            exports_17("MIN_UINT32_VALUE", MIN_UINT32_VALUE = 0);
            exports_17("MAX_UINT32_VALUE", MAX_UINT32_VALUE = Math.pow(2, 32) - 1);
            //FIXME: Cannot represent 64 bit integer in javascript
            exports_17("MIN_INT64_VALUE", MIN_INT64_VALUE = -Math.pow(2, 63));
            exports_17("MAX_INT64_VALUE", MAX_INT64_VALUE = Math.pow(2, 63) - 1);
            exports_17("MIN_UINT64_VALUE", MIN_UINT64_VALUE = 0);
            exports_17("MAX_UINT64_VALUE", MAX_UINT64_VALUE = Math.pow(2, 64) - 1);
        }
    };
});
System.register("compiler/analyzer/type-checker", ["compiler/core/symbol", "compiler/core/type", "compiler/core/node", "compiler/compiler", "utils/log", "compiler/core/scope", "utils/stringbuilder", "utils/imports", "compiler/const"], function (exports_18, context_18) {
    "use strict";
    ...
    exports_18("addScopeToSymbol", addScopeToSymbol);
    ...
    exports_18("linkSymbolToNode", linkSymbolToNode);
    ...
    exports_18("initialize", initialize);
    ...
    exports_18("forbidFlag", forbidFlag);
    ...
    exports_18("requireFlag", requireFlag);
                ...
                if (parent.node.isDeclare()) {
                    if (body == null) {
                        ...
                        if (parent.node.isExternalImport()) {
                            node.flags = node.flags | node_7.NODE_FLAG_EXTERNAL_IMPORT;
                        }
                    }
                    else {
    ...
    exports_18("initializeSymbol", initializeSymbol);
    /**
    ...
    exports_18("resolveChildren", resolveChildren);
    ...
    exports_18("resolveChildrenAsExpressions", resolveChildrenAsExpressions);
    ...
    exports_18("resolveAsExpression", resolveAsExpression);
    ...
    exports_18("resolveAsType", resolveAsType);
    ...
    exports_18("canConvert", canConvert);
    ...
    exports_18("checkConversion", checkConversion);
    ...
    exports_18("checkStorage", checkStorage);
    ...
    exports_18("createDefaultValueForType", createDefaultValueForType);
    ...
    exports_18("simplifyBinary", simplifyBinary);
    ...
    exports_18("binaryHasUnsignedArguments", binaryHasUnsignedArguments);
    ...
    exports_18("isBinaryLong", isBinaryLong);
    ...
    exports_18("isBinaryDouble", isBinaryDouble);
    ...
    exports_18("isSymbolAccessAllowed", isSymbolAccessAllowed);
    function resolve(context, node, parentScope) {
        ...
        else if (kind == node_7.NodeKind.EXTERNAL_IMPORT) {
            let symbol = node.symbol;
        }
        ...
        else if (kind == node_7.NodeKind.INTERNAL_IMPORT || kind == node_7.NodeKind.INTERNAL_IMPORT_FROM) {
            //ignore imports
        }
...
System.register("compiler/core/symbol", ["compiler/core/node", "utils/imports"], function (exports_19, context_19) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_19("SymbolKind", SymbolKind);
            ...
            exports_19("SymbolState", SymbolState);
            exports_19("SYMBOL_FLAG_CONVERT_INSTANCE_TO_GLOBAL", SYMBOL_FLAG_CONVERT_INSTANCE_TO_GLOBAL = 1 << 0);
            exports_19("SYMBOL_FLAG_IS_BINARY_OPERATOR", SYMBOL_FLAG_IS_BINARY_OPERATOR = 1 << 1);
            exports_19("SYMBOL_FLAG_IS_REFERENCE", SYMBOL_FLAG_IS_REFERENCE = 1 << 2);
            exports_19("SYMBOL_FLAG_IS_UNARY_OPERATOR", SYMBOL_FLAG_IS_UNARY_OPERATOR = 1 << 3);
            exports_19("SYMBOL_FLAG_IS_UNSIGNED", SYMBOL_FLAG_IS_UNSIGNED = 1 << 4);
            exports_19("SYMBOL_FLAG_NATIVE_INTEGER", SYMBOL_FLAG_NATIVE_INTEGER = 1 << 5);
            exports_19("SYMBOL_FLAG_NATIVE_LONG", SYMBOL_FLAG_NATIVE_LONG = 1 << 6);
            exports_19("SYMBOL_FLAG_NATIVE_FLOAT", SYMBOL_FLAG_NATIVE_FLOAT = 1 << 7);
            exports_19("SYMBOL_FLAG_NATIVE_DOUBLE", SYMBOL_FLAG_NATIVE_DOUBLE = 1 << 8);
            exports_19("SYMBOL_FLAG_USED", SYMBOL_FLAG_USED = 1 << 9);
            exports_19("SYMBOL_FLAG_IS_ARRAY", SYMBOL_FLAG_IS_ARRAY = 1 << 10);
            exports_19("SYMBOL_FLAG_IS_GENERIC", SYMBOL_FLAG_IS_GENERIC = 1 << 11);
            exports_19("SYMBOL_FLAG_IS_TEMPLATE", SYMBOL_FLAG_IS_TEMPLATE = 1 << 12);
            Symbol = class Symbol {
                constructor() {
            ...
            exports_19("Symbol", Symbol);
        }
    };
});
System.register("compiler/core/type", ["compiler/core/symbol", "utils/stringbuilder"], function (exports_20, context_20) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_20("ConversionKind", ConversionKind);
            Type = class Type {
                isClass() {
...
System.register("compiler/core/node", ["compiler/core/symbol"], function (exports_21, context_21) {
    ...
    exports_21("appendFlag", appendFlag);
    ...
    exports_21("rangeForFlag", rangeForFlag);
    ...
    exports_21("createNew", createNew);
    ...
    exports_21("createDelete", createDelete);
    ...
    exports_21("createHook", createHook);
    ...
    exports_21("createIndex", createIndex);
    function createNull() {
        let node = new Node();
        node.kind = NodeKind.NULL;
        return node;
    }
    exports_21("createNull", createNull);
    function createUndefined() {
        let node = new Node();
        node.kind = NodeKind.UNDEFINED;
        return node;
    }
    exports_21("createUndefined", createUndefined);
    function createThis() {
        let node = new Node();
        node.kind = NodeKind.THIS;
        return node;
    }
    exports_21("createThis", createThis);
    ...
    exports_21("createAddressOf", createAddressOf);
    ...
    exports_21("createDereference", createDereference);
    ...
    exports_21("createAlignOf", createAlignOf);
    ...
    exports_21("createSizeOf", createSizeOf);
    ...
    exports_21("createboolean", createboolean);
    ...
    exports_21("createInt", createInt);
    ...
    exports_21("createLong", createLong);
    ...
    exports_21("createFloat", createFloat);
    ...
    exports_21("createDouble", createDouble);
    ...
    exports_21("createString", createString);
    ...
    exports_21("createArray", createArray);
    ...
    exports_21("createName", createName);
    ...
    exports_21("createType", createType);
    function createAny() {
        let node = new Node();
        node.kind = NodeKind.ANY;
        return node;
    }
    exports_21("createAny", createAny);
    function createEmpty() {
        let node = new Node();
        node.kind = NodeKind.EMPTY;
        return node;
    }
    exports_21("createEmpty", createEmpty);
    ...
    exports_21("createExpression", createExpression);
    function createBlock() {
        let node = new Node();
        node.kind = NodeKind.BLOCK;
        return node;
    }
    exports_21("createBlock", createBlock);
    ...
    exports_21("createModule", createModule);
    ...
    exports_21("createClass", createClass);
    ...
    exports_21("createEnum", createEnum);
    ...
    exports_21("createWhile", createWhile);
    ...
    exports_21("createReturn", createReturn);
    function createImports() {
        let node = new Node();
        node.kind = NodeKind.IMPORTS;
        return node;
    }
    exports_21("createImports", createImports);
    ...
    exports_21("createInternalImport", createInternalImport);
    ...
    exports_21("createInternalImportFrom", createInternalImportFrom);
    ...
    exports_21("createExternalImport", createExternalImport);
    function createVariables() {
        let node = new Node();
        node.kind = NodeKind.VARIABLES;
        return node;
    }
    exports_21("createVariables", createVariables);
    function createConstants() {
        let node = new Node();
        node.kind = NodeKind.CONSTANTS;
        return node;
    }
    exports_21("createConstants", createConstants);
    function createParameters() {
        let node = new Node();
        node.kind = NodeKind.PARAMETERS;
        return node;
    }
    exports_21("createParameters", createParameters);
    ...
    exports_21("createExtends", createExtends);
    function createImplements() {
        let node = new Node();
        node.kind = NodeKind.IMPLEMENTS;
        return node;
    }
    exports_21("createImplements", createImplements);
    ...
    exports_21("createParameter", createParameter);
    ...
    exports_21("createVariable", createVariable);
    ...
    exports_21("createFunction", createFunction);
    ...
    exports_21("createUnary", createUnary);
    ...
    exports_21("createBinary", createBinary);
    ...
    exports_21("createCall", createCall);
    ...
    exports_21("createCast", createCast);
    ...
    exports_21("createDot", createDot);
    ...
    exports_21("createSymbolReference", createSymbolReference);
    ...
    exports_21("createMemberReference", createMemberReference);
    function createParseError() {
        let node = new Node();
        node.kind = NodeKind.PARSE_ERROR;
        return node;
    }
    exports_21("createParseError", createParseError);
    //JavaScript
    ...
    return {
        ...
        execute: function () {
            ...
            exports_21("NodeKind", NodeKind);
            exports_21("NODE_FLAG_DECLARE", NODE_FLAG_DECLARE = 1 << 0);
            exports_21("NODE_FLAG_EXPORT", NODE_FLAG_EXPORT = 1 << 1);
            exports_21("NODE_FLAG_INTERNAL_IMPORT", NODE_FLAG_INTERNAL_IMPORT = 1 << 2);
            exports_21("NODE_FLAG_EXTERNAL_IMPORT", NODE_FLAG_EXTERNAL_IMPORT = 1 << 3);
            exports_21("NODE_FLAG_GET", NODE_FLAG_GET = 1 << 4);
            exports_21("NODE_FLAG_OPERATOR", NODE_FLAG_OPERATOR = 1 << 5);
            exports_21("NODE_FLAG_POSITIVE", NODE_FLAG_POSITIVE = 1 << 6);
            exports_21("NODE_FLAG_PRIVATE", NODE_FLAG_PRIVATE = 1 << 7);
            exports_21("NODE_FLAG_PROTECTED", NODE_FLAG_PROTECTED = 1 << 8);
            exports_21("NODE_FLAG_PUBLIC", NODE_FLAG_PUBLIC = 1 << 9);
            exports_21("NODE_FLAG_SET", NODE_FLAG_SET = 1 << 10);
            exports_21("NODE_FLAG_STATIC", NODE_FLAG_STATIC = 1 << 11);
            exports_21("NODE_FLAG_UNSAFE", NODE_FLAG_UNSAFE = 1 << 12);
            exports_21("NODE_FLAG_JAVASCRIPT", NODE_FLAG_JAVASCRIPT = 1 << 13);
            exports_21("NODE_FLAG_UNSIGNED_OPERATOR", NODE_FLAG_UNSIGNED_OPERATOR = 1 << 14);
            exports_21("NODE_FLAG_VIRTUAL", NODE_FLAG_VIRTUAL = 1 << 15);
            exports_21("NODE_FLAG_START", NODE_FLAG_START = 1 << 16);
            exports_21("NODE_FLAG_ANYFUNC", NODE_FLAG_ANYFUNC = 1 << 17);
            exports_21("NODE_FLAG_GENERIC", NODE_FLAG_GENERIC = 1 << 18);
            NodeFlag = class NodeFlag {
            };
            exports_21("NodeFlag", NodeFlag);
            Node = class Node {
                get hasValue() {
            ...
            exports_21("Node", Node);
        }
    };
});
System.register("utils/log", ["utils/stringbuilder"], function (exports_22, context_22) {
    "use strict";
    ...
    exports_22("createRange", createRange);
    ...
    exports_22("spanRanges", spanRanges);
    var stringbuilder_11, LineColumn, Source, Range, DiagnosticKind, Diagnostic, Log;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_22("LineColumn", LineColumn);
            Source = class Source {
            ...
            exports_22("Range", Range);
            (function (DiagnosticKind) {
                DiagnosticKind[DiagnosticKind["ERROR"] = 0] = "ERROR";
                DiagnosticKind[DiagnosticKind["WARNING"] = 1] = "WARNING";
            })(DiagnosticKind || (DiagnosticKind = {}));
            exports_22("DiagnosticKind", DiagnosticKind);
            ...
            exports_22("Diagnostic", Diagnostic);
            Log = class Log {
                error(range, message) {
...
System.register("turboscript", ["utils/log", "utils/stringbuilder", "compiler/compiler"], function (exports_23, context_23) {
    "use strict";
    ...
    exports_23("writeLogToTerminal", writeLogToTerminal);
    ...
    exports_23("printError", printError);
    ...
    exports_23("main_addArgument", main_addArgument);
    function main_reset() {
        firstArgument = null;
        lastArgument = null;
    }
    exports_23("main_reset", main_reset);
    function printUsage() {
        stdlib.Terminal_write(`
...
`);
    ...
    exports_23("printUsage", printUsage);
    function main_entry() {
    ...
    exports_23("main_entry", main_entry);
    ...
    return {
        ...
        execute: function () {
            ...
            exports_23("Color", Color);
            CommandLineArgument = class CommandLineArgument {
            };
            exports_23("CommandLineArgument", CommandLineArgument);
